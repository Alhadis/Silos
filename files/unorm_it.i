# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unorm_it.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unorm_it.c"
# 17 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unorm_it.c"
...
# 18 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unorm_it.c" 2
...
# 22 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unorm_it.c" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h" 1
# 22 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h"
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/uiter.h" 1
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h" 1
# 32 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/localpointer.h" 1
# 33 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h" 2
...
# 34 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h" 2
# 42 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
typedef enum {
# 51 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
    UNORM2_COMPOSE,
# 60 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
    UNORM2_DECOMPOSE,
# 73 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
    UNORM2_FCD,
# 83 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
...
# 142 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
extern const UNormalizer2 *
unorm2_getInstance_48(const char *packageName,
                   const char *name,
                   UNormalization2Mode mode,
                   UErrorCode *pErrorCode);
# 163 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
extern UNormalizer2 *
unorm2_openFiltered_48(const UNormalizer2 *norm2, const USet *filterSet, UErrorCode *pErrorCode);
...
# 210 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
extern int32_t
unorm2_normalize_48(const UNormalizer2 *norm2,
                 const UChar *src, int32_t length,
                 UChar *dest, int32_t capacity,
                 UErrorCode *pErrorCode);
# 233 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
extern int32_t
unorm2_normalizeSecondAndAppend_48(const UNormalizer2 *norm2,
                                UChar *first, int32_t firstLength, int32_t firstCapacity,
                                const UChar *second, int32_t secondLength,
                                UErrorCode *pErrorCode);
# 256 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
extern int32_t
unorm2_append_48(const UNormalizer2 *norm2,
              UChar *first, int32_t firstLength, int32_t firstCapacity,
              const UChar *second, int32_t secondLength,
              UErrorCode *pErrorCode);
# 278 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
extern int32_t
unorm2_getDecomposition_48(const UNormalizer2 *norm2,
                        UChar32 c, UChar *decomposition, int32_t capacity,
                        UErrorCode *pErrorCode);
# 299 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
extern UBool
unorm2_isNormalized_48(const UNormalizer2 *norm2,
                    const UChar *s, int32_t length,
                    UErrorCode *pErrorCode);
# 321 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
extern UNormalizationCheckResult
unorm2_quickCheck_48(const UNormalizer2 *norm2,
                  const UChar *s, int32_t length,
                  UErrorCode *pErrorCode);
# 350 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
extern int32_t
unorm2_spanQuickCheckYes_48(const UNormalizer2 *norm2,
                         const UChar *s, int32_t length,
                         UErrorCode *pErrorCode);
# 364 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
extern UBool
unorm2_hasBoundaryBefore_48(const UNormalizer2 *norm2, UChar32 c);
# 376 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
extern UBool
unorm2_hasBoundaryAfter_48(const UNormalizer2 *norm2, UChar32 c);
# 387 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm2.h"
extern UBool
unorm2_isInert_48(const UNormalizer2 *norm2, UChar32 c);
# 24 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h" 2
# 133 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h"
typedef enum {
...
# 160 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h"
enum {
...
# 206 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h"
extern int32_t
unorm_normalize_48(const UChar *source, int32_t sourceLength,
                UNormalizationMode mode, int32_t options,
                UChar *result, int32_t resultLength,
                UErrorCode *status);
# 232 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h"
extern UNormalizationCheckResult
unorm_quickCheck_48(const UChar *source, int32_t sourcelength,
                 UNormalizationMode mode,
                 UErrorCode *status);
# 253 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h"
extern UNormalizationCheckResult
unorm_quickCheckWithOptions_48(const UChar *src, int32_t srcLength,
                            UNormalizationMode mode, int32_t options,
                            UErrorCode *pErrorCode);
# 279 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h"
extern UBool
unorm_isNormalized_48(const UChar *src, int32_t srcLength,
                   UNormalizationMode mode,
                   UErrorCode *pErrorCode);
# 301 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h"
extern UBool
unorm_isNormalizedWithOptions_48(const UChar *src, int32_t srcLength,
                              UNormalizationMode mode, int32_t options,
                              UErrorCode *pErrorCode);
# 379 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h"
extern int32_t
unorm_next_48(UCharIterator *src,
           UChar *dest, int32_t destCapacity,
           UNormalizationMode mode, int32_t options,
           UBool doNormalize, UBool *pNeededToNormalize,
           UErrorCode *pErrorCode);
# 412 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h"
extern int32_t
unorm_previous_48(UCharIterator *src,
               UChar *dest, int32_t destCapacity,
               UNormalizationMode mode, int32_t options,
               UBool doNormalize, UBool *pNeededToNormalize,
               UErrorCode *pErrorCode);
# 456 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h"
extern int32_t
unorm_concatenate_48(const UChar *left, int32_t leftLength,
                  const UChar *right, int32_t rightLength,
                  UChar *dest, int32_t destCapacity,
                  UNormalizationMode mode, int32_t options,
                  UErrorCode *pErrorCode);
# 553 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/unorm.h"
extern int32_t
unorm_compare_48(const UChar *s1, int32_t length1,
              const UChar *s2, int32_t length2,
              uint32_t options,
              UErrorCode *pErrorCode);
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unorm_it.c" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unorm_it.h" 1
# 82 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unorm_it.h"
struct UNormIterator;
typedef struct UNormIterator UNormIterator;
# 105 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unorm_it.h"
extern UNormIterator *
unorm_openIter_48(void *stackMem, int32_t stackMemSize, UErrorCode *pErrorCode);
...
extern void
unorm_closeIter_48(UNormIterator *uni);
# 143 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unorm_it.h"
extern UCharIterator *
unorm_setIter_48(UNormIterator *uni, UCharIterator *iter, UNormalizationMode mode, UErrorCode *pErrorCode);
# 24 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unorm_it.c" 2
...
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unorm_it.c" 2
...
struct UNormIterator {
    UCharIterator api;
    UCharIterator *iter;
# 43 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unorm_it.c"
    UChar *chars;
    uint32_t *states;
...
reallocArrays(UNormIterator *uni, int32_t capacity, UBool addAtStart) {
    ...
    states=(uint32_t *)uprv_malloc_48((capacity+1)*4+capacity*2);
    if(states==((void *)0)) {
        return 0;
    }
    ...
    if(addAtStart) {
        ...
        memcpy(states+delta+start, uni->states+start, (limit-start+1)*4);
        memcpy(chars+delta+start, uni->chars+start, (limit-start)*4);
        ...
        memcpy(states+start, uni->states+start, (limit-start+1)*4);
        memcpy(chars+start, uni->chars+start, (limit-start)*4);
    }
...
moveContentsTowardStart(UCharIterator *api, UChar chars[], uint32_t states[], int32_t delta) {
    ...
    if(srcIndex>api->start) {
        ...
        while(srcIndex<limit && states[srcIndex]==((uint32_t)0xffffffff)) {
            ++srcIndex;
        }
    }
...
moveContentsTowardEnd(UCharIterator *api, UChar chars[], uint32_t states[], int32_t delta) {
    ...
    if(srcIndex<api->limit) {
        ...
        while(srcIndex>start && states[srcIndex]==((uint32_t)0xffffffff)) {
            --srcIndex;
        }
    }
...
readNext(UNormIterator *uni, UCharIterator *iter) {
    ...
    if(uni->state!=uni->states[limit]) {
        uiter_setState_48(iter, uni->states[limit], &errorCode);
        if(((errorCode)>U_ZERO_ERROR)) {
            uni->state=((uint32_t)0xffffffff);
            uni->hasNext=0;
            return 0;
        }
    }

    room=unorm_next_48(iter, uni->chars+limit, capacity-limit, uni->mode, 0, 1, ((void *)0), &errorCode);
    if(errorCode==U_BUFFER_OVERFLOW_ERROR) {
        if(room<=capacity) {
            ...
            capacity+=room+100;
            if(!reallocArrays(uni, capacity, 0)) {
                uni->state=((uint32_t)0xffffffff);
                uni->hasNext=0;
                return 0;
            }
    ...
    if(((errorCode)>U_ZERO_ERROR) || room==0) {
        uni->state=((uint32_t)0xffffffff);
        uni->hasNext=0;
        return 0;
    }
    ...
    for(--room; room>0; --room) {
        ...
        uni->states[limit++]=((uint32_t)0xffffffff);
    }
    uni->states[limit]=uni->state=uiter_getState_48(iter);
    uni->hasNext=iter->hasNext(iter);
    api->limit=limit;
    return 1;
}
...
readPrevious(UNormIterator *uni, UCharIterator *iter) {
    ...
    if(uni->state!=uni->states[start]) {
        uiter_setState_48(iter, uni->states[start], &errorCode);
        if(((errorCode)>U_ZERO_ERROR)) {
            uni->state=((uint32_t)0xffffffff);
            uni->hasPrevious=0;
            return 0;
    ...
    room=unorm_previous_48(iter, uni->chars, start, uni->mode, 0, 1, ((void *)0), &errorCode);
    if(errorCode==U_BUFFER_OVERFLOW_ERROR) {
        if(room<=capacity) {
            ...
            capacity+=room+100;
            if(!reallocArrays(uni, capacity, 1)) {
                uni->state=((uint32_t)0xffffffff);
                uni->hasPrevious=0;
                return 0;
            }
    ...
    do {
        ...
        uni->states[start]=((uint32_t)0xffffffff);
    } while(room>0);
    uni->states[start]=uni->state=uiter_getState_48(iter);
    uni->hasPrevious=iter->hasPrevious(iter);
    api->start=start;
    return 1;
}
...
unormIteratorMove(UCharIterator *api, int32_t delta, UCharIteratorOrigin origin) {
    ...
    case UITER_START:
        ...
        if(uni->hasPrevious) {
            ...
            api->start=api->index=api->limit=0;
            uni->states[api->limit]=uni->state=uiter_getState_48(iter);
            uni->hasPrevious=0;
            uni->hasNext=iter->hasNext(iter);
        } else {
...
unormIteratorSetState(UCharIterator *api, uint32_t state, UErrorCode *pErrorCode) {
    if(pErrorCode==((void *)0) || ((*pErrorCode)>U_ZERO_ERROR)) {
    ...
    } else if(state==((uint32_t)0xffffffff)) {
        *pErrorCode=U_INDEX_OUTOFBOUNDS_ERROR;
        ...
        if(state!=uni->state) {
            uni->state=state;
            uiter_setState_48(iter, state, pErrorCode);
        }
...
unorm_openIter_48(void *stackMem, int32_t stackMemSize, UErrorCode *pErrorCode) {
    ...
    uni=((void *)0);
    if(stackMem!=((void *)0) && stackMemSize>=sizeof(UNormIterator)) {
        if((((ptrdiff_t)(char *)(stackMem)) & (sizeof(UAlignedMemory) - 1))==0) {

            uni=(UNormIterator *)stackMem;
        } else {
            int32_t align=(int32_t)(sizeof(UAlignedMemory) - (((ptrdiff_t)(char *)(stackMem)) & (sizeof(UAlignedMemory) - 1)));
    ...
    if(uni!=((void *)0)) {
        uni->isStackAllocated=1;
    } else {
        uni=(UNormIterator *)uprv_malloc_48(sizeof(UNormIterator));
        if(uni==((void *)0)) {
            *pErrorCode=U_MEMORY_ALLOCATION_ERROR;
            return ((void *)0);
        }
        uni->isStackAllocated=0;
    }
    ...
    uni->state=((uint32_t)0xffffffff);
    uni->hasPrevious=uni->hasNext=0;
    uni->mode=UNORM_NONE;


    uiter_setString_48(&uni->api, ((void *)0), 0);
    return uni;
}
...
unorm_setIter_48(UNormIterator *uni, UCharIterator *iter, UNormalizationMode mode, UErrorCode *pErrorCode) {
    ...
    if( iter==((void *)0) || iter->getState==((void *)0) || iter->setState==((void *)0) ||
    ...
    memcpy(&uni->api, &unormIterator, sizeof(unormIterator));

    uni->iter=iter;
    uni->mode=mode;

    initIndexes(uni, iter);
    uni->states[uni->api.limit]=uni->state=uiter_getState_48(iter);
