...
//	$DialogText03="　";
	...
	if(!$DialogChangeState_Flag){
		CreateTexture("MSGWND/MSG_bak",2010000,0,0,"cg/sys/dialog/ダイアログkeep-out.png");
	}

	//■定義「選択肢」
	//box
	CreateTexture("MSGWND/MSG_msg",2010000,280,184,"cg/sys/dialog/ダイアログ台座2.png");
	//text
...
//			#SYSTEM_sound_volume_bgm=0;
			...
			CreateMovie360("妄想out", 2112000, Center, Middle, false, false, "dx/mvout.avi");
			//Request("妄想out", Play);
