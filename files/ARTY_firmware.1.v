...
//Command     : generate_target ARTY_firmware.bd
//Design      : ARTY_firmware
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "ARTY_firmware,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ARTY_firmware,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=23,numReposBlks=16,numNonXlnxBlks=0,numHierBlks=7,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,da_board_cnt=2,da_clkrst_cnt=1,da_mb_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "ARTY_firmware.hwdef" *) 
module ARTY_firmware
   (ddr3_sdram_addr,
    ddr3_sdram_ba,
    ddr3_sdram_cas_n,
    ddr3_sdram_ck_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN ARTY_firmware_sys_clock, FREQ_HZ 100000000, PHASE 0.000" *) input sys_clock;
  ...
  assign axi_gpio_0_GPIO2_TRI_I = shield_dp26_dp41_tri_i[15:0];
  ...
  assign shield_dp26_dp41_tri_o[15:0] = axi_gpio_0_GPIO2_TRI_O;
  assign shield_dp26_dp41_tri_t[15:0] = axi_gpio_0_GPIO2_TRI_T;
  assign sys_clock_1 = sys_clock;
  assign usb_uart_txd = axi_uartlite_0_UART_TxD;
  ARTY_firmware_axi_gpio_0_0 axi_gpio_0
  ...
  ARTY_firmware_axi_quad_spi_0_0 axi_quad_spi_0
  ...
  ARTY_firmware_axi_smc_0 axi_smc
  ...
  ARTY_firmware_axi_timer_0_0 axi_timer_0
       (.capturetrig0(1'b0),
        .capturetrig1(1'b0),
        .freeze(1'b0),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  ARTY_firmware_axi_uartlite_0_0 axi_uartlite_0
  ...
  ARTY_firmware_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(sys_clock_1),
        .clk_out1(clk_wiz_0_clk_out1),
        .clk_out2(clk_wiz_0_clk_out2),
        .resetn(reset_1));
  ARTY_firmware_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > ARTY_firmware microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ARTY_firmware_microblaze_0_0 microblaze_0
  ...
  ARTY_firmware_microblaze_0_axi_periph_0 microblaze_0_axi_periph
       (.ACLK(microblaze_0_Clk),
  ...
  microblaze_0_local_memory_imp_1PXJUY6 microblaze_0_local_memory
  ...
  ARTY_firmware_mig_7series_0_0 mig_7series_0
       (.aresetn(rst_mig_7series_0_83M_peripheral_aresetn),
  ...
  ARTY_firmware_rst_mig_7series_0_83M_0 rst_mig_7series_0_83M
       (.aux_reset_in(1'b1),
...
module ARTY_firmware_microblaze_0_axi_periph_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m00_couplers_imp_RT38L m00_couplers
       (.M_ACLK(M00_ACLK_1),
  ...
  m01_couplers_imp_16NL1M9 m01_couplers
       (.M_ACLK(M01_ACLK_1),
  ...
  m02_couplers_imp_1UEZJGS m02_couplers
       (.M_ACLK(M02_ACLK_1),
  ...
  m03_couplers_imp_W8GV4O m03_couplers
       (.M_ACLK(M03_ACLK_1),
  ...
  s00_couplers_imp_829VBU s00_couplers
...
module m01_couplers_imp_16NL1M9
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m02_couplers_imp_1UEZJGS
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m03_couplers_imp_W8GV4O
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module microblaze_0_local_memory_imp_1PXJUY6
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > ARTY_firmware microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ARTY_firmware_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  ARTY_firmware_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_dlmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  ARTY_firmware_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  ARTY_firmware_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_ilmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_0_ilmb_bus_WAIT));
  ARTY_firmware_lmb_bram_0 lmb_bram
...
module s00_couplers_imp_829VBU
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
