...
#include "nss/ch03_051a_★あやせ編_インターミッション０７Ａ.nss"
...
#include "nss/ch03_063r_★梨深編_インターミッション０９Ａ.nss"
#include "nss/ch03_064_折原梢.nss"
#include "nss/ch03_064a_★共通_妄想トリガー１２Ａ■.nss"
...
scene SelectStoryMode03
{
	...
	if(($GameName == "ch03_051a_★あやせ編_インターミッション０７Ａ" || $GameName == 0) && $あやせルート)
	{
		$ChapterName = "ch03_051a_★あやせ編_インターミッション０７Ａ";
		$GameName = 0;
	...
	if(($GameName == "ch03_063r_★梨深編_インターミッション０９Ａ" || $GameName == 0) && $梨深ルート)
	{
		$ChapterName = "ch03_063r_★梨深編_インターミッション０９Ａ";
		$GameName = 0;
	...
	if($GameName == "ch03_064a_★共通_妄想トリガー１２Ａ■" || $GameName == 0)
	{
		$ChapterName = "ch03_064a_★共通_妄想トリガー１２Ａ■";
		$GameName = 0;
