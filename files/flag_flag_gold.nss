...
string takers_color="GOLD";  //which group can take the flag.
string global_flag_taken="goldflagtaken";
string local_player_has_flag="hasgoldflag";
int takers_color_int = TEAM_GOLD;
