...
//:://////////////////////////////////////////////
//:: Updated On: October 10, 2009, doxic
//:://////////////////////////////////////////////
...
int MaximizeOrEmpower(int nDice, int nNumberOfDice, int nMeta, int nBonus = 0)
{
    ...
    //Resolve metamagic
    if (QuickMetaMagicMaximize(nMeta))
    {
        nDamage = nDice * nNumberOfDice;
    }
    else if (QuickMetaMagicEmpower(nMeta))
    {
...
void DoCamoflage(object oTarget)
{
    ...
    if (QuickMetaMagicExtend(nMetaMagic))    //Duration is +100%
    {
...
void spellApplyMindBlank(object oTarget, int nSpellId, float fDelay=0.0)
{
    ...
    int nMetaMagic = GetMetaMagic();
    //Enter Metamagic conditions
    if (QuickMetaMagicExtend(nMetaMagic))
    {
