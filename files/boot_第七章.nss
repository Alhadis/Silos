...
#include "nss/ch07_129r_★梨深編_インターミッション２７Ａ.nss"
...
#include "nss/ch07_142k_★梢編_インターミッション３０Ａ.nss"
...
#include "nss/ch07_151a_★あやせ編_１１月４日火.nss"
...
scene SelectStoryMode07
{
	...
	if(($GameName == "ch07_129_インターミッション２７" || $GameName == 0) && !$梨深ルート)
	{
		$ChapterName = "ch07_129_インターミッション２７";
		$GameName = 0;
		ch07_129_インターミッション２７();
	}
	if(($GameName == "ch07_129r_★梨深編_インターミッション２７Ａ" || $GameName == 0) && $梨深ルート)
	{
			$ChapterName = "ch07_129r_★梨深編_インターミッション２７Ａ";
			$GameName = 0;
	...
	if(($GameName == "ch07_142_インターミッション３０" || $GameName == 0) && !$梢ルート)
	{
		$ChapterName = "ch07_142_インターミッション３０";
		$GameName = 0;
		ch07_142_インターミッション３０();
	}
	if(($GameName == "ch07_142k_★梢編_インターミッション３０Ａ" || $GameName == 0) && $梢ルート)
	{
		$ChapterName = "ch07_142k_★梢編_インターミッション３０Ａ";
		$GameName = 0;
	...
	if(($GameName == "ch07_150_インターミッション３１ｂ" || $GameName == 0) && !$セナルート && !$優愛ルート && !$あやせルート)
	{
		$ChapterName = "ch07_150_インターミッション３１ｂ";
		$GameName = 0;
		ch07_150_インターミッション３１ｂ();
	}
	if(($GameName == "ch07_151_１１月４日火" || $GameName == 0) && !$セナルート && !$優愛ルート && !$梢ルート && !$あやせルート)
	{
		$ChapterName = "ch07_151_１１月４日火";
		$GameName = 0;
		ch07_151_１１月４日火();
	}
	if(($GameName == "ch07_151a_★あやせ編_１１月４日火" || $GameName == 0) && $あやせルート)
	{
		$ChapterName = "ch07_151a_★あやせ編_１１月４日火";
		$GameName = 0;
		ch07_151a_★あやせ編_１１月４日火();
	}
	if(($GameName == "ch07_152_インターミッション３２" || $GameName == 0) && !$梢ルート)
	{
		$ChapterName = "ch07_152_インターミッション３２";
		$GameName = 0;
		ch07_152_インターミッション３２();
	}
	if(($GameName == "ch07_153_七海の手首に包帯" || $GameName == 0) && !$セナルート && !$優愛ルート && !$梢ルート && !$あやせルート)
	{
