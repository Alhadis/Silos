...
Definition R := 49.
Definition proc := 50.
Definition StatusRegister_to_uint32 := 51.
Definition set_reg_or_pc := 52.
Definition spsr := 53.
Definition ConditionPassed := 54.
Definition MRS := 55.
...
Definition T9 := uint8.
Definition T10 := Tfunction T[`*` typ_SLv6_StatusRegister] uint32.
Definition T11 := Tfunction T[`*` typ_SLv6_Processor] (`*` typ_SLv6_StatusRegister).
Definition T12 := uint32.
Definition T13 := void.
...
then `if ((\R`:T7)==(#1`:T6)`:T6)
then (call (\set_reg_or_pc`:T8) E[\proc`:T2; \d`:T9; (call (\StatusRegister_to_uint32`:T10) E[(call (\spsr`:T11) E[\proc`:T2] T5)] T12)] T13)
else (call (\set_reg_or_pc`:T8) E[\proc`:T2; \d`:T9; (call (\StatusRegister_to_uint32`:T10) E[&((`*(\proc`:T2)`:T3)|cpsr`:T4)`:T4] T12)] T13)
else skip |}.

Definition fun_MRS :=
  (MRS, Internal fun_internal_MRS).

Definition functions : list (prod ident fundef) := [fun_MRS].
