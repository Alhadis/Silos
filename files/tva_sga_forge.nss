...
void SetItemLocals()
{
SetLocalString(OBJECT_SELF, "lsn1", "bladiumgreataxe");
SetLocalInt(OBJECT_SELF, "lsc_bladiumgreataxe", 4);
SetLocalString(OBJECT_SELF, "lsi1_bladiumgreataxe", "blackdiamond");
SetLocalString(OBJECT_SELF, "lsi2_bladiumgreataxe", "goldbrick");
SetLocalString(OBJECT_SELF, "lsi3_bladiumgreataxe", "verciditebuckle");
SetLocalString(OBJECT_SELF, "lsi4_bladiumgreataxe", "  gold  75000");
SetLocalInt(OBJECT_SELF, "lss_bladiumgreataxe", -10);
SetLocalInt(OBJECT_SELF, "lsv_bladiumgreataxe", VFX_FNF_STRIKE_HOLY);
