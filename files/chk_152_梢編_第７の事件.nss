...
//※以下、『ch08_156_妄想トリガー３５』より一部コピペ。ただし梨深がいないバージョンになっています
...
誰か、助けてくれ……。
梨深、どこに行ったんだよ。僕を守ってくれるんじゃ、なかったの……？

ダメだ、梨深はもう、当てにはできない。
今日だって、学校に行ってみたけど、梨深はいなかった。
まるで最初からいなかったみたいに。

だから、梨深以外の、頼りになる誰かに守ってもらうしかない。
真っ先に思い浮かんだのは――
...
//ＢＧ//Ｒｏｆｔ店内
	...
	SetVolume360("@CH01", 500, 400, null);

	CreateTextureEX("背景２", 100, 0, 0, "cg/bg/bg059_01_2_Ｒｏｆｔ店内_a.jpg");
	Fade("背景２", 0, 1000, null, true);

	CreateColor("黒１", 250, 0, 0, 1280, 720, "Black");
	Fade("黒１", 0, 300, null, true);

	Stand("bu梢_制服_武器構え青","angry", 100, @+150);
	FadeStand("bu梢_制服_武器構え青_angry", 0, true);
...
//ＢＧ//拓巳の部屋
	...
	CreateTextureEX("背景３", 100, 0, 0, "cg/bg/bg000_02_1_チャットサンプル_a.jpg");
	Fade("背景３", 1000, 1000, null, true);

	Delete("黒１");
	DeleteStand("bu梢_制服_武器構え青_angry", 0, true);
...
彼女は人として歪んでいる気がするけど、けっこうバカそうだから、僕の頼みも案外、素直に聞いてくれそうな気がする……。
