...
# 27 "../sysdeps/x86/cpu-features.c" 2
...
# 22 "../sysdeps/x86_64/tlsdesc.c" 2

# 1 "../sysdeps/x86_64/dl-tlsdesc.h" 1
# 24 "../sysdeps/x86_64/tlsdesc.c" 2
...
# 25 "../sysdeps/x86_64/tlsdesc.c" 2
# 1 "./tlsdeschtab.h" 1
# 27 "./tlsdeschtab.h"
# 1 "../include/inline-hashtab.h" 1
# 28 "../include/inline-hashtab.h"
...
htab_create (void)
{
  ...
  if (! ht)
    return 
# 53 "../include/inline-hashtab.h" 3 4
          ((void *)0)
# 53 "../include/inline-hashtab.h"
              ;
  ht->size = 3;
 ...
 ht->free (ht);
      return 
# 61 "../include/inline-hashtab.h" 3 4
            ((void *)0)
# 61 "../include/inline-hashtab.h"
                ;
    }
...
htab_expand (struct hashtab *htab, int (*hash_fn) (void *))
{
  ...
  if (nentries == 
# 145 "../include/inline-hashtab.h" 3 4
                 ((void *)0)
# 145 "../include/inline-hashtab.h"
                     )
    return 0;
  ...
  int (*hash_fn)(void *), int (*eq_fn)(void *, void *))
{
  ...
  if (htab->size * 3 <= htab->n_elements * 4
    ...
    return 
# 199 "../include/inline-hashtab.h" 3 4
          ((void *)0)
# 199 "../include/inline-hashtab.h"
              ;
 ...
 empty_entry:
  if (!insert)
    return 
# 228 "../include/inline-hashtab.h" 3 4
          ((void *)0)
# 228 "../include/inline-hashtab.h"
              ;
...
# 71 "./tlsdeschtab.h"
  ...
  return _rtld_local._dl_tls_generation + 1;
}
...
{
  if (caller != ({ if ((sizeof (*(&td->entry)) != 1) && (sizeof (*(&td->entry)) != 2) && (sizeof (*(&td->entry)) != 4) && (sizeof (*(&td->entry)) != 8)) __atomic_link_error ();; __atomic_load_n ((&td->entry), 0); }))
    return 1;
  ...
  do { if ((sizeof (*(&td->entry)) != 1) && (sizeof (*(&td->entry)) != 2) && (sizeof (*(&td->entry)) != 4) && (sizeof (*(&td->entry)) != 8)) __atomic_link_error ();; __atomic_store_n ((&td->entry), (_dl_tlsdesc_resolve_hold), 0); } while (0);
...
# 26 "../sysdeps/x86_64/tlsdesc.c" 2
# 34 "../sysdeps/x86_64/tlsdesc.c"
void
__attribute__ ((visibility ("hidden")))
_dl_tlsdesc_resolve_rela_fixup (struct tlsdesc volatile *td,
    struct link_map *l)
{
  const Elf64_Rela *reloc = td->arg;

  if (_dl_tlsdesc_resolve_early_return_p
      (td, (void*)((l)->l_info[(35 + 0 + 16 + 3 + 12 + (0x6ffffeff - (0x6ffffef6)))]->d_un.d_ptr + l->l_addr)))
    return;
  ...
  if ((((unsigned char) (sym->st_info)) >> 4) != 0
      && __builtin_expect (((sym->st_other) & 0x03), 0) == 0)
    {
      const struct r_found_version *version = 
# 57 "../sysdeps/x86_64/tlsdesc.c" 3 4
                                             ((void *)0)
# 57 "../sysdeps/x86_64/tlsdesc.c"
                                                 ;

      if (l->l_info[(35 + 0 + (0x6fffffff - (0x6ffffff0)))] != 
# 59 "../sysdeps/x86_64/tlsdesc.c" 3 4
                                             ((void *)0)
# 59 "../sysdeps/x86_64/tlsdesc.c"
                                                 )
 {
   ...
   if (version->hash == 0)
     version = 
# 66 "../sysdeps/x86_64/tlsdesc.c" 3 4
              ((void *)0)
# 66 "../sysdeps/x86_64/tlsdesc.c"
                  ;
 }
...
# 71 "../sysdeps/x86_64/tlsdesc.c" 3 4
                                 ((void *)0)
# 71 "../sysdeps/x86_64/tlsdesc.c"
                                     );
    }
  else
    {
  ...
  if (! sym)
  ...
  else
    {
      ...
      if (!(__builtin_expect ((result)->l_tls_offset != -1, 1) && (__builtin_expect ((result)->l_tls_offset != 0, 1) || _dl_try_allocate_static_tls (result) == 0)))
 {
