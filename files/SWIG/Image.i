...
#line 1 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image_MTK.ic"
...
#line 8 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image_MTK.ic"
...
#line 11 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image_MTK.ic"
...
Obj V_bk;
#line 10 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Resource.inc"
#line 22 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image_MTK.ic"
...
(Obj*)&V_bk,
#line 10 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Resource.inc"
#line 30 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image_MTK.ic"
};
...
static int load_background(void* p) { if(V_background.obj == 0) V_background.obj = Image_createImage(gpDC, "res/backgroud/2_bg.png"); if(V_background.obj == 0) return 1;else return 0; }
static int load_se1(void* p) { if(V_se1.obj == 0) V_se1.obj = Image_createImage(gpDC, "res/backgroud/1_bg.png"); if(V_se1.obj == 0) return 1;else return 0; }
static int load_red(void* p) { if(V_red.obj == 0) V_red.obj = Image_createImage(gpDC, "book_red.png"); if(V_red.obj == 0) return 1;else return 0; }
static int load_blue(void* p) { if(V_blue.obj == 0) V_blue.obj = Image_createImage(gpDC, "book_blue.png"); if(V_blue.obj == 0) return 1;else return 0; }
static int load_green(void* p) { if(V_green.obj == 0) V_green.obj = Image_createImage(gpDC, "book_green.png"); if(V_green.obj == 0) return 1;else return 0; }
static int load_bk(void* p) { if(V_bk.obj == 0) V_bk.obj = Image_createImage(gpDC, "bk.bmp"); if(V_bk.obj == 0) return 1;else return 0; }
#line 10 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Resource.inc"
#line 44 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image_MTK.ic"
...
imgList[i]->ID = i; imgList[i]->create = load_background; ++i;
imgList[i]->ID = i; imgList[i]->create = load_se1; ++i;
imgList[i]->ID = i; imgList[i]->create = load_red; ++i;
imgList[i]->ID = i; imgList[i]->create = load_blue; ++i;
imgList[i]->ID = i; imgList[i]->create = load_green; ++i;
imgList[i]->ID = i; imgList[i]->create = load_bk; ++i;
#line 10 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Resource.inc"
#line 58 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image_MTK.ic"
...
static void delObj(int idx) 
{
    ...
    {
      delete (Img*)imgPool->List[idx]->obj;
...
JImage* GETIMG(int x)
{
   return (Img*)instance_ResPool(&imgPool,init)->getObj(x)->obj;
}

void DELIMG(int x)
{
   instance_ResPool(&imgPool,init)->delObj(x);
}
#line 3 ".\\Image.cpp"
