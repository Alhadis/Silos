# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c"
# 21 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c"
...
# 22 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c" 2
...
uloc_toLanguageTag_48(const char* localeID,
                   ...
                   UBool strict,
                   UErrorCode* err);
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c" 2
...
u_strFromJavaModifiedUTF8WithSub_48(
        ...
        UChar32 subchar, int32_t *pNumSubstitutions,
        UErrorCode *pErrorCode);
# 24 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c" 2
...
ucasemap_utf8FoldCase_48(const UCaseMap *csm,
                      ...
                      const char *src, int32_t srcLength,
                      UErrorCode *pErrorCode);
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c" 2
...
# 26 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c" 2
...
# 27 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c" 2
...
# 28 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c" 2
...
# 29 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c" 2
...
appendResult(UChar *dest, int32_t destIndex, int32_t destCapacity,
    ...
    if(destIndex<destCapacity) {
        ...
        if(length<0) {
            ...
            UBool isError=0;
            { if((uint32_t)(c)<=0xffff) { (dest)[(destIndex)++]=(uint16_t)(c); } else if((uint32_t)(c)<=0x10ffff && (destIndex)+1<(destCapacity)) { (dest)[(destIndex)++]=(uint16_t)(((c)>>10)+0xd7c0); (dest)[(destIndex)++]=(uint16_t)(((c)&0x3ff)|0xdc00); } else { (isError)=1; } };
            if(isError) {

                destIndex+=((uint32_t)(c)<=0xffff ? 1 : 2);
            }
        } else {
...
utf16_caseContextIterator(void *context, int8_t dir) {
    ...
    if(dir<0) {
        if(csc->start<csc->index) {
            { (c)=((const UChar *)csc->p)[--(csc->index)]; if((((c)&0xfffffc00)==0xdc00)) { uint16_t __c2; if((csc->index)>(csc->start) && (((__c2=((const UChar *)csc->p)[(csc->index)-1])&0xfffffc00)==0xd800)) { --(csc->index); (c)=(((UChar32)(__c2)<<10UL)+(UChar32)((c))-((0xd800<<10UL)+0xdc00-0x10000)); } } };
            return c;
        }
    } else {
        if(csc->index<csc->limit) {
            { (c)=((const UChar *)csc->p)[(csc->index)++]; if((((c)&0xfffffc00)==0xd800)) { uint16_t __c2; if((csc->index)<(csc->limit) && (((__c2=((const UChar *)csc->p)[(csc->index)])&0xfffffc00)==0xdc00)) { ++(csc->index); (c)=(((UChar32)((c))<<10UL)+(UChar32)(__c2)-((0xd800<<10UL)+0xdc00-0x10000)); } } };
            return c;
        }
    }
    return (-1);
...
_caseMap(const UCaseMap *csm, UCaseMapFull *map,
    ...
    while(srcIndex<srcLimit) {
        ...
        { (c)=(src)[(srcIndex)++]; if((((c)&0xfffffc00)==0xd800)) { uint16_t __c2; if((srcIndex)<(srcLimit) && (((__c2=(src)[(srcIndex)])&0xfffffc00)==0xdc00)) { ++(srcIndex); (c)=(((UChar32)((c))<<10UL)+(UChar32)(__c2)-((0xd800<<10UL)+0xdc00-0x10000)); } } };
...
# 170 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c"
    int i;
    char c;


    if(locale==((void *)0)) {
        locale=uloc_getDefault_48();
    }
...
_toTitle(UCaseMap *csm,
    ...
    if(csm->iter!=((void *)0)) {
        ubrk_setText_48(csm->iter, src, srcLength, pErrorCode);
    } else {
...
# 261 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c"
        if(prev<idx) {

            titleStart=titleLimit=prev;
            { (c)=(src)[(titleLimit)++]; if((((c)&0xfffffc00)==0xd800)) { uint16_t __c2; if((titleLimit)<(idx) && (((__c2=(src)[(titleLimit)])&0xfffffc00)==0xdc00)) { ++(titleLimit); (c)=(((UChar32)((c))<<10UL)+(UChar32)(__c2)-((0xd800<<10UL)+0xdc00-0x10000)); } } };
            if((csm->options&0x200)==0 && UCASE_NONE==ucase_getType_48(csm->csp, c)) {
                ...
                if(length>0) {
                    if((destIndex+length)<=destCapacity) {
                        memcpy(dest+destIndex, src+prev, length*2);
                    }
                    destIndex+=length;
                }
            }
            ...
            if(titleStart<titleLimit) {
                ...
                c=ucase_toFullTitle_48(csm->csp, c, utf16_caseContextIterator, csc, &s, csm->locale, &csm->locCache);
                destIndex=appendResult(dest, destIndex, destCapacity, c, s);
                ...
                if(titleLimit<idx) {
                    if((csm->options&0x100)==0) {
                        ...
                        if((destIndex+length)<=destCapacity) {
                            memcpy(dest+destIndex, src+titleLimit, length*2);
                        }
                        destIndex+=length;
                    }
                }
...
ustr_toLower_48(const UCaseProps *csp,
    ...
    return _caseMap(&csm, ucase_toFullLower_48,
                    dest, destCapacity,
                    src, &csc, 0, srcLength,
                    pErrorCode);
}
...
ustr_toUpper_48(const UCaseProps *csp,
    ...
    return _caseMap(&csm, ucase_toFullUpper_48,
                    dest, destCapacity,
                    src, &csc, 0, srcLength,
                    pErrorCode);
}
...
ustr_toTitle_48(const UCaseProps *csp,
    ...
    length=_toTitle(&csm,
                    ...
                    src, &csc, srcLength,
                    pErrorCode);
    if(titleIter==((void *)0) && csm.iter!=((void *)0)) {
...
ustr_foldCase_48(const UCaseProps *csp,
    ...
    while(srcIndex<srcLength) {
        { (c)=(src)[(srcIndex)++]; if((((c)&0xfffffc00)==0xd800)) { uint16_t __c2; if((srcIndex)<(srcLength) && (((__c2=(src)[(srcIndex)])&0xfffffc00)==0xdc00)) { ++(srcIndex); (c)=(((UChar32)((c))<<10UL)+(UChar32)(__c2)-((0xd800<<10UL)+0xdc00-0x10000)); } } };
...
# 452 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c"
static int32_t
caseMap(const UCaseMap *csm,
    ...
    if( dest!=((void *)0) &&
        ...
        if(destCapacity<=(sizeof(buffer)/2)) {

            temp=buffer;
        } else {

            temp=(UChar *)uprv_malloc_48(destCapacity*2);
            if(temp==((void *)0)) {
    ...
    if(toWhichCase==FOLD_CASE) {
        destLength=ustr_foldCase_48(csm->csp, temp, destCapacity, src, srcLength,
    ...
    if(temp!=dest) {
        ...
        if(destLength>0) {
            ...
            if(copyLength>0) {
                memmove(dest, temp, copyLength*2);
            }
        }
        if(temp!=buffer) {
            uprv_free_48(temp);
...
# 642 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c"
...
u_strcmpFold_48(const UChar *s1, int32_t length1,
    ...
    for(;;) {
        ...
        if(c1<0) {
            ...
            for(;;) {
                if(s1==limit1 || ((c1=*s1)==0 && (limit1==((void *)0) || (options&0x1000)))) {
                    if(level1==0) {
                        c1=-1;
                        break;
                    }
        ...
        if(c2<0) {
            ...
            for(;;) {
                if(s2==limit2 || ((c2=*s2)==0 && (limit2==((void *)0) || (options&0x1000)))) {
                    if(level2==0) {
                        c2=-1;
                        break;
                    }
        ...
        cp1=c1;
        if((((c1)&0xfffff800)==0xd800)) {
            UChar c;

            if((((c1)&0x400)==0)) {
                if(s1!=limit1 && (((c=*s1)&0xfffffc00)==0xdc00)) {

                    cp1=(((UChar32)(c1)<<10UL)+(UChar32)(c)-((0xd800<<10UL)+0xdc00-0x10000));
                }
            } else {
                if(start1<=(s1-2) && (((c=*(s1-2))&0xfffffc00)==0xd800)) {
                    cp1=(((UChar32)(c)<<10UL)+(UChar32)(c1)-((0xd800<<10UL)+0xdc00-0x10000));
                }
            }
        }

        cp2=c2;
        if((((c2)&0xfffff800)==0xd800)) {
            UChar c;

            if((((c2)&0x400)==0)) {
                if(s2!=limit2 && (((c=*s2)&0xfffffc00)==0xdc00)) {

                    cp2=(((UChar32)(c2)<<10UL)+(UChar32)(c)-((0xd800<<10UL)+0xdc00-0x10000));
                }
            } else {
                if(start2<=(s2-2) && (((c=*(s2-2))&0xfffffc00)==0xd800)) {
                    cp2=(((UChar32)(c)<<10UL)+(UChar32)(c2)-((0xd800<<10UL)+0xdc00-0x10000));
                }
            }
        }
        ...
        if( level1==0 &&
            (length=ucase_toFullFolding_48(csp, (UChar32)cp1, &p, options))>=0
        ) {
            ...
            if(length<=UCASE_MAX_STRING_LENGTH) {
                u_memcpy_48(fold1, p, length);
            } else {
                int32_t i=0;
                { if((uint32_t)(length)<=0xffff) { (fold1)[(i)++]=(uint16_t)(length); } else { (fold1)[(i)++]=(uint16_t)(((length)>>10)+0xd7c0); (fold1)[(i)++]=(uint16_t)(((length)&0x3ff)|0xdc00); } };
                length=i;
            }
        ...
        if( level2==0 &&
            (length=ucase_toFullFolding_48(csp, (UChar32)cp2, &p, options))>=0
        ) {
            ...
            if(length<=UCASE_MAX_STRING_LENGTH) {
                u_memcpy_48(fold2, p, length);
            } else {
                int32_t i=0;
                { if((uint32_t)(length)<=0xffff) { (fold2)[(i)++]=(uint16_t)(length); } else { (fold2)[(i)++]=(uint16_t)(((length)>>10)+0xd7c0); (fold2)[(i)++]=(uint16_t)(((length)&0x3ff)|0xdc00); } };
                length=i;
            }
...
# 918 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrcase.c"
        if(c1>=0xd800 && c2>=0xd800 && (options&0x8000)) {

            if(
                (c1<=0xdbff && s1!=limit1 && (((*s1)&0xfffffc00)==0xdc00)) ||
                ((((c1)&0xfffffc00)==0xdc00) && start1!=(s1-1) && (((*(s1-2))&0xfffffc00)==0xd800))
            ) {
            ...
            if(
                (c2<=0xdbff && s2!=limit2 && (((*s2)&0xfffffc00)==0xdc00)) ||
                ((((c2)&0xfffffc00)==0xdc00) && start2!=(s2-1) && (((*(s2-2))&0xfffffc00)==0xd800))
            ) {
...
u_strCaseCompare_48(const UChar *s1, int32_t length1,
    ...
    if(pErrorCode==0 || ((*pErrorCode)>U_ZERO_ERROR)) {
        return 0;
    }
    if(s1==((void *)0) || length1<-1 || s2==((void *)0) || length2<-1) {
        *pErrorCode=U_ILLEGAL_ARGUMENT_ERROR;
        return 0;
    }
    return u_strcmpFold_48(s1, length1, s2, length2,
                        options|0x10000,
                        pErrorCode);
}
...
u_strcasecmp_48(const UChar *s1, const UChar *s2, uint32_t options) {
    ...
    return u_strcmpFold_48(s1, -1, s2, -1,
                        options|0x10000,
                        &errorCode);
}
...
u_memcasecmp_48(const UChar *s1, const UChar *s2, int32_t length, uint32_t options) {
    UErrorCode errorCode=U_ZERO_ERROR;
    return u_strcmpFold_48(s1, length, s2, length,
                        options|0x10000,
                        &errorCode);
}
...
u_strncasecmp_48(const UChar *s1, const UChar *s2, int32_t n, uint32_t options) {
    UErrorCode errorCode=U_ZERO_ERROR;
    return u_strcmpFold_48(s1, n, s2, n,
                        options|(0x10000|0x1000),
                        &errorCode);
}
