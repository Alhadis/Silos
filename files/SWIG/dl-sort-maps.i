            ...
            for_fini)
{
  ...
  while (1)
    {
      ...
      if (__builtin_expect ((for_fini), 0))
 {
      ...
      while (k > i)
 {
   ...
   if (runp != 
# 57 "dl-sort-maps.c" 3 4
              ((void *)0)
# 57 "dl-sort-maps.c"
                  )

     while (*runp != 
# 59 "dl-sort-maps.c" 3 4
                    ((void *)0)
# 59 "dl-sort-maps.c"
                        )
...
# 69 "dl-sort-maps.c"
   ...
   if (__builtin_expect ((for_fini && maps[k]->l_reldeps != 
# 90 "dl-sort-maps.c" 3 4
      ((void *)0)
# 90 "dl-sort-maps.c"
      ), 0))
     {
  ...
  if (__builtin_expect ((relmaps[m] == thisp), 0))
    {
      ...
      if (runp != 
# 102 "dl-sort-maps.c" 3 4
                 ((void *)0)
# 102 "dl-sort-maps.c"
                     )
        while (*runp != 
# 103 "dl-sort-maps.c" 3 4
                       ((void *)0)
# 103 "dl-sort-maps.c"
                           )
