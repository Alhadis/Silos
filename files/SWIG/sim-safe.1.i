# 1 "sim-safe.c"
# 1 "/home/zhlb29/Desktop/Assignment1/sim-cpen411//"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 134 "sim-safe.c"
  ...
  stat_reg_formula(sdb, "sim_cond_branch_freq",
    ...
    "sim_num_cond_branches / sim_num_insn", 
# 137 "sim-safe.c" 3 4
                                           ((void *)0)
# 137 "sim-safe.c"
                                               );
...
# 338 "sim-safe.c" 2
 default:
   _panic("sim-safe.c", __FUNCTION__, 339, "attempted to execute a bogus opcode");
      }

      if (fault != md_fault_none)
 _fatal("sim-safe.c", __FUNCTION__, 343, "fault (%d) detected @ 0x%08p", fault, regs.regs_PC);
