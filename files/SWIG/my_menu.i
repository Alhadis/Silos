...
void main_menu(char* id,char menu)
{
    ...
    if(menu==1)
    {
		...
		Lcd_WriteChineseStringClarity(25+125/2-16,55+50/2-8,0xf800,0,"ÏµÍ³",0); 
		Lcd_WriteChineseStringClarity(25+125+(320-125*2-25*2)+125/2-16,55+50/2-8,0xf800,0,"ä¯ÀÀ",0);
		Lcd_WriteChineseStringClarity(25+125/2-12,55+50+(240-50*2-55*2)+50/2-8,0xf800,0,"GPS",0);
		Lcd_WriteChineseStringClarity(25+125+(320-125*2-25*2)+125/2-16,55+50+(240-50*2-55*2)+50/2-8,0xf800,0,"ÉãÏñ",0);
    ...
    {	
		...
		f_mount(0, &fs);	
		f_open(&fsrc,"st1616.bin", 0x00 | 0x01);
		Lcd_WriteChineseStringClarity(25+125/2-16,55+50/2-8,0xf800,0,"³··À",0); 
		Lcd_WriteChineseStringClarity(25+125+(320-125*2-25*2)+125/2-16,55+50/2-8,0xf800,0,"²¼·À",0);
		Lcd_WriteChineseStringClarity(25+125/2-16,55+50+(240-50*2-55*2)+50/2-8,0xf800,0,"½ÚÄÜ",0);
		Lcd_WriteChineseStringClarity(25+125+(320-125*2-25*2)+125/2-16,55+50+(240-50*2-55*2)+50/2-8,0xf800,0,"ÍË³ö",0);
	}
    ...
    if(menu==3)
    {
		...
		f_mount(0, &fs);	
		f_open(&fsrc,"st1616.bin", 0x00 | 0x01);
		Lcd_WriteChineseStringClarity(25+125/2-32,55+50/2-8,0xf800,0,"É¾³ýÈ«²¿",0); 
		Lcd_WriteChineseStringClarity(25+125+(320-125*2-25*2)+125/2-32,55+50/2-8,0xf800,0,"Ê±¼äÉèÖÃ",0);
		Lcd_WriteChineseStringClarity(25+125+(320-125*2-25*2)+125/2-16,55+50+(240-50*2-55*2)+50/2-8,0xf800,0,"ÍË³ö",0);
		Lcd_WriteChineseStringClarity(25+125/2-28,55+50+(240-50*2-55*2)+50/2-18,0xf800,0,"¦ÌC/GUI",0);
		Lcd_WriteChineseStringClarity(25+125/2-24,55+50+(240-50*2-55*2)+50/2+ 2,0xf800,0,"Á·Ï°³¡",0);
    }
