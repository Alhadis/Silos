...
init (void)
{
  ...
  if (fromlist != 
# 69 "sotruss-lib.c" 3 4
                 ((void *)0) 
# 69 "sotruss-lib.c"
                      && fromlist[0] == '\0')
    fromlist = 
# 70 "sotruss-lib.c" 3 4
              ((void *)0)
# 70 "sotruss-lib.c"
                  ;
  tolist = getenv ("SOTRUSS_TOLIST");
  if (tolist != 
# 72 "sotruss-lib.c" 3 4
               ((void *)0) 
# 72 "sotruss-lib.c"
                    && tolist[0] == '\0')
    tolist = 
# 73 "sotruss-lib.c" 3 4
            ((void *)0)
# 73 "sotruss-lib.c"
                ;
...
# 85 "sotruss-lib.c"
                              && out_filename[0] != 0)
 {
   ...
   if (which_process == 
# 90 "sotruss-lib.c" 3 4
                       ((void *)0) 
# 90 "sotruss-lib.c"
                            || which_process[0] == '\0')
     snprintf (endp, 13, ".%ld", (long int) pid);

   out_fd = open (fullname, 02 | 0100 | 01000, 0666);
   if (out_fd != -1)
     print_pid = 0;
 }
    }
...
# 175 "sotruss-lib.c" 3 4
                          ((void *)0)
# 175 "sotruss-lib.c"
                              ;
  for (struct libname_list *l = map->l_libname; l != 
# 176 "sotruss-lib.c" 3 4
                                                    ((void *)0)
# 176 "sotruss-lib.c"
                                                        ; l = l->next)
    {
      if (print_name == 
# 178 "sotruss-lib.c" 3 4
                       ((void *)0) 
# 178 "sotruss-lib.c"
                            || (print_name[0] == '/' && l->name[0] != '/'))
 print_name = l->name;

      if (fromlist != 
# 181 "sotruss-lib.c" 3 4
                     ((void *)0)
# 181 "sotruss-lib.c"
                         )
...
uintptr_t
la_symbind64 (Elf_Sym *sym, unsigned int ndx, uintptr_t *refcook,
