...
# 36 "../sysdeps/unix/sysv/linux/sysdep-cancel.h"
extern int __libc_multiple_threads;
# 29 "dl-sym.c" 2
# 1 "../sysdeps/x86_64/dl-tls.h" 1
# 25 "../sysdeps/x86_64/dl-tls.h"
...
# 43 "dl-sym.c"
static void *
_dl_tls_symaddr (struct link_map *map, const Elf64_Sym *ref)
{
...
call_dl_lookup (void *ptr)
{
  ...
  args->map = _rtld_global_ro._dl_lookup_symbol_x (args->name, args->map, args->refp,
...
# 88 "dl-sym.c"
                            ;
  lookup_t result;
  Elf64_Addr caller = (Elf64_Addr) who;

  struct link_map *l = _dl_find_dso_for_object (caller);


  struct link_map *match = l ? l : _rtld_global._dl_ns[0]._ns_loaded;
...
# 104 "dl-sym.c"
 ...
 result = _rtld_global_ro._dl_lookup_symbol_x (name, match, &ref,
...
# 123 "dl-sym.c"
     ...
     _dl_signal_exception (err, &exception, 
# 124 "dl-sym.c" 3 4
                                           ((void *)0)
# 124 "dl-sym.c"
                                               );
  ...
  else if (handle == ((void *) -1l))
    {
      if (__builtin_expect ((match == _rtld_global._dl_ns[0]._ns_loaded), 0))
 {
   if (match == 
# 133 "dl-sym.c" 3 4
               ((void *)0)
...
# 141 "dl-sym.c"
 ...
 l = l->l_loader;
      ...
      result = _rtld_global_ro._dl_lookup_symbol_x (name, match, &ref, l->l_local_scope,
      vers, 0, 0, match);
    }
  else
    {
      ...
      result = _rtld_global_ro._dl_lookup_symbol_x (name, map, &ref, map->l_local_scope,
      vers, 0, flags, 
# 152 "dl-sym.c" 3 4
                     ((void *)0)
# 152 "dl-sym.c"
...
# 166 "dl-sym.c" 3 4
        0
# 166 "dl-sym.c"
        ) || (result) ? (result)->l_addr : 0)) + (ref)->st_value);


      if (__builtin_expect ((((ref->st_info) & 0xf) == 10), 0))
 {
   Elf64_Addr fixup
     = ((Elf64_Addr) value);
   fixup = elf_ifunc_invoke ((fixup));
   value = (void *) (fixup);
 }
      ...
      if (__builtin_expect ((_rtld_global_ro._dl_naudit > 0), 0))
 {
   const char *strtab = (const char *) (result)->l_info[5]->d_un.d_ptr
                             ;


   unsigned int ndx = (ref - (Elf64_Sym *) (result)->l_info[6]->d_un.d_ptr
                          );

   if ((match->l_audit_any_plt | result->l_audit_any_plt) != 0)
     {
       unsigned int altvalue = 0;
       struct audit_ifaces *afct = _rtld_global_ro._dl_audit;


       Elf64_Sym sym = *ref;
       sym.st_value = (Elf64_Addr) value;

       for (unsigned int cnt = 0; cnt < _rtld_global_ro._dl_naudit; ++cnt)
  {
    if (afct->symbind64 != 
# 201 "dl-sym.c" 3 4
                        ((void *)0)
