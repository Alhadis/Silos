...
#line 15 "..\\user\\oled_096.h"
#line 16 "..\\user\\oled_096.h"
#line 17 "..\\user\\oled_096.h"
#line 18 "..\\user\\oled_096.h"
...
void rtc_config(void)
{
 uint32_t err_code;
 RTC_Init();	
 err_code = app_timer_start(m_rtc_update_timer_id, ((uint32_t)((((1000) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000))), 0);
 do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 56, (uint8_t*) "..\\user\\rtc.c"); } while (0); } } while (0);
...
void RTC_Update(void)
{
	...
	if(++RTC_Con.Second_Reg>=60)
	{
		RTC_Con.Second_Reg=0;
		if(++RTC_Con.Min_Reg>=60)
		{
		  RTC_Con.Min_Reg=0;
			if(++RTC_Con.Hour_Reg>=24)
			{
       RTC_Con.Hour_Reg=0;
			if(++RTC_Con.Day_Reg>=no_of_day)
			{
       RTC_Con.Day_Reg=1; 
			if(++RTC_Con.Month_Reg>=12)
			  {
         RTC_Con.Month_Reg=1;
				 RTC_Con.Year_Reg++;
