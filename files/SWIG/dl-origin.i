# 1 "../sysdeps/unix/sysv/linux/dl-origin.c"
...
# 1 "<command-line>" 2
# 1 "../sysdeps/unix/sysv/linux/dl-origin.c"
# 20 "../sysdeps/unix/sysv/linux/dl-origin.c"
...
# 21 "../sysdeps/unix/sysv/linux/dl-origin.c" 2
...
# 22 "../sysdeps/unix/sysv/linux/dl-origin.c" 2
...
extern char *__strncat_chk (char *__restrict __dest,
       const char *__restrict __src,
       size_t __len, size_t __destlen) __attribute__ ((__nothrow__ ));
# 23 "../sysdeps/unix/sysv/linux/dl-origin.c" 2
...
# 24 "../sysdeps/unix/sysv/linux/dl-origin.c" 2
...
# 25 "../sysdeps/unix/sysv/linux/dl-origin.c" 2
...
# 26 "../sysdeps/unix/sysv/linux/dl-origin.c" 2
...
# 20 "./dl-dst.h" 2
# 29 "../sysdeps/unix/sysv/linux/dl-origin.c" 2
...
{
  char linkval[
# 37 "../sysdeps/unix/sysv/linux/dl-origin.c" 3 4
              4096
# 37 "../sysdeps/unix/sysv/linux/dl-origin.c"
                      ];
  char *result;
  int len;
  do { } while (0);
...
# 42 "../sysdeps/unix/sysv/linux/dl-origin.c" 3 4
       89
# 42 "../sysdeps/unix/sysv/linux/dl-origin.c"
       ), "r" (_a1), "r" (_a2), "r" (_a3) : "memory", "cc", "r11", "cx"); (long int) resultvar; })
                      ;
  if (! ((unsigned long int) (long int) (len) >= -4095L) && len > 0 && linkval[0] != '[')
    {

      ((void) sizeof ((linkval[0] == '/') ? 1 : 0), __extension__ ({ if (linkval[0] == '/') ; else __assert_fail ("linkval[0] == '/'", "../sysdeps/unix/sysv/linux/dl-origin.c", 47, __extension__ __PRETTY_FUNCTION__); }));
      while (len > 1 && linkval[len - 1] != '/')
 --len;
      result = (char *) malloc (len + 1);
      if (result == 
# 51 "../sysdeps/unix/sysv/linux/dl-origin.c" 3 4
                   ((void *)0)
# 51 "../sysdeps/unix/sysv/linux/dl-origin.c"
                       )
 result = (char *) -1;
      else if (len == 1)
 memcpy (result, "/", 2);
      else
 *((char *) __builtin_mempcpy (result, linkval, len - 1)) = '\0';
    }
  else
    {
      result = (char *) -1;
      ...
      if (_rtld_local_ro._dl_origin_path != 
# 63 "../sysdeps/unix/sysv/linux/dl-origin.c" 3 4
                                 ((void *)0)
# 63 "../sysdeps/unix/sysv/linux/dl-origin.c"
                                     )
 {
   size_t len = strlen (_rtld_local_ro._dl_origin_path);
   result = (char *) malloc (len + 1);
   if (result == 
# 67 "../sysdeps/unix/sysv/linux/dl-origin.c" 3 4
                ((void *)0)
# 67 "../sysdeps/unix/sysv/linux/dl-origin.c"
                    )
     result = (char *) -1;
   else
     {
       char *cp = __builtin_mempcpy (result, _rtld_local_ro._dl_origin_path, len);
