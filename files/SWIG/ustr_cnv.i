# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustr_cnv.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustr_cnv.c"
# 19 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustr_cnv.c"
...
# 20 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustr_cnv.c" 2
...
u_strFromJavaModifiedUTF8WithSub_48(
        ...
        UChar32 subchar, int32_t *pNumSubstitutions,
        UErrorCode *pErrorCode);
# 24 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustr_cnv.c" 2
...
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustr_cnv.c" 2
...
# 26 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustr_cnv.c" 2
...
# 27 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustr_cnv.c" 2
...
# 28 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustr_cnv.c" 2
...
# 29 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustr_cnv.c" 2



static UConverter *gDefaultConverter = ((void *)0);

extern UConverter*
u_getDefaultConverter_48(UErrorCode *status)
{
    UConverter *converter = ((void *)0);

    if (gDefaultConverter != ((void *)0)) {
        umtx_lock_48(((void *)0));


        if (gDefaultConverter != ((void *)0)) {
            converter = gDefaultConverter;
            gDefaultConverter = ((void *)0);
        }
    ...
    if(converter == ((void *)0)) {
        converter = ucnv_open_48(((void *)0), status);
        if(((*status)>U_ZERO_ERROR)) {
            ucnv_close_48(converter);
            converter = ((void *)0);
        }
    }
...
# 114 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustr_cnv.c"
...
extern UChar*
u_uastrncpy_48(UChar *ucs1,
           const char *s2,
           int32_t n)
{
  UChar *target = ucs1;
  UErrorCode err = U_ZERO_ERROR;
  UConverter *cnv = u_getDefaultConverter_48(&err);
  if(((err)<=U_ZERO_ERROR) && cnv != ((void *)0)) {
    ucnv_reset_48(cnv);
    ucnv_toUnicode_48(cnv,
                   &target,
                   ucs1+n,
                   &s2,
                   s2+u_astrnlen(s2, n),
...
extern UChar*
u_uastrcpy_48(UChar *ucs1,
          const char *s2 )
{
  UErrorCode err = U_ZERO_ERROR;
  UConverter *cnv = u_getDefaultConverter_48(&err);
  if(((err)<=U_ZERO_ERROR) && cnv != ((void *)0)) {
    ucnv_toUChars_48(cnv,
                    ucs1,
                    0x0FFFFFFF,
                    s2,
                    (int32_t) strlen(s2),
...
extern char*
u_austrcpy_48(char *s1,
         const UChar *ucs2 )
{
  UErrorCode err = U_ZERO_ERROR;
  UConverter *cnv = u_getDefaultConverter_48(&err);
  if(((err)<=U_ZERO_ERROR) && cnv != ((void *)0)) {
    int32_t len = ucnv_fromUChars_48(cnv,
                  s1,
                  0x0FFFFFFF,
                  ucs2,
                  -1,
