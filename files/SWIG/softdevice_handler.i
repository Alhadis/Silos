...
#line 86 "..\\Include\\sd_common\\softdevice_handler.h"
...
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (event_size == 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 152, (uint8_t*) "..\\Include\\sd_common\\softdevice_handler.h"); } while (0); } } while (0);
