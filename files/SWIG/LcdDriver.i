...
void lcdPinWrite(char reg) {
    ...
    if (value.lcd_DBS.pinDB4 == 1) LATBbits.LATB4 = 1;
    if (value.lcd_DBS.pinDB5 == 1) LATBbits.LATB5 = 1;
    if (value.lcd_DBS.pinDB6 == 1) LATBbits.LATB6 = 1;
    if (value.lcd_DBS.pinDB7 == 1) LATBbits.LATB7 = 1;
}
