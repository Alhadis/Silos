# 1 "../../lib/zlib_deflate/deflate.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../lib/zlib_deflate/deflate.c"
# 51 "../../lib/zlib_deflate/deflate.c"
...
# 52 "../../lib/zlib_deflate/deflate.c" 2
...
static inline __attribute__((always_inline)) unsigned long deflateBound(unsigned long s)
{
...
# 53 "../../lib/zlib_deflate/deflate.c" 2
# 1 "../../lib/zlib_deflate/defutil.h" 1
# 40 "../../lib/zlib_deflate/defutil.h"
...
# 99 "../../lib/zlib_deflate/defutil.h"
    ...
    uInt max_lazy_match;
# 158 "../../lib/zlib_deflate/defutil.h"
    int level;
    int strategy;
    ...
    uInt lit_bufsize;
# 212 "../../lib/zlib_deflate/defutil.h"
    uInt last_lit;
...
typedef struct deflate_workspace {
    ...
    Pos head_memory[1 << (8 + 7)];
    char overlay_memory[(1 << (8 + 6)) * (sizeof(ush)+2)];
} deflate_workspace;
# 267 "../../lib/zlib_deflate/defutil.h"
...
# 291 "../../lib/zlib_deflate/defutil.h"
static inline __attribute__((always_inline)) unsigned bi_reverse(unsigned code,
      int len)
{
...
static inline __attribute__((always_inline)) void bi_flush(deflate_state *s)
{
    if (s->bi_valid == 16) {
...
static inline __attribute__((always_inline)) void bi_windup(deflate_state *s)
{
    if (s->bi_valid > 8) {
        { {s->pending_buf[s->pending++] = ((uch)((s->bi_buf) & 0xff));}; {s->pending_buf[s->pending++] = ((uch)((ush)(s->bi_buf) >> 8));}; };
...
# 54 "../../lib/zlib_deflate/deflate.c" 2
...
# 106 "../../lib/zlib_deflate/deflate.c"
...
# 167 "../../lib/zlib_deflate/deflate.c"
...
)
{
    ...
    if (memLevel < 1 || memLevel > 8 || method != 8 ||
...
# 283 "../../lib/zlib_deflate/deflate.c"
...
# 357 "../../lib/zlib_deflate/deflate.c"
...
)
{
 ...
 bstate = (*(configuration_table[s->level].func))(s, flush);
  ...
  zlib_tr_stored_type_only(s);
                ...
                if (flush == 4) {
                    s->head[s->hash_size-1] = 0; ({ void *__p = ((char *)s->head); size_t __n = (unsigned)(s->hash_size-1)*sizeof(*s->head); if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });;
                }
            }
            flush_pending(strm);
     if (strm->avail_out == 0) {
...
)
{
    ...
    if (strm == ((void *)0) || strm->state == ((void *)0)) return (-2);
    s = (deflate_state *) strm->state;
...
# 620 "../../lib/zlib_deflate/deflate.c"
static int read_buf(
 z_streamp strm,
 Byte *buf,
 unsigned size
...
# 681 "../../lib/zlib_deflate/deflate.c"
...
)
{
    ...
    Pos *prev = s->prev;
    uInt wmask = s->w_mask;
# 708 "../../lib/zlib_deflate/deflate.c"
...
# 771 "../../lib/zlib_deflate/deflate.c"
...
# 860 "../../lib/zlib_deflate/deflate.c"
...
# 930 "../../lib/zlib_deflate/deflate.c"
        ;
...
# 980 "../../lib/zlib_deflate/deflate.c"
 ...
 s->lookahead = 0;
  ...
  max_start = s->block_start + max_block_size;
     ...
     s->strstart = (uInt)max_start;
            { { zlib_tr_flush_block(s, (s->block_start >= 0L ? (char *)&s->window[(unsigned)s->block_start] : ((void *)0)), (ulg)((long)s->strstart - s->block_start), (0)); s->block_start = s->strstart; flush_pending(s->strm); ; }; if (s->strm->avail_out == 0) return (0) ? finish_started : need_more; };
 }
    ...
    { { zlib_tr_flush_block(s, (s->block_start >= 0L ? (char *)&s->window[(unsigned)s->block_start] : ((void *)0)), (ulg)((long)s->strstart - s->block_start), (flush == 5)); s->block_start = s->strstart; flush_pending(s->strm); ; }; if (s->strm->avail_out == 0) return (flush == 5) ? finish_started : need_more; };
    return flush == 5 ? finish_done : block_done;
}
# 1039 "../../lib/zlib_deflate/deflate.c"
...
)
{
    ...
    for (;;) {
        ...
        if (bflush) { { zlib_tr_flush_block(s, (s->block_start >= 0L ? (char *)&s->window[(unsigned)s->block_start] : ((void *)0)), (ulg)((long)s->strstart - s->block_start), (0)); s->block_start = s->strstart; flush_pending(s->strm); ; }; if (s->strm->avail_out == 0) return (0) ? finish_started : need_more; };
    }
    { { zlib_tr_flush_block(s, (s->block_start >= 0L ? (char *)&s->window[(unsigned)s->block_start] : ((void *)0)), (ulg)((long)s->strstart - s->block_start), (flush == 5)); s->block_start = s->strstart; flush_pending(s->strm); ; }; if (s->strm->avail_out == 0) return (flush == 5) ? finish_started : need_more; };
    return flush == 5 ? finish_done : block_done;
}
    ...
    for (;;) {
       ...
       s->prev_length - 3);
            ...
            if (zlib_tr_tally (s, 0, s->window[s->strstart-1])) {
                { zlib_tr_flush_block(s, (s->block_start >= 0L ? (char *)&s->window[(unsigned)s->block_start] : ((void *)0)), (ulg)((long)s->strstart - s->block_start), (0)); s->block_start = s->strstart; flush_pending(s->strm); ; };
            }
            s->strstart++;
            s->lookahead--;
