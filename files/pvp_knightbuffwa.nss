   ...
   if (!adjustAndCheck(GetPCSpeaker(), 5000) )
    ...
    else if (GetGold(GetPCSpeaker()) >= 5000)
    {
        ...
        else if (GetLocalInt (oPC, "wpgiven") == FALSE)
        {
            ...
            itemproperty ipAdd = ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_ACID, IP_CONST_DAMAGEBONUS_2);
            itemproperty ipAddv = ItemPropertyVisualEffect(ITEM_VISUAL_ACID);
