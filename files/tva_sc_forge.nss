...
void SetItemLocals()
{
SetLocalString(OBJECT_SELF, "lsn1", "bladiumchain");
SetLocalInt(OBJECT_SELF, "lsc_bladiumchain", 3);
SetLocalString(OBJECT_SELF, "lsi1_bladiumchain", "blackdiamond");
SetLocalString(OBJECT_SELF, "lsi2_bladiumchain", "verciditebuckle");
SetLocalString(OBJECT_SELF, "lsi3_bladiumchain", "Spidersteel");
SetLocalString(OBJECT_SELF, "lsi4_bladiumchain", "Spidersteel");
SetLocalString(OBJECT_SELF, "lsi5_bladiumchain", "  gold  150000");
SetLocalInt(OBJECT_SELF, "lss_bladiumchain", -10);
SetLocalInt(OBJECT_SELF, "lsv_bladiumchain", VFX_FNF_STRIKE_HOLY);
