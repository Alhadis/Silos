...
part1_get_intersections :: proc(a, b: string) -> [][2]int {
    ...
    for b != "" {
        ...
        for old_pos != b_pos {
            ...
            if v, ok := a_map[old_pos.x][old_pos.y]; ok {
                append(&intersections, old_pos);
            }
        }
...
part1 :: proc() {
    intersections := part1_get_intersections(wire_1, wire_2);
    shortest := 99999;
    ...
    fmt.printf("part1: shortest distance: %v\n", shortest);
}
...
part2_get_intersections :: proc(a, b: string) -> []int {
    ...
    for b != "" {
        ...
        for old_pos != b_pos {
            ...
            if v, ok := a_map[old_pos.x][old_pos.y]; ok {
                append(&intersections, v+b_steps);
            }
        }
...
part2 :: proc() {
    ...
    fmt.printf("part2: most efficient intersection: %v\n", most_efficient);
}
