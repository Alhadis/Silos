# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c"
# 45 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c"
...
# 46 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c" 2
...
# 50 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c" 2
...
# 51 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c" 2
...
# 52 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.h" 1
# 66 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.h"
extern int32_t
u_strToPunycode_48(const UChar *src, int32_t srcLength,
                UChar *dest, int32_t destCapacity,
                const UBool *caseFlags,
                UErrorCode *pErrorCode);
# 101 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.h"
extern int32_t
u_strFromPunycode_48(const UChar *src, int32_t srcLength,
                  UChar *dest, int32_t destCapacity,
                  UBool *caseFlags,
                  UErrorCode *pErrorCode);
# 53 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c" 2
...
u_strFromJavaModifiedUTF8WithSub_48(
        ...
        UChar32 subchar, int32_t *pNumSubstitutions,
        UErrorCode *pErrorCode);
# 54 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c" 2
# 89 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c"
...
digitToBasic(int32_t digit, UBool uppercase) {
    ...
    if(digit<26) {
        if(uppercase) {
            return (char)(0X41 +digit);
        } else {
            return (char)(0X61 +digit);
        }
    } else {
        return (char)((0X30 -26)+digit);
    }
}
...
# 158 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c"
static int32_t
adaptBias(int32_t delta, int32_t length, UBool firstTime) {
    ...
    delta+=delta/length;
    for(count=0; delta>((36 -1)*26)/2; count+=36) {
        delta/=(36 -1);
    }

    return count+(((36 -1 +1)*delta)/(delta+38));
}
...
u_strToPunycode_48(const UChar *src, int32_t srcLength,
    ...
    if(src==((void *)0) || srcLength<-1 || (dest==((void *)0) && destCapacity!=0)) {
    ...
    if(srcLength==-1) {
        ...
        for(j=0; ; ++j) {
            ...
            if(((c)<0x80)) {
                ...
                n=(caseFlags!=((void *)0) && caseFlags[j])<<31L;
                if(!(((c)&0xfffff800)==0xd800)) {
                    n|=c;
                } else if((((c)&0xfffffc00)==0xd800) && (((c2=src[j+1])&0xfffffc00)==0xdc00)) {
                    ++j;
                    n|=(int32_t)(((c)<<10UL)+(c2)-((0xd800<<10UL)+0xdc00-0x10000));
                } else {
        ...
        for(j=0; j<srcLength; ++j) {
            ...
            if(((c)<0x80)) {
                ...
                if(!(((c)&0xfffff800)==0xd800)) {
                    n|=c;
                } else if((((c)&0xfffffc00)==0xd800) && (j+1)<srcLength && (((c2=src[j+1])&0xfffffc00)==0xdc00)) {
                    ++j;
                    n|=(int32_t)(((c)<<10UL)+(c2)-((0xd800<<10UL)+0xdc00-0x10000));
                } else {
    ...
    if(basicLength>0) {
        if(destLength<destCapacity) {
            dest[destLength]=0X2d;
        }
        ++destLength;
    }
# 289 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c"
    n=0x80;
    delta=0;
    bias=72;
    ...
    for(handledCPCount=basicLength; handledCPCount<srcCPCount; ) {
        ...
        if(m-n>(0x7fffffff-200 -delta)/(handledCPCount+1)) {
...
# 336 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c"
                    t=k-bias;
                    if(t<1) {
                        t=1;
                    } else if(k>=(bias+26)) {
                    ...
                    if(destLength<destCapacity) {
                        dest[destLength]=digitToBasic(t+(q-t)%(36 -t), 0);
                    }
                    ++destLength;
                    q=(q-t)/(36 -t);
                }
...
# 402 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c"
    for(j=srcLength; j>0;) {
        if(src[--j]==0X2d) {
            break;
        }
...
# 446 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c"
        for(oldi=i, w=1, k=36; ; k+=36) {
            ...
            i+=digit*w;
# 472 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c"
            t=k-bias;
            if(t<1) {
                t=1;
            } else if(k>=(bias+26)) {
        ...
        cpLength=((uint32_t)(n)<=0xffff ? 1 : 2);
        if((destLength+cpLength)<=destCapacity) {
            int32_t codeUnitIndex;
# 534 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/punycode.c"
            if(i<=firstSupplementaryIndex) {
                ...
                { int32_t __N=(i-codeUnitIndex); while(__N>0 && (codeUnitIndex)<(destLength)) { { if(((((dest)[(codeUnitIndex)++])&0xfffffc00)==0xd800) && (codeUnitIndex)<(destLength) && ((((dest)[codeUnitIndex])&0xfffffc00)==0xdc00)) { ++(codeUnitIndex); } }; --__N; } };
            }


            if(codeUnitIndex<destLength) {
                memmove(dest+codeUnitIndex+cpLength, dest+codeUnitIndex, (destLength-codeUnitIndex)*2);
            ...
            if(cpLength==1) {
                ...
                dest[codeUnitIndex]=(UChar)(((n)>>10)+0xd7c0);
                dest[codeUnitIndex+1]=(UChar)(((n)&0x3ff)|0xdc00);
            }
            if(caseFlags!=((void *)0)) {

                caseFlags[codeUnitIndex]=(0X41<=(src[in-1]) && (src[in-1])<=0X5a);
                if(cpLength==2) {
                    caseFlags[codeUnitIndex+1]=0;
                }
            }
        }
        destLength+=cpLength;
