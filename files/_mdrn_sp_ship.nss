...
void main()
{
    ...
    */
    ...
    SetLocalInt(OBJECT_SELF, "nMdrnVehicle", 1);
     // * If Incorporeal, apply changes
    //SetIsDestroyable(FALSE, TRUE, TRUE);
    //SetLootable(OBJECT_SELF, TRUE);
    SetLocalInt(OBJECT_SELF, "nSpeed", 0);
    SetFootstepType(FOOTSTEP_TYPE_NONE);
    //ApplyEffectToObject(DURATION_TYPE_PERMANENT, EffectMovementSpeedDecrease(99), OBJECT_SELF);
