...
class ThreadSafe::AtomicReferenceCacheBackend
  ...
  def get_or_default(key, else_value = _); end
  def key?(key); end
  ...
  def internal_replace(key, expected_old_value = _, &block); end
...
class ThreadSafe::AtomicReferenceCacheBackend::Node
  ...
  def initialize(hash, key, value, next_node = _); end
  ...
  def try_lock_via_hash(node_hash = _); end
