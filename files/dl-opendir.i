# 1 "../sysdeps/unix/sysv/linux/dl-opendir.c"
...
# 1 "<command-line>" 2
# 1 "../sysdeps/unix/sysv/linux/dl-opendir.c"
# 1 "../sysdeps/posix/opendir.c" 1
# 18 "../sysdeps/posix/opendir.c"
...
# 22 "../sysdeps/posix/opendir.c" 2
# 1 "../include/sys/param.h" 1
# 23 "../sysdeps/posix/opendir.c" 2

# 1 "../sysdeps/unix/sysv/linux/not-cancel.h" 1
# 26 "../sysdeps/unix/sysv/linux/not-cancel.h"
...
# 27 "../sysdeps/unix/sysv/linux/not-cancel.h" 2
...
enum {
  opendir_oflags = 00|04000|0200000|0|02000000
};

static 
# 36 "../sysdeps/posix/opendir.c" 3 4
      _Bool

# 37 "../sysdeps/posix/opendir.c"
invalid_name (const char *name)
{
  if (__builtin_expect ((name[0] == '\0'), 0))
    {


      (rtld_errno = (
# 43 "../sysdeps/posix/opendir.c" 3 4
     2
# 43 "../sysdeps/posix/opendir.c"
     ));
      return 
# 44 "../sysdeps/posix/opendir.c" 3 4
            1
# 44 "../sysdeps/posix/opendir.c"
                ;
    }
  return 
# 46 "../sysdeps/posix/opendir.c" 3 4
        0
# 46 "../sysdeps/posix/opendir.c"
             ;
}
...
opendir_tail (int fd)
{
  if (__builtin_expect ((fd < 0), 0))
    return 
# 53 "../sysdeps/posix/opendir.c" 3 4
          ((void *)0)
# 53 "../sysdeps/posix/opendir.c"
              ;
  ...
  if (__builtin_expect ((__fxstat64 (1, fd, &statbuf) < 0), 0))
    goto lose;
  if (__builtin_expect ((! ((((statbuf.st_mode)) & 0170000) == (0040000))), 0))
    {
      (rtld_errno = (
# 63 "../sysdeps/posix/opendir.c" 3 4
     20
# 63 "../sysdeps/posix/opendir.c"
     ));
    lose:
      __close_nocancel_nostatus (fd);
      return 
# 66 "../sysdeps/posix/opendir.c" 3 4
            ((void *)0)
# 66 "../sysdeps/posix/opendir.c"
                ;
    }

  return __alloc_dir (fd, 
# 69 "../sysdeps/posix/opendir.c" 3 4
                         1
# 69 "../sysdeps/posix/opendir.c"
                             , 0, &statbuf);
}
# 86 "../sysdeps/posix/opendir.c"
DIR *
__opendir (const char *name)
{
  if (__builtin_expect ((invalid_name (name)), 0))
    return 
# 90 "../sysdeps/posix/opendir.c" 3 4
          ((void *)0)
# 90 "../sysdeps/posix/opendir.c"
              ;

  return opendir_tail (__open_nocancel (name, opendir_oflags));
}
extern __typeof (__opendir) opendir __attribute__ ((weak, alias ("__opendir")));

DIR *
__alloc_dir (int fd, 
# 97 "../sysdeps/posix/opendir.c" 3 4
                    _Bool 
# 97 "../sysdeps/posix/opendir.c"
                         close_fd, int flags, const struct stat64 *statp)
{


  if (!close_fd
      && __builtin_expect ((__fcntl64_nocancel (fd, 2, 1) < 0), 0))
 goto lose;

  const size_t default_allocation = (4 * 8192 < sizeof (struct dirent64)
         ? sizeof (struct dirent64) : 4 * 8192);
  const size_t small_allocation = (8192 < sizeof (struct dirent64)
       ? sizeof (struct dirent64) : 8192);
  size_t allocation = default_allocation;



  if (statp != 
# 113 "../sysdeps/posix/opendir.c" 3 4
              ((void *)0)
# 113 "../sysdeps/posix/opendir.c"
                  )
    allocation = (((((((size_t) statp->st_blksize)>(default_allocation))?((size_t) statp->st_blksize):(default_allocation)))<(1048576U))?(((((size_t) statp->st_blksize)>(default_allocation))?((size_t) statp->st_blksize):(default_allocation))):(1048576U))
                            ;


  DIR *dirp = (DIR *) malloc (sizeof (DIR) + allocation);
  if (dirp == 
# 119 "../sysdeps/posix/opendir.c" 3 4
             ((void *)0)
# 119 "../sysdeps/posix/opendir.c"
                 )
    {
      ...
      if (dirp == 
# 124 "../sysdeps/posix/opendir.c" 3 4
                 ((void *)0)
# 124 "../sysdeps/posix/opendir.c"
                     )
      lose:
 {
   if (close_fd)
   ...
   return 
# 133 "../sysdeps/posix/opendir.c" 3 4
         ((void *)0)
# 133 "../sysdeps/posix/opendir.c"
             ;
 }
    }
...
# 1 "../sysdeps/unix/sysv/linux/dl-opendir.c" 2
