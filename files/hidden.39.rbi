...
class Database
  def has?(*args, &block); end

  def load_info(*args, &block); end

  def load_raw(*args, &block); end

  def pack_path(*args, &block); end

  def prefix_match(*args, &block); end
end
...
class Database::Backends
  def write_object(*args, &block); end
end
...
class Pack::Window::Unpacked
  ...
  def delta_index=(delta_index); end
...
class RevList
  ...
  def initialize(repo, revs, options=T.unsafe(nil)); end

  def tree_diff(old_oid, new_oid); end
...
class Revision::HintedError
  def self.[](*_); end

  def self.members(); end
end

class Revision::Parent
  def self.[](*_); end
