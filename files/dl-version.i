...
find_needed (const char *name, struct link_map *map)
{
  ...
  for (tmap = _rtld_local._dl_ns[map->l_ns]._ns_loaded; tmap != 
# 37 "dl-version.c" 3 4
                                                      ((void *)0)
# 37 "dl-version.c"
                                                          ;
...
static int
match_symbol (const char *name, Lmid_t ns, Elf64_Word hash, const char *string,
       struct link_map *map, int verbose, int weak)
{
  const char *strtab = (const void *) (map)->l_info[5]->d_un.d_ptr;
  Elf64_Addr def_offset;
  Elf64_Verdef *def;
  ...
  if (__builtin_expect ((_rtld_local_ro._dl_debug_mask & (1 << 4)), 0))
    _dl_debug_printf ("checking for version `%s' in file %s [%lu] required by file %s [%lu]\n",

        string, ((map->l_name)[0] ? (map->l_name) : (_dl_argv[0] ?: "<main program>")),
        map->l_ns, name, ns);

  if (__builtin_expect ((map->l_info[(35 + 0 + (0x6fffffff - (0x6ffffffc)))] == 
# 71 "dl-version.c" 3 4
     ((void *)0)
# 71 "dl-version.c"
     ), 0))
      ...
      if (verbose)
 {
   ...
   _dl_exception_create_format
     (&exception, ((map->l_name)[0] ? (map->l_name) : (_dl_argv[0] ?: "<main program>")),
  ...
  def_offset = map->l_info[(35 + 0 + (0x6fffffff - (0x6ffffffc)))]->d_un.d_ptr;
  ((void) sizeof ((def_offset != 0) ? 1 : 0), __extension__ ({ if (def_offset != 0) ; else __assert_fail ("def_offset != 0", "dl-version.c", 88, __extension__ __PRETTY_FUNCTION__); }));

  def = (Elf64_Verdef *) ((char *) map->l_addr + def_offset);
  while (1)
    {
      ...
      if (__builtin_expect (def->vd_version, 1) != 1)
 {
   ...
   _dl_exception_create_format
     (&exception, ((map->l_name)[0] ? (map->l_name) : (_dl_argv[0] ?: "<main program>")),
      ...
      _itoa_word (def->vd_version, &buf[sizeof (buf) - 1], 10, 0));
   result = 1;
   goto call_cerror;
 }
      ...
      if (verbose)
 {
  ...
  result = 1;
 call_cerror:
  _dl_signal_cexception (0, &exception, "version lookup error");
...
# 171 "dl-version.c"
  ...
  dyn = map->l_info[(35 + 0 + (0x6fffffff - (0x6ffffffe)))];
  def = map->l_info[(35 + 0 + (0x6fffffff - (0x6ffffffc)))];

  if (dyn != 
# 178 "dl-version.c" 3 4
            ((void *)0)
# 178 "dl-version.c"
                )
    {

      Elf64_Verneed *ent = (Elf64_Verneed *) (map->l_addr + dyn->d_un.d_ptr);
      ...
      if (__builtin_expect (ent->vn_version, 1) != 1)
 {
   ...
   _dl_exception_create_format
     (&exception, ((map->l_name)[0] ? (map->l_name) : (_dl_argv[0] ?: "<main program>")),
      ...
      _itoa_word (ent->vn_version, &buf[sizeof (buf) - 1], 10, 0));
 call_error:
   _dl_signal_exception (errval, &exception, 
# 195 "dl-version.c" 3 4
                                            ((void *)0)
# 195 "dl-version.c"
                                                );
 }
      ...
      while (1)
 {
   ...
   ((void) sizeof ((needed != 
# 205 "dl-version.c" 3 4
  ((void *)0)
# 205 "dl-version.c"
  ) ? 1 : 0), __extension__ ({ if (needed != 
# 205 "dl-version.c" 3 4
  ((void *)0)
# 205 "dl-version.c"
  ) ; else __assert_fail ("needed != NULL", "dl-version.c", 205, __extension__ __PRETTY_FUNCTION__); }));
       ...
       while (1)
  {
    ...
    result |= match_symbol (((map->l_name)[0] ? (map->l_name) : (_dl_argv[0] ?: "<main program>")),
  ...
  if (def != 
# 251 "dl-version.c" 3 4
            ((void *)0)
# 251 "dl-version.c"
                )
    {
      Elf64_Verdef *ent;
      ent = (Elf64_Verdef *) (map->l_addr + def->d_un.d_ptr);
      while (1)
 {
 ...
 calloc (ndx_high + 1, sizeof (*map->l_versions));
      if (__builtin_expect ((map->l_versions == 
# 275 "dl-version.c" 3 4
         ((void *)0)
# 275 "dl-version.c"
         ), 0))
 {
...
# 280 "dl-version.c"
   ...
   goto call_error;
      ...
      map->l_versyms = (void *) (map)->l_info[(35 + 0 + (0x6fffffff - (0x6ffffff0)))]->d_un.d_ptr;

      if (dyn != 
# 290 "dl-version.c" 3 4
                ((void *)0)
# 290 "dl-version.c"
                    )
 {
...
# 328 "dl-version.c"
                    )
 {
       ...
       if ((ent->vd_flags & 0x1) == 0)
  {
    ...
    map->l_versions[ndx].filename = 
# 344 "dl-version.c" 3 4
                                   ((void *)0)
# 344 "dl-version.c"
                                       ;
  }
