/*
    ...
    2d12 sonic to target and 2d6 to all creatures in 3.5m of target. Unattended objects also take damage.
    Relex save DC = 20
*/
...
void main()
{
    ...
    int nDamage;
    float fDelay;
    effect eExplode = EffectVisualEffect(VFX_IMP_SONIC);
    ...
    while (GetIsObjectValid(oTarget))
    {
        ...
        nDamage = GetReflexAdjustedDamage(nDamage, oTarget, 20, SAVING_THROW_TYPE_SONIC);
