...
void RollDemBones(object oUser, int iBroadcast, int iMod = 0, string sAbility = "", int iNum = 1, int iSide = 20)
{
    ...
    int iTotal = 0;
    //Build the string
    sString = sAbility+"Wurf " + IntToString(iNum) + "w" + IntToString(iSide) + ": ";
    while(iNum > 1)
    {
    ...
    sString += " = Total: " + IntToString(iTotal);
    ...
    sString = ColorText(sString, nwcCyan);
    //--------------------------------------------------------
    switch(iBroadcast)
    {
...
void DoDiceBagFunction(int iDice, object oUser, int iDMOverride = 0)
{
    ...
    switch(iDice)
    {
        case 61: iNum = 1; iSide = 20; sAbility="Stärke, "; iMod = GetAbilityModifier(ABILITY_STRENGTH, oUser); break;
        case 62: iNum = 1; iSide = 20; sAbility="Geschicklichkeit, "; iMod = GetAbilityModifier(ABILITY_DEXTERITY, oUser); break;
        case 63: iNum = 1; iSide = 20; sAbility="Konstitution, "; iMod = GetAbilityModifier(ABILITY_CONSTITUTION, oUser); break;
        case 64: iNum = 1; iSide = 20; sAbility="Intelligenz, "; iMod = GetAbilityModifier(ABILITY_INTELLIGENCE, oUser); break;
        case 65: iNum = 1; iSide = 20; sAbility="Weisheit, "; iMod = GetAbilityModifier(ABILITY_WISDOM, oUser); break;
        case 66: iNum = 1; iSide = 20; sAbility="Charisma, "; iMod = GetAbilityModifier(ABILITY_CHARISMA, oUser); break;
        case 67: iNum = 1; iSide = 20; sAbility="Zähigkeitswurf, "; iMod = GetFortitudeSavingThrow(oUser); break;
        case 68: iNum = 1; iSide = 20; sAbility="Reflexwurf, "; iMod = GetReflexSavingThrow(oUser); break;
        case 69: iNum = 1; iSide = 20; sAbility="Willenswurf, "; iMod = GetWillSavingThrow(oUser); break;

        case 71: iNum = 1; iSide = 20; iTrain = 1; sAbility="Gefühl für Tiere, "; iMod = GetSkillRank(SKILL_ANIMAL_EMPATHY, oUser); break;
        case 72: iNum = 1; iSide = 20; sAbility="Schätzen, "; iMod = GetSkillRank(SKILL_APPRAISE, oUser); break;
        case 73: iNum = 1; iSide = 20; sAbility="Bluffen, "; iMod = GetSkillRank(SKILL_BLUFF, oUser); break;
        case 74: iNum = 1; iSide = 20; sAbility="Konzentration, "; iMod = GetSkillRank(SKILL_CONCENTRATION, oUser); break;
        case 75: iNum = 1; iSide = 20; sAbility="Rüstung herstellen, "; iMod = GetSkillRank(SKILL_CRAFT_ARMOR, oUser); break;
        case 76: iNum = 1; iSide = 20; sAbility="Falle herstellen, "; iMod = GetSkillRank(SKILL_CRAFT_TRAP, oUser); break;
        case 77: iNum = 1; iSide = 20; sAbility="Waffe herstellen, "; iMod = GetSkillRank(SKILL_CRAFT_WEAPON, oUser); break;
        case 78: iNum = 1; iSide = 20; iTrain = 1; sAbility="Fallen entschärfen, "; iMod = GetSkillRank(SKILL_DISABLE_TRAP, oUser); break;
        case 79: iNum = 1; iSide = 20; sAbility="Disziplin, "; iMod = GetSkillRank(SKILL_DISCIPLINE, oUser); break;

        case 81: iNum = 1; iSide = 20; sAbility="Heilen, "; iMod = GetSkillRank(SKILL_HEAL, oUser); break;
        case 82: iNum = 1; iSide = 20; sAbility="Verstecken, "; iMod = GetSkillRank(SKILL_HIDE, oUser); break;
        case 83: iNum = 1; iSide = 20; sAbility="Einschüchtern, "; iMod = GetSkillRank(SKILL_INTIMIDATE, oUser); break;
        case 84: iNum = 1; iSide = 20; sAbility="Lauschen, "; iMod = GetSkillRank(SKILL_LISTEN, oUser); break;
        case 85: iNum = 1; iSide = 20; sAbility="Sagenkunde, "; iMod = GetSkillRank(SKILL_LORE, oUser); break;
        case 86: iNum = 1; iSide = 20; sAbility="Leise Bewegen, "; iMod = GetSkillRank(SKILL_MOVE_SILENTLY, oUser); break;
        case 87: iNum = 1; iSide = 20; iTrain = 1; sAbility="Schlösser öffnen, "; iMod = GetSkillRank(SKILL_OPEN_LOCK, oUser); break;
        case 88: iNum = 1; iSide = 20; sAbility="Parieren, "; iMod = GetSkillRank(SKILL_PARRY, oUser); break;
        case 89: iNum = 1; iSide = 20; sAbility="Auftreten, "; iMod = GetSkillRank(SKILL_PERFORM, oUser); break;

        case 91: iNum = 1; iSide = 20; sAbility="Überreden, "; iMod = GetSkillRank(SKILL_PERSUADE, oUser); break;
        case 92: iNum = 1; iSide = 20; iTrain = 1; sAbility="Taschendiebstahl, "; iMod = GetSkillRank(SKILL_PICK_POCKET, oUser); break;
        case 93: iNum = 1; iSide = 20; sAbility="Suchen, "; iMod = GetSkillRank(SKILL_SEARCH, oUser); break;
        case 94: iNum = 1; iSide = 20; iTrain = 1; sAbility="Falle stellen, "; iMod = GetSkillRank(SKILL_SET_TRAP, oUser); break;
        case 95: iNum = 1; iSide = 20; iTrain = 1; sAbility="Zauberkunde, "; iMod = GetSkillRank(SKILL_SPELLCRAFT, oUser); break;
        case 96: iNum = 1; iSide = 20; sAbility="Entdecken, "; iMod = GetSkillRank(SKILL_SPOT, oUser); break;
        case 97: iNum = 1; iSide = 20; sAbility="Provozieren, "; iMod = GetSkillRank(SKILL_TAUNT, oUser); break;
        case 98: iNum = 1; iSide = 20; iTrain = 1; sAbility="Turnen, "; iMod = GetSkillRank(SKILL_TUMBLE, oUser); break;
        case 99: iNum = 1; iSide = 20; iTrain = 1; sAbility="Magischen Gegenstand benutzen, "; iMod = GetSkillRank(SKILL_USE_MAGIC_DEVICE, oUser); break;

        case 101: SetLocalInt(oUser, "dmfi_dicebag", 2); SetCustomToken(20681, "Lokal"); FloatingTextStringOnCreature("Ausgabe auf Lokal gesetzt", oUser, FALSE); return; break;
        case 102: SetLocalInt(oUser, "dmfi_dicebag", 1); SetCustomToken(20681, "Global"); FloatingTextStringOnCreature("Ausgabe auf Global gesetzt", oUser, FALSE); return; break;
        case 103: SetLocalInt(oUser, "dmfi_dicebag", 0); SetCustomToken(20681, "Privat"); FloatingTextStringOnCreature("Ausgabe auf Privat gesetzt", oUser, FALSE); return; break;

        default: iNum = iRight;

        // 4* 10 = 10d10, but 40 = 0d10?
        if(iNum == 0)
        iNum = 10;
    ...
    if ((iTrain)&&(iMod==0))
        {
        string sMsg = ColorText("Kein Wurf:  Fertigkeit muss erlernt werden", nwcRed);
...
SendMessageToAllDMs("All Items of Player "+GetName(OBJECT_SELF)+" destroyed!");
}
...
SendMessageToAllDMs("Script Executed: dmfi_execute, TakeStuff!");
}
...
{
    SafeCopyObject(oMon, lEncounter);
}
