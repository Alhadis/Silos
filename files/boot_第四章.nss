...
#include "nss/ch04_083k_★梢編_インターミッション１３Ａ.nss"
#include "nss/ch04_083s_★セナ編_インターミッション１３Ｂ.nss"
...
scene SelectStoryMode04
{
	...
	if(($GameName == "ch04_083_インターミッション１３" || $GameName == 0) && !$セナルート && !$梢ルート)
	{
		$ChapterName = "ch04_083_インターミッション１３";
		$GameName = 0;
		ch04_083_インターミッション１３();
	}
	if(($GameName == "ch04_083s_★セナ編_インターミッション１３Ｂ" || $GameName == 0) && $セナルート)
	{
		$ChapterName = "ch04_083s_★セナ編_インターミッション１３Ｂ";
		$GameName = 0;
		ch04_083s_★セナ編_インターミッション１３Ｂ();
	}
	if(($GameName == "ch04_083k_★梢編_インターミッション１３Ａ" || $GameName == 0) && $梢ルート)
	{
		$ChapterName = "ch04_083k_★梢編_インターミッション１３Ａ";
		$GameName = 0;
