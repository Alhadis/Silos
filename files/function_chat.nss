...
function ChatMain($Ｘ座標,$Ｙ座標,$参加人数)
{
	...
	CreateTexture("box01/ChatPerson", 1000, 16, 98, $人数画像);
	CreateWindow("box01/ChatWindow", 1000, 10, 201, 497, 392, true);
	SetAlias("box01/ChatWindow", "box01");
	CreateTexture("box01/moniter", 1005, 0, 0, "cg/sys/chat/CHゲーム画面.png");
...
function ChatMain2($Ｘ座標,$Ｙ座標,$参加人数)
{
...
function SetChat("ボックス名",$テキスト名,テキスト色)
{
	...
	LoadText($構文名,"ボックス名",$テキスト名,500,320,0,20);
