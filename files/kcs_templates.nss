...
// DEFAULT GENERIC BEHAVIOR (DO NOT TOUCH) *****************************************************************************************
    ...
    SetKeyword(OBJECT_SELF, "**(storm|wind|rain|thunder|lightning)**", " &N has answered correctly, the way is clear.", 0, 0, "np_destroy_mephi");
    SetKeyword(OBJECT_SELF, "**(what|don't|know|help|air|lion|go)**", " &N has answered IN-correctly, the way is NOT safe.");
