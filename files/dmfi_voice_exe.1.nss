...
{
    string sEmote1 = "*Raucht eine Pfeife*";
    string sEmote2 = "*Inhaliert aus einer Pfeife*";
    string sEmote3 = "*bildet Pfeifenrauch-Ringe*";
    float fHeight = 1.7;
    float fDistance = 0.1;
...
string ProcessCant(string sLetter)
{
    ...
    if (sLetter == "a" || sLetter == "A") return "*bedeckt die Augen*";
    if (sLetter == "b" || sLetter == "B") return "*schimpft*";
    if (sLetter == "c" || sLetter == "C") return "*hustet*";
    if (sLetter == "d" || sLetter == "D") return "*runzelt die Stirn*";
    if (sLetter == "e" || sLetter == "E") return "*schaut zu Boden*";
    if (sLetter == "f" || sLetter == "F") return "*finster dreinsehend*";
    if (sLetter == "g" || sLetter == "G") return "*schaut auf*";
    if (sLetter == "h" || sLetter == "H") return "*scheint gedankenverloren*";
    if (sLetter == "i" || sLetter == "I") return "*scheint gelangweilt*";
    if (sLetter == "j" || sLetter == "J") return "*reibt das Kinn*";
    if (sLetter == "k" || sLetter == "K") return "*kratzt sich am Ohr*";
    if (sLetter == "l" || sLetter == "L") return "*blickt umher*";
    if (sLetter == "m" || sLetter == "M") return "*mmm hmm*";
    if (sLetter == "n" || sLetter == "N") return "*nichts*";
    if (sLetter == "o" || sLetter == "O") return "*grinst*";
    if (sLetter == "p" || sLetter == "P") return "*lächelt*";
    if (sLetter == "q" || sLetter == "Q") return "*schaudert*";
    if (sLetter == "r" || sLetter == "R") return "*rollt mit den Augen*";
    if (sLetter == "s" || sLetter == "S") return "*kratzt sich an der Nase*";
    if (sLetter == "t" || sLetter == "T") return "*Daumen drehend*";
    if (sLetter == "u" || sLetter == "U") return "*schaut untätig*";
    if (sLetter == "v" || sLetter == "V") return "*fährt mit der Hand durchs Haar*";
    if (sLetter == "w" || sLetter == "W") return "*winkt*";
    if (sLetter == "x" || sLetter == "X") return "*dehnt sich*";
    if (sLetter == "y" || sLetter == "Y") return "*gähnt*";
    if (sLetter == "z" || sLetter == "Z") return "*zuckt mit den Achseln*";
...
void ParseCommand(object oNPC, object oPC, string sCom)
{
    ...
    if (GetStringLowerCase(GetStringLeft(sCom, 12)) ==".appearance ")
    {
        ...
        {
             int nLen = GetStringLength(sNew);
             int i, nFound, nChar;

             for(i=0;i<nLen;i++)
             {
                  nChar = FindSubString(sIndex, GetSubString(sNew,i,1));
             ...
             if(nFound == nLen)
             {
                SendMessageToPC(oPC, "Current Appearance-Type Number: "+IntToString(GetAppearanceType(oNPC)));
                SendMessageToPC(oPC, "New Appearance-Type Number: "+sNew);
                SetCreatureAppearanceType(oNPC, StringToInt(sNew));
             }
             else
             {
                FloatingTextStringOnCreature("Appearance type invalid", oPC, FALSE);
             }
         }
