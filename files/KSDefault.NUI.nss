...
@appCellLightRedColor:#cb1426;/*深红色京东金额颜色*/
@appLightRedColor:#e60012;/*深红色颜色*/
@appBuleColor:#3278ff;/*蓝色联系客服颜色*/
...
@appChartBlueColor:#44a4fe;   /*统计图橙色 */
...
{
font-size: @appNormalFontSize;
font-color: @appBuleColor;
}
AppCellLightRedLabel
{
    font-size: 24;
    font-color: @appCellLightRedColor;
...
InvestListTagLabel
{
    ...
    corner-radius: 9;
    HONORABLE: #f64f4f; /* 尊享 */
    RECOMMEND:#ff8584; /* 推荐,热门*/
    NEWBEE:#0cea98; /*新手标*/
    RATE:#f9d667;/* 加利率 */
    BANKBILL:#ac89ed;/*银行承兑 */
    CREDITA:#50c58f; /*资信等级A */
    CREDITAA:#50c58f;   /*资信等级Aa */
    CREDITAAA:#50c58f; /*资信等级Aaa */
    ABLE:#6996f3;      /*可提前还款*/
}
