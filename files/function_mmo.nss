...
function MmoMain($Ｘ座標,$Ｙ座標,"$場所")
{
	...
	CreateWindow("MmoWindow", 1000, $Ｘ座標, $Ｙ座標, 1024, 768, true);
	CreateTexture("MmoWindow/back", 1000, Center, 0, $場所);
...
//	Zoom("MmoWindow/back", 0, 500, 500, null, true);
	...
	CreateTexture("MmoWindow/エンスーウィンドウ", 1500, 55, 548, "cg/sys/mmo/エンスーウィンドウ.png");
	CreateMovie360("MmoWindow/ムービー１", 1100, Center, 288, true, true, "dx/mvNH02.avi");
	Zoom("MmoWindow/ムービー１", 0, 800, 800, null, false);
...
function MmoKnight()
{
	Delete("MmoWindow/ムービー１");
	CreateMovie360("MmoWindow/ムービー１", 1100, Center, 288, true, true, "dx/mvNH02a.avi");
	Zoom("MmoWindow/ムービー１", 0, 800, 800, null, false);
}
...
function SetMmo("ボックス名",$テキスト名,テキスト色)
{
	...
	SetFont("ＭＳ ゴシック", 21, テキスト色, #000000, 500, NULL);
	LoadText($構文名,"ボックス名",$テキスト名,680,240,0,30);
