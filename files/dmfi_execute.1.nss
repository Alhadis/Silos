...
void DoDiceBagFunction(int iDice, object oUser, int iDMOverride = 0)
{
    ...
    switch (iDice)
    {
        case 10: SetLocalInt(oUser, "dmfi_dicebag", 2); SetDMFIPersistentInt("dmfi", "dmfi_dicebag", 2, oUser); SetCustomToken(20681, "Local"); FloatingTextStringOnCreature("Broadcast Mode set to Local", oUser, FALSE); return; break;
        case 18: SetLocalInt(oUser, "dmfi_dicebag", 1); SetDMFIPersistentInt("dmfi", "dmfi_dicebag", 1, oUser); SetCustomToken(20681, "Global"); FloatingTextStringOnCreature("Broadcast Mode set to Global", oUser, FALSE); return; break;
        case 19: SetLocalInt(oUser, "dmfi_dicebag", 0); SetDMFIPersistentInt("dmfi", "dmfi_dicebag", 0, oUser); SetCustomToken(20681, "Private"); FloatingTextStringOnCreature("Broadcast Mode set to Private", oUser, FALSE); return; break;
        case 20: iNum = 1; iSide = 20; sAbility="Repair Check, "; iMod = GetSkillRank(SKILL_REPAIR, oUser); break;
        case 21: iNum = 1; iSide = 20; sAbility="Knowledge (Technology) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_TECHNOLOGY, oUser); break;
        case 22: iNum = 1; iSide = 20; sAbility="Knowledge (Theology) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_THEOLOGY, oUser); break;
        case 23: iNum = 1; iSide = 20; sAbility="Listen Check, "; iMod = GetSkillRank(SKILL_LISTEN, oUser); break;
        case 24: iNum = 1; iSide = 20; sAbility="Move Silently Check, "; iMod = GetSkillRank(SKILL_MOVE_SILENTLY, oUser); break;
        case 25: iNum = 1; iSide = 20; sAbility="Navigate Check, "; iMod = GetSkillRank(SKILL_NAVIGATE, oUser); break;
        case 26: iNum = 1; iSide = 20; sAbility="Perform Check, "; iMod = GetSkillRank(SKILL_PERFORM, oUser); break;
        case 27: iNum = 1; iSide = 20; sAbility="Persuade Check, "; iMod = GetSkillRank(SKILL_PERSUADE, oUser); break;
        case 28: iNum = 1; iSide = 20; sAbility="Pilot Check, "; iMod = GetSkillRank(SKILL_PILOT, oUser); break;
        case 29: iNum = 1; iSide = 20; sAbility="Profession Check, "; iMod = GetSkillRank(SKILL_PROFESSION, oUser); break;
        case 30: iNum = 1; iSide = 20; sAbility="Knowledge (Tactics) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_TACTICS, oUser); break;
        case 31: iNum = 1; iSide = 20; sAbility="Knowledge (Behavoral) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_BEHAVIORAL, oUser); break;
        case 32: iNum = 1; iSide = 20; sAbility="Knowledge (Business) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_BUSINESS, oUser); break;
        case 33: iNum = 1; iSide = 20; sAbility="Knowledge (Civics) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_CIVICS, oUser); break;
        case 34: iNum = 1; iSide = 20; sAbility="Knowledge (Current) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_CURRENT, oUser); break;
        case 35: iNum = 1; iSide = 20; sAbility="Knowledge (Earth Sciences) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_EARTH_SCIENCES, oUser); break;
        case 36: iNum = 1; iSide = 20; sAbility="Knowledge (History) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_HISTORY, oUser); break;
        case 37: iNum = 1; iSide = 20; sAbility="Knowledge (Physical Sciences) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_PHYSICAL_SCIENCES, oUser); break;
        case 38: iNum = 1; iSide = 20; sAbility="Knowledge (Popular) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_POPULAR, oUser); break;
        case 39: iNum = 1; iSide = 20; sAbility="Knowledge (Streetwise) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_STREETWISE, oUser); break;
        case 50: iNum = 1; iSide = 20; sAbility="Forgery Check,  "; iMod = GetSkillRank(SKILL_FORGERY, oUser)-4+4*GetIsObjectValid(GetItemPossessedBy(oUser, "_mdrn_it_forgerykit")); break;
        case 51: iNum = 1; iSide = 20; sAbility="Craft (Visual Arts) Check, "; iMod = GetSkillRank(SKILL_CRAFT_VISUAL_ART, oUser); break;
        case 52: iNum = 1; iSide = 20; sAbility="Craft (Writing) Check, "; iMod =GetSkillRank(SKILL_CRAFT_WRITING, oUser); break;
        case 53: iNum = 1; iSide = 20; sAbility="Decipher Script Check, "; iMod =GetSkillRank(SKILL_DECIPHER_SCRIPT, oUser); break;
        case 54: iNum = 1; iSide = 20; sAbility="Demolitions Check, "; iMod = GetSkillRank(SKILL_DEMOLITIONS, oUser) -4+4*GetIsObjectValid(GetItemPossessedBy(oUser, "_mdrn_ot_demo")); break;
        case 55: iNum = 1; iSide = 20; sAbility="Disable Device Check, "; iMod =GetSkillRank(SKILL_DISABLE_DEVICE, oUser); break;
        case 56: iNum = 1; iSide = 20; sAbility="Discipline Check, "; iMod = GetSkillRank(SKILL_DISCIPLINE, oUser); break;
        case 57: iNum = 1; iSide = 20; sAbility="Disguise Check, "; iMod = GetSkillRank(SKILL_DISGUISE, oUser) -4+4*GetIsObjectValid(GetItemPossessedBy(oUser, "_mdrn_it_disguisekit")); break;
        case 58: iNum = 1; iSide = 20; sAbility="Drive Check, "; iMod = GetSkillRank(SKILL_DRIVE, oUser); break;
        case 59: iNum = 1; iSide = 20; sAbility="Escape Artist Check, "; iMod = GetSkillRank(SKILL_ESCAPE_ARTIST, oUser); break;
        case 71: iNum = 1; iSide = 20; sAbility="Strength Check, "; iMod = GetAbilityModifier(ABILITY_STRENGTH, oUser)+2*GetHasFeat(FEAT_EXTREMEEFFORT, oUser)+2*GetHasFeat(FEAT_IMPROVEDEXTREMEEFFORT, oUser); break;
        case 72: iNum = 1; iSide = 20; sAbility="Dexterity Check, "; iMod = GetAbilityModifier(ABILITY_DEXTERITY, oUser); break;
        case 73: iNum = 1; iSide = 20; sAbility="Constitution Check, "; iMod = GetAbilityModifier(ABILITY_CONSTITUTION, oUser)+2*GetHasFeat(FEAT_ENDURANCE, oUser); break;
        ...
        case 80: iNum = 1; iSide = 20; sAbility="Craft (Structural) Check, "; iMod = GetSkillRank(SKILL_CRAFT_STRUCTURAL, oUser); break;
        case 81: iNum = 1; iSide = 20; sAbility="Balance Check, "; iMod = GetSkillRank(SKILL_BALANCE, oUser); break;
        case 82: iNum = 1; iSide = 20; sAbility="Bluff Check, "; iMod = GetSkillRank(SKILL_BLUFF, oUser); break;
        case 83: iNum = 1; iSide = 20; sAbility="Climb Check, "; iMod = GetSkillRank(SKILL_CLIMB, oUser) -4+4*GetIsObjectValid(GetItemPossessedBy(oUser, "_mdrn_ot_climb")); break;
        case 84: iNum = 1; iSide = 20; sAbility="Computer Use Check, "; iMod = GetSkillRank(SKILL_COMPUTER_USE, oUser); break;
        case 85: iNum = 1; iSide = 20; sAbility="Concentration Check, "; iMod = GetSkillRank(SKILL_CONCENTRATION, oUser); break;
        case 86: iNum = 1; iSide = 20; sAbility="Craft (Chemical) Check, "; iMod = GetSkillRank(SKILL_CRAFT_CHEMICAL, oUser) -4+4*GetIsObjectValid(GetItemPossessedBy(oUser, "_mdrn_ot_chemkit")); break;
        case 87: iNum = 1; iSide = 20; sAbility="Craft (Electronic) Check, "; iMod = GetSkillRank(SKILL_CRAFT_ELECTRONIC, oUser) -4+4*GetIsObjectValid(GetItemPossessedBy(oUser, "_mdrn_ot_disable")) ; break;
        case 88: iNum = 1; iSide = 20; sAbility="Craft (Mechanical) Check, "; iMod = GetSkillRank(SKILL_CRAFT_MECHANICAL, oUser) -4+4*GetIsObjectValid(GetItemPossessedBy(oUser, "_mdrn_ot_mechkit")); break;
        case 89: iNum = 1; iSide = 20; sAbility="Craft (Pharmaceutical) Check, "; iMod = GetSkillRank(SKILL_CRAFT_PHARMACEUTICAL, oUser); break;
        case 90: iNum = 1; iSide = 20; sAbility="Knowledge (Art) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_ART, oUser); break;
        case 91: iNum = 1; iSide = 20; sAbility="Gamble Check, "; iMod = GetSkillRank(SKILL_GAMBLE, oUser); break;
        case 92: iNum = 1; iSide = 20; sAbility="Gather Information Check, "; iMod = GetSkillRank(SKILL_GATHER_INFORMATION, oUser); break;
        case 93: iNum = 1; iSide = 20; sAbility="Handle Animal Check, "; iMod = GetSkillRank(SKILL_HANDLE_ANIMAL, oUser); break;
        case 94: iNum = 1; iSide = 20; sAbility="Heal (Treat Injury) Check, "; iMod = GetSkillRank(SKILL_HEAL, oUser)-4+4*(GetIsObjectValid(GetItemPossessedBy(oUser, "_mdrn_medikit"))||GetIsObjectValid(GetItemPossessedBy(oUser, "_mdrn_firstaid"))||GetIsObjectValid(GetItemPossessedBy(oUser, "_mdrn_surgkit"))); break;
        case 95: iNum = 1; iSide = 20; sAbility="Hide Check, "; iMod = GetSkillRank(SKILL_HIDE, oUser); break;
        case 96: iNum = 1; iSide = 20; sAbility="Intimidate Check, "; iMod = GetSkillRank(SKILL_INTIMIDATE, oUser); break;
        case 97: iNum = 1; iSide = 20; sAbility="Investigate Check, "; iMod = GetSkillRank(SKILL_INVESTIGATE, oUser)-4+4*GetIsObjectValid(GetItemPossessedBy(oUser, "_mdrn_it_investigatekit")); break;
        case 98: iNum = 1; iSide = 20; sAbility="Jump Check, "; iMod = GetSkillRank(SKILL_JUMP, oUser); break;
        case 99: iNum = 1; iSide = 20; sAbility="Knowledge (Arcane Lore) Check, "; iMod = GetSkillRank(SKILL_KNOWLEDGE_ARCANE_LORE, oUser); break;
        case 101: iNum = 1; iSide = 20; sAbility="Research Check, "; iMod = GetSkillRank(SKILL_RESEARCH, oUser); break;
        case 102: iNum = 1; iSide = 20; sAbility="Ride Check, "; iMod = GetSkillRank(SKILL_RIDE, oUser); break;
        case 103: iNum = 1; iSide = 20; sAbility="Search Check, "; iMod = GetSkillRank(SKILL_SEARCH, oUser)+4*GetHasFeat(FEAT_IMPROVEDSWEEP,oUser); break;
        case 104: iNum = 1; iSide = 20; sAbility="Sense Motive Check, "; iMod = GetSkillRank(SKILL_SENSE_MOTIVE, oUser); break;
        case 105: iNum = 1; iSide = 20; sAbility="Sleight of Hand Check, "; iMod = GetSkillRank(SKILL_SLEIGHT_OF_HAND, oUser); break;
        case 106: iNum = 1; iSide = 20; sAbility="Spot Check, "; iMod = GetSkillRank(SKILL_SPOT, oUser)+4*GetHasFeat(FEAT_SWEEP,oUser); break;
        case 107: iNum = 1; iSide = 20; sAbility="Survival Check, "; iMod = GetSkillRank(SKILL_SURVIVAL, oUser); break;
        case 108: iNum = 1; iSide = 20; sAbility="Tumble Check, "; iMod = GetSkillRank(SKILL_TUMBLE, oUser); break;
        default: iNum = iRight;
        switch (iLeft)
        {
...
void DoNewDMThingy(int iChoice, object oUser)
{
    ...
    case 91: StoreCampaignObject(GetTag(GetModule()), "dmfi_copyplayer1", oTarget);
        FloatingTextStringOnCreature("Target stored", oUser);break;
    case 92:   oParty = GetFirstFactionMember(oTarget, TRUE);
        n=1;
        while (GetIsObjectValid(oParty))
        {
            StoreCampaignObject(GetTag(GetModule()), "dmfi_copyplayer"+IntToString(n), oParty);
    ...
    case 93:n=1;
        oCopy = RetrieveCampaignObject(GetTag(GetModule()), "dmfi_copyplayer"+IntToString(n), lLocation);
...
void DoSoundFunction(int iSound, object oUser)
{
    ...
    if (GetCampaignFloat(GetTag(GetModule()), "EffectDuration") == 0.0f)
        fDuration = 1.0f;
    else
        fDuration = GetCampaignFloat(GetTag(GetModule()), "EffectDuration");

    if (GetCampaignFloat(GetTag(GetModule()), "EffectSoundDelay") == 0.0f)
        fDelay = 0.2f;
    else
        fDelay = GetCampaignFloat(GetTag(GetModule()), "EffectSoundDelay");
    switch(iSound)
    {
        ...
        case 13: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("c_boar_bat1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 14: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("al_an_chickens"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        ...
        case 19: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("al_an_flies1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 10: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("as_cv_mineshovl2"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        ...
        case 20: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("as_cv_bell1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        ...
        case 32: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("al_na_waterpipe1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 33: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("al_na_fountainsm"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        ...
        case 30: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("as_cv_pipeflush1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        ...
        case 51: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("al_cv_furnace1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 52: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sim_cntresist"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 53: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sim_protdeath"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 54: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sim_raylight"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 55: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sim_strkholy"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 56: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sps_fog_loop"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 57: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("al_cv_millwheel1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 58: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("as_cv_boilergrn1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 59: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("al_cv_fanlg1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 50: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("al_cv_sewerent1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        ...
        case 60: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sim_magsleep"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 71: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("as_cv_boomdist2"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 72: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("cb_sh_alongarm"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 73: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("cb_sh_machgun"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 74: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("al_mg_pillrlght1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 75: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("al_cv_smithfrnc1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 76: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sim_bonac"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 77: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sim_raylight"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 78: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("al_cv_pump"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 79: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("as_cv_pipegroan1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 70: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sca_dragfire"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        ...
        case 85: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sim_bonabil"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 86: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("fs_floatair"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 87: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sps_storm"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 88: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("al_na_fountainlg"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 89: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("as_cv_bellwind1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 80: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sca_conesonic01"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
       //Settings
        case 91: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("autodest"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 92:
        SetLocalString(oUser, "EffectSetting", "EffectSoundDelay");
        CreateSetting(oUser);
        break;
        case 93: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("cb_sh_photon"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 94: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sco_lgsprfire01"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 95: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sco_lgsprmind01"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 96: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sco_mebalelec01"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 97: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sco_mehanelec03"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 98: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sco_mehansonc03"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 99: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sff_rainfire"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 90: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("redalert"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 101: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("alarmcar"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 102: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("alarmstaccato"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 103: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("alarmwoop2"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 104: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("buttonbeep"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 105: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("hydraulic"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 106: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("scanner"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 107: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sirenfire2"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 108: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("sirenpolice1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 109: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("cb_sh_missile1"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
        case 100: oTarget = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lLocation); DelayCommand(fDelay, AssignCommand(oTarget, PlaySound("alarmem"))); DelayCommand(20.0f, DestroyObject(oTarget)); break;
...
void CreateEffects(int iEffect, location lEffect, object oUser)
{
    ...
    if (GetCampaignFloat(GetTag(GetModule()), "EffectDelay") == 0.0f)
        fDelay = 5.0f;
    else
        fDelay = GetCampaignFloat(GetTag(GetModule()), "EffectDelay");

    if (GetCampaignFloat(GetTag(GetModule()), "EffectBeamDuration") == 0.0f)
        fBeamDuration = 5.0f;
    else
        fBeamDuration =  GetCampaignFloat(GetTag(GetModule()), "EffectBeamDuration");
    ...
    switch(iEffect)
    {
        //SoU Effects(must have a target)
        ...
        case 105: ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BIGBYS_FORCEFUL_HAND), oTarget, fDuration); break;
        case 106: ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_SUNSTRIKE), oTarget, fDuration); break;
        case 107: ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_FNF_STORM), oTarget, fDuration); break;
        ...
        case 11: ApplyEffectAtLocation(DURATION_TYPE_TEMPORARY, EffectVisualEffect(321),lEffect, fDuration);
                 oBird = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lEffect); DelayCommand(fDelay, AssignCommand(oBird, PlaySound("sdr_spellturnlp"))); DelayCommand(20.0f, DestroyObject(oBird));
                 break;
        case 12: oBird = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lEffect);
                 ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(498),oBird, fDuration);
                 DelayCommand(fDuration, DestroyObject(oBird));
                 break;
        case 13: oBird = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lEffect);
                 ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(479),oBird, fDuration);
                 DelayCommand(fDuration, DestroyObject(oBird));
                 break;
        case 14: ApplyEffectAtLocation(DURATION_TYPE_INSTANT, EffectVisualEffect(481),lEffect, fDuration); break;
        case 15: oBird = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lEffect);
                 ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(425),oBird, fDuration);
                 DelayCommand(fDuration, DestroyObject(oBird));
                 break;
        ...
        case 19: ApplyEffectAtLocation(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_DUR_CALTROPS),lEffect, fDuration); break;
        case 10: ApplyEffectAtLocation(DURATION_TYPE_INSTANT, EffectVisualEffect(320),lEffect, fDuration); break;
       //Magical Status Effects (must have a target)
        case 20: ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(VFX_DUR_CUTSCENE_INVISIBILITY), oTarget, fDuration); break;
        ...
        case 23: ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(351), oTarget, fDuration); break;
        case 24: ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(508), oTarget, fDuration); break;
        case 25: ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(510), oTarget, fDuration); break;
        ...
        case 48: SetFogAmount(FOG_TYPE_SUN, GetFogAmount(FOG_TYPE_SUN, GetArea(oTarget))+10, GetArea(oTarget));
                 SetFogAmount(FOG_TYPE_MOON, GetFogAmount(FOG_TYPE_MOON, GetArea(oTarget))+10, GetArea(oTarget)); break;
        case 49: SetFogAmount(FOG_TYPE_SUN, GetFogAmount(FOG_TYPE_SUN, GetArea(oTarget))-10, GetArea(oTarget));
                 SetFogAmount(FOG_TYPE_MOON, GetFogAmount(FOG_TYPE_MOON, GetArea(oTarget))-10, GetArea(oTarget)); break;
        case 40: nFog = GetFogColor(FOG_TYPE_SUN, GetArea(oTarget));
                 if (nFog == FOG_COLOR_BLACK)
                    nFog = FOG_COLOR_GREY;
                 else if (nFog == FOG_COLOR_GREY)
                    nFog = FOG_COLOR_BROWN_DARK;
                 else if (nFog == FOG_COLOR_BROWN_DARK)
                    nFog = FOG_COLOR_BROWN;
                 else if (nFog == FOG_COLOR_BROWN)
                    nFog = FOG_COLOR_RED_DARK;
                 else if (nFog == FOG_COLOR_RED_DARK)
                    nFog = FOG_COLOR_RED;
                 else if (nFog == FOG_COLOR_RED)
                    nFog = FOG_COLOR_ORANGE_DARK;
                 else if (nFog == FOG_COLOR_ORANGE_DARK)
                    nFog = FOG_COLOR_ORANGE;
                 else if (nFog == FOG_COLOR_ORANGE)
                    nFog = FOG_COLOR_YELLOW_DARK;
                 else if (nFog == FOG_COLOR_YELLOW_DARK)
                    nFog = FOG_COLOR_YELLOW;
                 else if (nFog == FOG_COLOR_YELLOW)
                    nFog = FOG_COLOR_GREEN_DARK;
                 else if (nFog == FOG_COLOR_GREEN_DARK)
                    nFog = FOG_COLOR_GREEN;
                 else if (nFog == FOG_COLOR_GREEN)
                    nFog = FOG_COLOR_CYAN;
                 else if (nFog == FOG_COLOR_CYAN)
                    nFog = FOG_COLOR_BLUE_DARK;
                 else if (nFog == FOG_COLOR_BLUE_DARK)
                    nFog = FOG_COLOR_BLUE;
                 else if (nFog == FOG_COLOR_BLUE)
                    nFog = FOG_COLOR_MAGENTA;
                 else if (nFog == FOG_COLOR_MAGENTA)
                    nFog = FOG_COLOR_WHITE;
                 else
                    nFog = FOG_COLOR_BLACK;
                 SetFogColor(FOG_TYPE_SUN, nFog, GetArea(oTarget));
                 nFog = GetFogColor(FOG_TYPE_MOON, GetArea(oTarget));
                 if (nFog == FOG_COLOR_BLACK)
                    nFog = FOG_COLOR_GREY;
                 else if (nFog == FOG_COLOR_GREY)
                    nFog = FOG_COLOR_BROWN_DARK;
                    ...
                    nFog = FOG_COLOR_BLACK;
                 SetFogColor(FOG_TYPE_MOON, nFog, GetArea(oTarget)); break;
        //Beam Effects
        ...
        case 54: ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectBeam(VFX_BEAM_CHAIN, oUser, BODY_NODE_CHEST, FALSE), oTarget, fBeamDuration); break;
        ...
        case 59: ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectBeam(VFX_BEAM_BLACK, oUser, BODY_NODE_CHEST, FALSE), oTarget, fBeamDuration); break;

        //Environmental Effects
        case 61: FXWand_Lightning(oTarget); break;
        case 62: ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(VFX_DUR_ENTANGLE), oTarget, fDuration); break;
        ...
        case 60: nFog = GetSkyBox(GetArea(oTarget));

                 if (nFog == 5)
                    nFog = 0;
                 else
                    nFog ++;
                 SetSkyBox(nFog, GetArea(oTarget)); break;
        //Summon Effects
        case 71:
                   // tell the DM object to shake the screen
                   AssignCommand( oUser, ApplyEffectAtLocation ( DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_FNF_SCREEN_SHAKE), lEffect));
                   AssignCommand ( oUser, DelayCommand( 2.8, ApplyEffectAtLocation ( DURATION_TYPE_INSTANT, EffectVisualEffect ( VFX_FNF_SCREEN_BUMP), lEffect)));
                   AssignCommand ( oUser, DelayCommand( 3.0, ApplyEffectAtLocation ( DURATION_TYPE_INSTANT, EffectVisualEffect ( VFX_FNF_SCREEN_SHAKE), lEffect)));
                   AssignCommand ( oUser, DelayCommand( 4.5, ApplyEffectAtLocation ( DURATION_TYPE_INSTANT, EffectVisualEffect ( VFX_FNF_SCREEN_BUMP), lEffect)));
                   AssignCommand ( oUser, DelayCommand( 5.8, ApplyEffectAtLocation ( DURATION_TYPE_INSTANT, EffectVisualEffect ( VFX_FNF_SCREEN_BUMP), lEffect)));
                   oBird = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lEffect); DelayCommand(2.8, AssignCommand(oBird, PlaySound("sff_rainfire"))); DelayCommand(20.0f, DestroyObject(oBird));




                break;
        case 72: ApplyEffectAtLocation(DURATION_TYPE_INSTANT, EffectVisualEffect(494),lEffect); break;
        case 73: DelayCommand(1.0, ApplyEffectAtLocation(DURATION_TYPE_INSTANT, EffectVisualEffect(460),lEffect));
                 oBird = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lEffect); DelayCommand(0.5, AssignCommand(oBird, PlaySound("sco_mehansonc03"))); DelayCommand(20.0f, DestroyObject(oBird));
                 break;
        case 74: ApplyEffectAtLocation(DURATION_TYPE_INSTANT, EffectVisualEffect(464),lEffect);
                 oBird = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lEffect); DelayCommand(fDelay, AssignCommand(oBird, PlaySound("sff_rainfire"))); DelayCommand(20.0f, DestroyObject(oBird));
                 break;
        case 75: ApplyEffectAtLocation(DURATION_TYPE_INSTANT, EffectVisualEffect(490),lEffect); break;


        case 76: ApplyEffectAtLocation(DURATION_TYPE_INSTANT, EffectVisualEffect(492),lEffect); break;
        case 77: ApplyEffectAtLocation(DURATION_TYPE_INSTANT, EffectVisualEffect(135),lEffect); break;
        case 78: ApplyEffectAtLocation(DURATION_TYPE_INSTANT, EffectVisualEffect(136),lEffect); break;
        case 79: // tell the DM object to shake the screen
                   AssignCommand( oUser, ApplyEffectAtLocation ( DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_FNF_SCREEN_SHAKE), lEffect));
                   AssignCommand ( oUser, DelayCommand( 2.8, ApplyEffectAtLocation ( DURATION_TYPE_INSTANT, EffectVisualEffect ( VFX_FNF_SCREEN_BUMP), lEffect)));
                    oBird = CreateObject(OBJECT_TYPE_PLACEABLE, "plc_invisobj", lEffect); DelayCommand(0.5, AssignCommand(oBird, PlaySound("as_cv_pipegroan1"))); DelayCommand(20.0f, DestroyObject(oBird));
        ...
        case 70:
                ...
                if (GetLocalInt(oUser, "dmfi_make_door")==0)
                {
                    SetLocalInt(oUser, "dmfi_make_door", 1);
                    SetLocalLocation(oUser, "dmfi_door_location", GetLocalLocation(oUser, "dmfi_univ_location"));
                    SendMessageToPC(oUser, "Location set.");


                }
                else
                {
                    SetLocalInt(oUser, "dmfi_make_door", 0);
                    SetLocalLocation(CreateObject(OBJECT_TYPE_PLACEABLE, "_mdrn_placedoor", GetLocalLocation(oUser, "dmfi_univ_location")), "lTarget", GetLocalLocation(oUser, "dmfi_door_location"));
                    SetLocalLocation(CreateObject(OBJECT_TYPE_PLACEABLE, "_mdrn_placedoor", GetLocalLocation(oUser, "dmfi_door_location")), "lTarget", GetLocalLocation(oUser, "dmfi_univ_location"));

                    SendMessageToPC(oUser, "Door created.");
            ...
            break;
        //Delayed Effects
        case 80: oBird = GetItemActivatedTarget();
            if (!GetIsObjectValid(oBird))
            {
                // Storing location for return
                SetLocalLocation(oUser, "dmfi_fly_location", GetLocalLocation(oUser, "dmfi_univ_location"));
                SendMessageToPC(oUser, "Location set.");
            }
            else
            {
                 location lFlyTarg = GetLocalLocation(oUser, "dmfi_fly_location");
                 ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectDisappearAppear(lFlyTarg), oBird, fDuration);
                 SendMessageToPC(oUser, "Sent fly command.");

            }
            break;
            case 81: oBird = GetFirstPC();
                    while (GetIsObjectValid(oBird))
                    {

                        if (GetIsPC(oBird)==TRUE && GetIsDM(oBird)==FALSE)
                        {

                            SetLocalLocation(oBird, "lStartCutscene", GetLocation(oBird));
                            FadeToBlack(oBird);
                            AssignCommand(oBird, ClearAllActions());
                            AssignCommand(oBird, JumpToLocation(lEffect));
                            ApplyEffectToObject(DURATION_TYPE_PERMANENT, EffectVisualEffect(VFX_DUR_CUTSCENE_INVISIBILITY), oBird);
                            DelayCommand(1.0, ApplyEffectToObject(DURATION_TYPE_PERMANENT, EffectCutsceneParalyze(), oBird));
                            DelayCommand(3.0, FadeFromBlack(oBird));
                        }
                    oBird = GetNextPC();
                    }
                    break;
        case 82:    oBird = GetFirstPC();
                    while (GetIsObjectValid(oBird))
                    {
                        ...
                        {
                            FadeToBlack(oBird);
                            effect eRem = GetFirstEffect(oBird);
                            while (GetIsEffectValid(eRem))
                            {
                                if (GetEffectType(eRem)==EFFECT_TYPE_CUTSCENE_PARALYZE)
                                    RemoveEffect(oBird, eRem);
                                if (GetEffectType(eRem)==EFFECT_TYPE_VISUALEFFECT)
                                    DelayCommand(3.0, RemoveEffect(oBird, eRem));
                                eRem = GetNextEffect(oBird);
                            }

                            DelayCommand(0.5, AssignCommand(oBird, ClearAllActions()));
                            DelayCommand(0.5, AssignCommand(oBird, JumpToLocation(GetLocalLocation(oBird, "lStartCutscene"))));
                            DelayCommand(3.0, FadeFromBlack(oBird));
                        }
                    oBird = GetNextPC();
                    }
        ...
        case 83: oBird = GetFirstObjectInShape(SHAPE_SPHERE, 2.0, lEffect, FALSE, OBJECT_TYPE_DOOR);
                 if (GetIsObjectValid(oBird))
                 {
                    if (GetLocalInt(oUser, "dmfi_make_realdoor")==0)
                    {
                        SetLocalInt(oUser, "dmfi_make_realdoor", 1);
                        SetLocalObject(oUser, "dmfi_door_object", oBird);
                        SendMessageToPC(oUser, "Door stored; now click on destination door OR click on this door again to clear.");

                    }
                    else
                    {
                        SetLocalInt(oUser, "dmfi_make_realdoor", 0);
                        if (oBird == GetLocalObject(oUser, "dmfi_door_object"))
                        {
                            SetLocalObject(oBird, "oDoorTarget", OBJECT_INVALID);
                            SendMessageToPC(oUser, "Door settings cleared.");
                        }
                        else
                        {
                            SetLocalObject(oBird, "oDoorTarget", GetLocalObject(oUser, "dmfi_door_object"));
                            SetLocalObject(GetLocalObject(oUser, "dmfi_door_object"), "oDoorTarget", oBird);

                            SendMessageToPC(oUser, "Doors now connect - remember, only works on ship or dock doors with proper scripts.");
                        }

                    }
                }
                else
                    SendMessageToPC(oUser, "No door within 2 meters of target.");
                break;
        ...
        case 85: oBird = GetItemActivatedTarget();
                 lStart = GetLocation(oBird);
                 sTag = GetStringLeft(GetName(oBird), 5);
                 AssignCommand(CopyObject(oBird, lStart, OBJECT_INVALID, sTag), SpeakString(""));     // creates a fake duplicate
                 DelayCommand(0.5, ChangeToStandardFaction(GetObjectByTag(sTag), STANDARD_FACTION_MERCHANT));
        ...
        case 87: if (!GetIsDM(oTarget)) DelayCommand(fDelay, FadeToBlack(oTarget)); break;
        case 88: if (!GetIsDM(oTarget)) DelayCommand(fDelay, FadeFromBlack(oTarget)); break;
        ...
        MusicBattleStop(GetArea(oUser));
        break;
        case 90: // Set Module Target PC variable
        if (GetLocalInt(GetModule(), "nRecurse")==0)
        {
            SetLocalInt(GetModule(), "nRecurse", 1);
            if (GetLocalInt(GetModule(), "dmfi_univ_party")==1)
            {
                SetLocalInt(GetModule(), "dmfi_univ_party", 0);
                SendMessageToAllDMs("DMFI Wands now target individuals.");
            }
            else
            {
                SetLocalInt(GetModule(), "dmfi_univ_party", 1);
                SendMessageToAllDMs("DMFI Wands now target ALL PC's.");
            }
        }
        break;
        default: break;
...
void DoEmoteFunction(int iEmote, object oUser)
{
    ...
    case 10:
        if (!GetLocalInt(oTarget, "hls_emotemute")) FloatingTextStringOnCreature("*emote* commands are off", oTarget, FALSE);
    ...
    case 21: AssignCommand(oTarget, PlayAnimation( ANIMATION_FIREFORGET_DRINK, 1.0)); break;
    case 22: AssignCommand(oTarget, PlayAnimation( ANIMATION_LOOPING_CUSTOM9, 1.0, fDur)); break;
    case 23: SmokePipe(oTarget); break;
    case 24: AssignCommand(oTarget, PlayAnimation( ANIMATION_LOOPING_CUSTOM7, 1.0, fDur)); break;
    case 25: AssignCommand(oTarget, PlayAnimation( ANIMATION_LOOPING_PAUSE_DRUNK, 1.0, fDur)); break;
    case 80: AssignCommand(oTarget, PlayAnimation( ANIMATION_LOOPING_CUSTOM2, 1.0, fDur)); break;
    ...
    case 89: AssignCommand(oTarget, PlayAnimation( ANIMATION_LOOPING_CUSTOM4, 1.0, fDur)); break;
    case 90: AssignCommand(oTarget, PlayAnimation( ANIMATION_LOOPING_CUSTOM1, 1.0, fDur)); break;
    ...
    case 98: AssignCommand(oTarget, PlayAnimation( ANIMATION_LOOPING_CUSTOM3, 1.0, fDur)); break;
    default: break;
    }
}
