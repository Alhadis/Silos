...
if(rx_flag<64)
{	
 Rx_Buff[rx_flag++]=(uint8_t)((NRF_UART_Type *) 0x40002000UL)->RXD;
}
else
{
	UART_Decode();
...
void Convert_16bit_to_BCD_ASCII (unsigned char *buffer, unsigned short Data)
{
 ...
 unsigned char result[5];
   temp= Data;
	   ...
	   result[0] = (temp/10000 )+0x30;		  
	   result[1] =  ((temp%10000)/1000)+0x30;	  
	   result[2] = 	((temp%1000)/100)+0x30;	  	  
	   result[3] = 	((temp%100)/10)+0x30;		 
	   result[4] =   (temp%10)+0x30;			 
