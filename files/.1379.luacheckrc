...
std = "luajit+garrysmod+citymod"

-- Problems to ignore
ignore = {
    "212", -- Unused argument, will report "self" on functions accessed by semi-colon
    "6..", -- All whitespace warnings
    "42.", -- Shadowing
...
stds.citymod.globals =
{
  CityMod = 
  {
    fields = 
    {
      -- Libraries. These usually have more fields specified
      Rank = 
      {
        fields =
        {
