...
Lemma match_xor_aug_match:
  forall (e p: list E) (v: V) (v1 v2: list V), aug_path p-> v1 = epath_to_vpath gra M -> is_matching v1 M  -> e = xor_edge M p -> v2 = epath_to_vpath gra M -> is_matching v2 e.
Proof.
  intros.
