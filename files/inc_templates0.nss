...
// this is only for testing, I don't recommend giving them randomly to creatures.
...
void TMP_ClericSpell0()
{
int n;
switch(Random(4))
{
case 0: n=GetLocalInt(OBJECT_SELF,"bSPELL_CURE_MINOR_WOUNDS"); SetLocalInt(OBJECT_SELF,"bSPELL_CURE_MINOR_WOUNDS",n+1); break;
case 1: n=GetLocalInt(OBJECT_SELF,"bSPELL_RESISTANCE"); SetLocalInt(OBJECT_SELF,"bSPELL_RESISTANCE",n+1); break;
case 2: n=GetLocalInt(OBJECT_SELF,"bSPELL_LIGHT"); SetLocalInt(OBJECT_SELF,"bSPELL_LIGHT",n+1); break;
case 3: n=GetLocalInt(OBJECT_SELF,"bSPELL_INFLICT_MINOR_WOUNDS"); SetLocalInt(OBJECT_SELF,"bSPELL_INFLICT_MINOR_WOUNDS",n+1); break;
case 4: n=GetLocalInt(OBJECT_SELF,"bSPELL_VIRTUE"); SetLocalInt(OBJECT_SELF,"bSPELL_VIRTUE",n+1); break;
}
}
...
switch(Random(6))
{
case 0: n=GetLocalInt(OBJECT_SELF,"bSPELL_ACID_SPLASH"); SetLocalInt(OBJECT_SELF,"bSPELL_ACID_SPLASH",n+1); break;
case 1: n=GetLocalInt(OBJECT_SELF,"bSPELL_RAY_OF_FROST"); SetLocalInt(OBJECT_SELF,"bSPELL_RAY_OF_FROST",n+1); break;
case 2: n=GetLocalInt(OBJECT_SELF,"bSPELL_DAZE"); SetLocalInt(OBJECT_SELF,"bSPELL_DAZE",n+1); break;
case 3: n=GetLocalInt(OBJECT_SELF,"bSPELL_ELECTRIC_JOLT"); SetLocalInt(OBJECT_SELF,"bSPELL_ELECTRIC_JOLT",n+1); break;
case 4: n=GetLocalInt(OBJECT_SELF,"bSPELL_RESISTANCE"); SetLocalInt(OBJECT_SELF,"bSPELL_RESISTANCE",n+1); break;
case 5: n=GetLocalInt(OBJECT_SELF,"bSPELL_LIGHT"); SetLocalInt(OBJECT_SELF,"bSPELL_LIGHT",n+1); break;
case 6: n=GetLocalInt(OBJECT_SELF,"bSPELL_FLARE"); SetLocalInt(OBJECT_SELF,"bSPELL_FLARE",n+1); break;
}
}



// Random spells, no level checks. Not used unless you uncomment in nw_c2_default9.
void TemplateSpell(object o, int n = -1)
{
if(n == -1) n = d6();
switch(Random(366))
{
