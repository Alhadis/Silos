...
void AnimActionPlayRandomAnimation()
{
    int iCup = GetLocalInt(OBJECT_SELF, "hascup");
    int iSmoke = GetLocalInt(OBJECT_SELF, "hassmoke");
    int iSmokeCup = GetLocalInt(OBJECT_SELF, "hascupsmoke");
    int nRoll;
    int bInTavern=FALSE;
    int bInHome=FALSE;
    ...
    else if (GetBaseItemType(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND, OBJECT_SELF))==211
                || GetBaseItemType(GetItemInSlot(INVENTORY_SLOT_LEFTHAND, OBJECT_SELF))==211)
    {
        // NPC has a cup.
        nRoll = Random(8);
        switch (nRoll)
        ...
        case 2:
            // Drinking animation
            ActionPlayAnimation(ANIMATION_LOOPING_CUSTOM9, 1.0, 12.0);
            break;
        case 3:
            //unknown custom animation
            ActionPlayAnimation(ANIMATION_FIREFORGET_PAUSE_BORED); break;
        case 4:
            //unknown custom animation
            PlayAnimation(ANIMATION_LOOPING_CUSTOM3, 1.0, 12.0); break;
        case 5:
            ActionPlayAnimation(ANIMATION_LOOPING_PAUSE_TIRED,
                                ANIM_LOOPING_SPEED,
                                ANIM_LOOPING_LENGTH);
        ...
        case 6:
            //Fold arms animation
            PlayAnimation(ANIMATION_LOOPING_CUSTOM4, 1.0, 12.0);
            break;
        case 7:
    ...
    else if (GetBaseItemType(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND, OBJECT_SELF))==210
                || GetBaseItemType(GetItemInSlot(INVENTORY_SLOT_LEFTHAND, OBJECT_SELF))==210)
    {
        // NPC has a cigarette.
        nRoll = Random(8);
        switch (nRoll)
        ...
        case 2:
            //smoke cigarette
            ActionPlayAnimation(ANIMATION_LOOPING_CUSTOM7, 1.0, 12.0);
            break;
        case 3:
            ActionPlayAnimation(ANIMATION_FIREFORGET_PAUSE_BORED); break;
        case 4:
            //unknown custom animation
            ActionPlayAnimation(ANIMATION_LOOPING_CUSTOM3, 1.0, 12.0); break;
        case 5:
            ActionPlayAnimation(ANIMATION_LOOPING_PAUSE_TIRED,
                                ANIM_LOOPING_SPEED,
                                ANIM_LOOPING_LENGTH);
        ...
        case 7:
            ...
            break;
                ...
                || GetBaseItemType(GetItemInSlot(INVENTORY_SLOT_LEFTHAND, OBJECT_SELF))==210) &&
                (GetBaseItemType(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND, OBJECT_SELF))==211
                || GetBaseItemType(GetItemInSlot(INVENTORY_SLOT_LEFTHAND, OBJECT_SELF))==211))

   {
        // NPC has a cigarette and a cup.
        nRoll = Random(9);
        switch (nRoll)
        {
        case 0:
            //
            // Drinking animation
            AssignCommand(OBJECT_SELF, PlayAnimation( ANIMATION_LOOPING_CUSTOM9, 1.0, 12.0));
            break;
        case 1:
            // Drinking animation
            AssignCommand(OBJECT_SELF, PlayAnimation( ANIMATION_LOOPING_CUSTOM9, 1.0, 12.0));
        ...
        case 4:
            //smoke cigarette
            PlayAnimation(ANIMATION_LOOPING_CUSTOM7, 1.0, 12.0); break;
        case 5:
            AssignCommand(OBJECT_SELF, PlayAnimation( ANIMATION_LOOPING_CUSTOM9, 1.0, 12.0));
            break;
        case 6:
            // Drinking animation
            PlayAnimation(ANIMATION_LOOPING_CUSTOM9, 1.0, 12.0);
            break;
        case 7:
            AnimActionLookAround();
            break;
