...
[Mesh]
  uniform_refine = 0
  file = depression_corner_quad2160.e
  block_id = '1'
  boundary_id = '1 2 3'
...
#active = ''
  [./EntViscMat]
    ...
    velocity_PPS_name = AverageValue
    eos = eos
  [../]
...
#file_base = CompressionCorner2D
  output_variables = 'density_aux pressure_aux kappa_aux kappa_max_aux mach_number_aux norm_vel_aux'
