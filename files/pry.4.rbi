...
module Pry::Config::Behavior
  ...
  def refresh; end
  def respond_to_missing?(key, include_private = nil); end
  def self.included(klass); end
  def to_h; end
  def to_hash; end
  def try_convert_to_hash(obj); end
end
module Pry::Config::Behavior::Builder
  def from_hash(hash, default = nil); end
end
class Pry::Config::Default
  ...
  def commands; end
  def completer; end
  def configure_gist; end
  def configure_history; end
