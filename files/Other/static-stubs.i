...
# 1 "static-stubs.c"
# 22 "static-stubs.c"
# 1 "../sysdeps/posix/libc_fatal.c" 1
# 19 "../sysdeps/posix/libc_fatal.c"
...
# 20 "../sysdeps/posix/libc_fatal.c" 2
# 1 "../include/errno.h" 1
...
# 21 "../sysdeps/posix/libc_fatal.c" 2
# 1 "../include/fcntl.h" 1
...
# 22 "../sysdeps/posix/libc_fatal.c" 2
...
uint64_t _dl_strtoul (const char *, char **) ;
...
extern int _dl_argc __attribute__ ((section (".data.rel.ro")));
...
extern void *_dl_random __attribute__ ((section (".data.rel.ro")));
...
extern void _dl_start_profile (void) ;
...
extern size_t _dl_next_tls_modid (void) ;


extern size_t _dl_count_modids (void) ;


extern void _dl_determine_tlsoffset (void) ;
...
extern size_t _dl_dst_count (const char *name) ;
...
extern int _dl_scope_free (void *) ;
...
extern void *_dl_tls_get_addr_soft (struct link_map *l) ;
...
# 23 "../sysdeps/posix/libc_fatal.c" 2
# 1 "../sysdeps/unix/sysv/linux/paths.h" 1
# 24 "../sysdeps/posix/libc_fatal.c" 2
...
# 25 "../sysdeps/posix/libc_fatal.c" 2
...
# 27 "../sysdeps/posix/libc_fatal.c" 2
...
extern int __getlogin_r_loginuid (char *name, size_t namesize)
     ;
# 31 "../sysdeps/posix/libc_fatal.c" 2
...
# 33 "../sysdeps/posix/libc_fatal.c" 2
...
# 34 "../sysdeps/posix/libc_fatal.c" 2
...
static 
# 41 "../sysdeps/posix/libc_fatal.c" 3 4
      _Bool

# 42 "../sysdeps/posix/libc_fatal.c"
writev_for_fatal (int fd, const struct iovec *iov, size_t niov, size_t total)
{
  return (__extension__ ({ long int __result; do __result = (long int) (__writev (fd, iov, niov)); while (__result == -1L && (*__errno_location ()) == 
# 44 "../sysdeps/posix/libc_fatal.c" 3 4
        4
# 44 "../sysdeps/posix/libc_fatal.c"
        ); __result; })) == total;
}
...
# 52 "../sysdeps/posix/libc_fatal.c" 3 4
             _Bool 
# 52 "../sysdeps/posix/libc_fatal.c"
                  written __attribute__ ((unused)),
...
# 72 "../sysdeps/posix/libc_fatal.c" 3 4
 __builtin_va_start(
# 72 "../sysdeps/posix/libc_fatal.c"
 ap
# 72 "../sysdeps/posix/libc_fatal.c" 3 4
 ,
# 72 "../sysdeps/posix/libc_fatal.c"
  ...
  if ((action & do_backtrace))
    {
      ...
      if (on_2 == 
# 85 "../sysdeps/posix/libc_fatal.c" 3 4
                 ((void *)0) 
# 85 "../sysdeps/posix/libc_fatal.c"
                      || *on_2 == '\0')
 fd = __open_nocancel ("/dev/tty", 02 | 0400 | 04000);
    }
...
# 92 "../sysdeps/posix/libc_fatal.c" 3 4
                         ((void *)0)
# 92 "../sysdeps/posix/libc_fatal.c"
                             ;
  int nlist = 0;
 ...
 {
   str = 
# 113 "../sysdeps/posix/libc_fatal.c" 3 4
        __builtin_va_arg(
# 113 "../sysdeps/posix/libc_fatal.c"
        ap
# 113 "../sysdeps/posix/libc_fatal.c" 3 4
        ,
# 113 "../sysdeps/posix/libc_fatal.c"
...
# 113 "../sysdeps/posix/libc_fatal.c"
      ...
      else
 {
   ...
   cp = next;
      ...
      struct str_list *newp = __builtin_alloca (sizeof (struct str_list));
      newp->str = str;
      newp->len = len;
      newp->next = list;
      list = newp;
...
# 132 "../sysdeps/posix/libc_fatal.c" 3 4
 _Bool 
# 132 "../sysdeps/posix/libc_fatal.c"
      written = 
# 132 "../sysdeps/posix/libc_fatal.c" 3 4
                0
# 132 "../sysdeps/posix/libc_fatal.c"
  ...
  if (nlist > 0)
    {
      struct iovec *iov = __builtin_alloca (nlist * sizeof (struct iovec));
      ssize_t total = 0;
      ...
      for (int cnt = nlist - 1; cnt >= 0; --cnt)
 {
   ...
   list = list->next;
      ...
      if ((action & do_abort))
 {
   total = ((total + 1 + _dl_pagesize - 1)
     & ~(_dl_pagesize - 1));
   struct abort_msg_s *buf = __mmap (
# 152 "../sysdeps/posix/libc_fatal.c" 3 4
                                    ((void *)0)
# 152 "../sysdeps/posix/libc_fatal.c"
                                        , total,
         0x1 | 0x2,
         0x20 | 0x02, -1, 0);
   if (__builtin_expect ((buf != ((void *) -1)), 1))
     {
       buf->size = total;
       char *wp = buf->msg;
  ...
  wp = mempcpy (wp, iov[cnt].iov_base, iov[cnt].iov_len);
       *wp = '\0';
       ...
       struct abort_msg_s *old = ({ __typeof (*&__abort_msg) result; if (sizeof (*&__abort_msg) == 1) __asm __volatile ("xchgb %b0, %1" : "=q" (result), "=m" (*&__abort_msg) : "0" (buf), "m" (*&__abort_msg)); else if (sizeof (*&__abort_msg) == 2) __asm __volatile ("xchgw %w0, %1" : "=r" (result), "=m" (*&__abort_msg) : "0" (buf), "m" (*&__abort_msg)); else if (sizeof (*&__abort_msg) == 4) __asm __volatile ("xchgl %0, %1" : "=r" (result), "=m" (*&__abort_msg) : "0" (buf), "m" (*&__abort_msg)); else __asm __volatile ("xchgq %q0, %1" : "=r" (result), "=m" (*&__abort_msg) : "0" ((atomic64_t) ((__typeof__ (*(0 ? (__typeof__ (0 ? (__typeof__ ((__typeof__ (buf)) 0) *) 0 : (void *) ((__builtin_classify_type ((__typeof__ (buf)) 0) == 5)))) 0 : (__typeof__ (0 ? (intptr_t *) 0 : (void *) (!((__builtin_classify_type ((__typeof__ (buf)) 0) == 5))))) 0))) (buf))), "m" (*&__abort_msg)); result; })
                ;
       if (old != 
# 167 "../sysdeps/posix/libc_fatal.c" 3 4
                 ((void *)0)
# 167 "../sysdeps/posix/libc_fatal.c"
                     )
...
# 173 "../sysdeps/posix/libc_fatal.c" 3 4
 __builtin_va_end(
# 173 "../sysdeps/posix/libc_fatal.c"
 ap
# 173 "../sysdeps/posix/libc_fatal.c" 3 4
 )
# 173 "../sysdeps/posix/libc_fatal.c"
