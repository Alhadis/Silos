# 1 "../sysdeps/unix/sysv/linux/dl-vdso.c"
...
# 1 "<command-line>" 2
# 1 "../sysdeps/unix/sysv/linux/dl-vdso.c"
# 19 "../sysdeps/unix/sysv/linux/dl-vdso.c"
# 1 "/home/flaig/EB_2.1/build/tmp/work/corei7-64-poky-linux/glibc/2.28-r0/build-x86_64-poky-linux/config.h" 1
# 20 "../sysdeps/unix/sysv/linux/dl-vdso.c" 2
...
# 21 "../sysdeps/unix/sysv/linux/dl-vdso.c" 2


void *
_dl_vdso_vsym (const char *name, const struct r_found_version *vers)
{
  struct link_map *map = _rtld_global_ro._dl_sysinfo_map;
  void *value = 
# 27 "../sysdeps/unix/sysv/linux/dl-vdso.c" 3 4
               ((void *)0)
# 27 "../sysdeps/unix/sysv/linux/dl-vdso.c"
                   ;


  if (map != 
# 30 "../sysdeps/unix/sysv/linux/dl-vdso.c" 3 4
            ((void *)0)
# 30 "../sysdeps/unix/sysv/linux/dl-vdso.c"
                )
    {

      Elf64_Sym wsym;
      memset (&wsym, 0, sizeof (Elf64_Sym));
      wsym.st_info = (unsigned char) ((((2)) << 4) + (((0)) & 0xf));


      const Elf64_Sym *ref = &wsym;
      lookup_t result = _rtld_global_ro._dl_lookup_symbol_x (name, map, &ref,
         map->l_local_scope,
         vers, 0, 0, 
# 41 "../sysdeps/unix/sysv/linux/dl-vdso.c" 3 4
                    ((void *)0)
# 41 "../sysdeps/unix/sysv/linux/dl-vdso.c"
                        );

      if (ref != 
# 43 "../sysdeps/unix/sysv/linux/dl-vdso.c" 3 4
                ((void *)0)
# 43 "../sysdeps/unix/sysv/linux/dl-vdso.c"
                    )
 value = (void *) ((ref) == 
# 44 "../sysdeps/unix/sysv/linux/dl-vdso.c" 3 4
        ((void *)0) 
# 44 "../sysdeps/unix/sysv/linux/dl-vdso.c"
