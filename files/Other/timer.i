...
#line 29 "..\\user\\system.h"
#line 1 "..\\user\\ble_apps_uart.h"
...
#line 32 "..\\user\\ble_apps_uart.h"



#line 42 "..\\user\\ble_apps_uart.h"
...
#line 35 "..\\user\\system.h"
#line 1 "..\\user\\ble_nus.h"
...
#line 110 "..\\Include\\s110\\ble_types.h"
...
#line 116 "..\\Include\\s110\\ble_gap.h"
 



 
#line 128 "..\\Include\\s110\\ble_gap.h"
...
#line 207 "..\\Include\\s110\\ble_gap.h"
...
#line 227 "..\\Include\\s110\\ble_gap.h"
...
#line 80 "..\\Include\\s110\\ble_gatts.h"
 



 
#line 92 "..\\Include\\s110\\ble_gatts.h"
...
#line 29 "..\\Include\\app_common\\app_util.h"
...
#line 104 "..\\Include\\app_common\\app_util.h"
...
#line 123 "..\\Include\\app_common\\app_util.h"
...
#line 37 "..\\user\\ble_nus.h"
#line 38 "..\\user\\ble_nus.h"
#line 39 "..\\user\\ble_nus.h"
...
#line 42 "..\\user\\system.h"
#line 43 "..\\user\\system.h"
#line 44 "..\\user\\system.h"
#line 45 "..\\user\\system.h"
...
#line 46 "..\\user\\system.h"
#line 47 "..\\user\\system.h"
...
#line 149 "..\\Include\\app_common\\app_timer.h"
...
static __inline void app_timer_evt_get(void * p_event_data, uint16_t event_size)
{
    ...
    do { const _Bool LOCAL_BOOLEAN_VALUE = (event_size == sizeof(app_timer_event_t)); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 275, (uint8_t*) "..\\Include\\app_common\\app_timer.h"); } while (0); } } while (0);
...
#line 57 "..\\user\\system.h"
#line 1 "..\\Include\\ble\\ble_bondmngr.h"
...
#line 103 "..\\Include\\ble\\ble_bondmngr.h"
#line 104 "..\\Include\\ble\\ble_bondmngr.h"
#line 105 "..\\Include\\ble\\ble_bondmngr.h"
...
uint32_t ble_bondmngr_is_link_encrypted(_Bool * status);
...
#line 42 "..\\Include\\app_common\\app_gpiote.h"
#line 43 "..\\Include\\app_common\\app_gpiote.h"
...
#line 82 "..\\Include\\app_common\\app_gpiote.h"
...
#line 89 "..\\Include\\app_common\\app_button.h"
...
static __inline void app_button_evt_get(void * p_event_data, uint16_t event_size)
{
    ...
    do { const _Bool LOCAL_BOOLEAN_VALUE = (event_size == sizeof(app_button_event_t)); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 155, (uint8_t*) "..\\Include\\app_common\\app_button.h"); } while (0); } } while (0);
...
#line 61 "..\\user\\system.h"
#line 62 "..\\user\\system.h"
#line 1 "..\\Include\\ble\\ble_radio_notification.h"
...
#line 24 "..\\Include\\ble\\ble_radio_notification.h"
#line 25 "..\\Include\\ble\\ble_radio_notification.h"
#line 26 "..\\Include\\ble\\ble_radio_notification.h"

 
typedef void (*ble_radio_notification_evt_handler_t) (_Bool radio_active);
...
void Timer2_init(void)
{
  ...
  ((NRF_TIMER_Type *) 0x4000A000UL)->CC[0]       = (31U);  
  
	
  ((NRF_TIMER_Type *) 0x4000A000UL)->INTENSET= ((1UL) << (16UL));	
	
	((NRF_TIMER_Type *) 0x4000A000UL)->SHORTS      = ((1UL) << (0UL));
...
void TIMER2_IRQHandler(void)
{
 	...
 	if ((((NRF_TIMER_Type *) 0x4000A000UL)->EVENTS_COMPARE[0] != 0) && ((((NRF_TIMER_Type *) 0x4000A000UL)->INTENSET & (0x1UL << (16UL))) != 0)) 
   { 
	...
	if(LED_Sys_Cnt>800)
  {
   ...
   adc_start();
    ...
    Timeout_1sec_Cnt=0;
		...
		BT_TR_time_count++;                                        
 if((BT_TR_time_count==60)||(change_state==1))      
 {
   err_code = ble_nus_send_string(&m_nus, states, 8 );      
   if (err_code != ((0x0) + 8))
   {
   do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 117, (uint8_t*) "..\\user\\timer.c"); } while (0); } } while (0);
   }
   BT_TR_time_count=0;
	 change_state=0;
 } 
