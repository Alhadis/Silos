# 1 "../sysdeps/unix/sysv/linux/x86/dl-sysdep.c"
...
# 1 "<command-line>" 2
# 1 "../sysdeps/unix/sysv/linux/x86/dl-sysdep.c"
# 19 "../sysdeps/unix/sysv/linux/x86/dl-sysdep.c"
# 1 "/home/flaig/EB_2.1/build/tmp/work/corei7-64-poky-linux/glibc/2.28-r0/build-x86_64-poky-linux/config.h" 1
# 20 "../sysdeps/unix/sysv/linux/x86/dl-sysdep.c" 2
# 1 "../sysdeps/x86/cpu-tunables.c" 1
# 21 "../sysdeps/x86/cpu-tunables.c"
...
# 22 "../sysdeps/x86/cpu-tunables.c" 2
...
# 23 "../sysdeps/x86/cpu-tunables.c" 2
...
# 24 "../sysdeps/x86/cpu-tunables.c" 2
...
# 22 "../sysdeps/x86/dl-procinfo.h" 2
...
# 25 "../sysdeps/x86/cpu-tunables.c" 2
# 109 "../sysdeps/x86/cpu-tunables.c"
__attribute__ ((visibility ("hidden")))
void
_dl_tunable_set_hwcaps (tunable_val_t *valp)
{
# 130 "../sysdeps/x86/cpu-tunables.c"
  const char *p = valp->strval;
  struct cpu_features *cpu_features = &_rtld_local_ro._dl_x86_cpu_features;
  size_t len;
...
# 137 "../sysdeps/x86/cpu-tunables.c" 3 4
     _Bool 
# 137 "../sysdeps/x86/cpu-tunables.c"
          disable;
      size_t nl;
 ...
 case 3:
   if (disable)
     {
       _Static_assert (sizeof ("AVX") - 1 == 3, "AVX" " != " "3"); if (!memcmp (n, "AVX", 3)) { cpu_features->cpuid[COMMON_CPUID_INDEX_1].ecx &= ~(1 << 28); break; };
       _Static_assert (sizeof ("CX8") - 1 == 3, "CX8" " != " "3"); if (!memcmp (n, "CX8", 3)) { cpu_features->cpuid[COMMON_CPUID_INDEX_1].edx &= ~(1 << 8); break; };
       _Static_assert (sizeof ("FMA") - 1 == 3, "FMA" " != " "3"); if (!memcmp (n, "FMA", 3)) { cpu_features->cpuid[COMMON_CPUID_INDEX_1].ecx &= ~(1 << 12); break; };
       _Static_assert (sizeof ("HTT") - 1 == 3, "HTT" " != " "3"); if (!memcmp (n, "HTT", 3)) { cpu_features->cpuid[COMMON_CPUID_INDEX_1].edx &= ~(1 << 28); break; };
       _Static_assert (sizeof ("IBT") - 1 == 3, "IBT" " != " "3"); if (!memcmp (n, "IBT", 3)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].edx &= ~(1u << 20); break; };
       _Static_assert (sizeof ("RTM") - 1 == 3, "RTM" " != " "3"); if (!memcmp (n, "RTM", 3)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].ebx &= ~(1 << 11); break; };
     }
   break;
 case 4:
   if (disable)
     {
       _Static_assert (sizeof ("AVX2") - 1 == 4, "AVX2" " != " "4"); if (!memcmp (n, "AVX2", 4)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].ebx &= ~(1 << 5); break; };
       _Static_assert (sizeof ("BMI1") - 1 == 4, "BMI1" " != " "4"); if (!memcmp (n, "BMI1", 4)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].ebx &= ~(1 << 3); break; };
       _Static_assert (sizeof ("BMI2") - 1 == 4, "BMI2" " != " "4"); if (!memcmp (n, "BMI2", 4)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].ebx &= ~(1 << 8); break; };
       _Static_assert (sizeof ("CMOV") - 1 == 4, "CMOV" " != " "4"); if (!memcmp (n, "CMOV", 4)) { cpu_features->cpuid[COMMON_CPUID_INDEX_1].edx &= ~(1 << 15); break; };
       _Static_assert (sizeof ("ERMS") - 1 == 4, "ERMS" " != " "4"); if (!memcmp (n, "ERMS", 4)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].ebx &= ~(1 << 9); break; };
       _Static_assert (sizeof ("FMA4") - 1 == 4, "FMA4" " != " "4"); if (!memcmp (n, "FMA4", 4)) { cpu_features->cpuid[COMMON_CPUID_INDEX_80000001].ecx &= ~(1 << 16); break; };
       _Static_assert (sizeof ("SSE2") - 1 == 4, "SSE2" " != " "4"); if (!memcmp (n, "SSE2", 4)) { cpu_features->cpuid[COMMON_CPUID_INDEX_1].edx &= ~(1 << 26); break; };
       _Static_assert (sizeof ("I586") - 1 == 4, "I586" " != " "4"); if (!memcmp (n, "I586", 4)) { cpu_features->feature[0] &= ~(1 << 14); break; };
       _Static_assert (sizeof ("I686") - 1 == 4, "I686" " != " "4"); if (!memcmp (n, "I686", 4)) { cpu_features->feature[0] &= ~(1 << 15); break; };
     }
   break;
 case 5:
   if (disable)
     {
       _Static_assert (sizeof ("LZCNT") - 1 == 5, "LZCNT" " != " "5"); if (!memcmp (n, "LZCNT", 5)) { cpu_features->cpuid[COMMON_CPUID_INDEX_80000001].ecx &= ~(1 << 5); break; };
       _Static_assert (sizeof ("MOVBE") - 1 == 5, "MOVBE" " != " "5"); if (!memcmp (n, "MOVBE", 5)) { cpu_features->cpuid[COMMON_CPUID_INDEX_1].ecx &= ~(1 << 22); break; };
       _Static_assert (sizeof ("SHSTK") - 1 == 5, "SHSTK" " != " "5"); if (!memcmp (n, "SHSTK", 5)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].ecx &= ~(1u << 7); break; };
       _Static_assert (sizeof ("SSSE3") - 1 == 5, "SSSE3" " != " "5"); if (!memcmp (n, "SSSE3", 5)) { cpu_features->cpuid[COMMON_CPUID_INDEX_1].ecx &= ~(1 << 9); break; };
     }
   break;
 case 6:
   if (disable)
     {
       _Static_assert (sizeof ("POPCNT") - 1 == 6, "POPCNT" " != " "6"); if (!memcmp (n, "POPCNT", 6)) { cpu_features->cpuid[COMMON_CPUID_INDEX_1].ecx &= ~(1 << 23); break; };
       _Static_assert (sizeof ("SSE4_1") - 1 == 6, "SSE4_1" " != " "6"); if (!memcmp (n, "SSE4_1", 6)) { cpu_features->cpuid[COMMON_CPUID_INDEX_1].ecx &= ~(1 << 19); break; };
       _Static_assert (sizeof ("SSE4_2") - 1 == 6, "SSE4_2" " != " "6"); if (!memcmp (n, "SSE4_2", 6)) { cpu_features->cpuid[COMMON_CPUID_INDEX_1].ecx &= ~(1 << 20); break; };
     }
   break;
 case 7:
   if (disable)
     {
       _Static_assert (sizeof ("AVX512F") - 1 == 7, "AVX512F" " != " "7"); if (!memcmp (n, "AVX512F", 7)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].ebx &= ~(1 << 16); break; };
       _Static_assert (sizeof ("OSXSAVE") - 1 == 7, "OSXSAVE" " != " "7"); if (!memcmp (n, "OSXSAVE", 7)) { cpu_features->cpuid[COMMON_CPUID_INDEX_1].ecx &= ~(1 << 27); break; };
     }
   break;
 case 8:
   if (disable)
     {
       _Static_assert (sizeof ("AVX512CD") - 1 == 8, "AVX512CD" " != " "8"); if (!memcmp (n, "AVX512CD", 8)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].ebx &= ~(1 << 28); break; };
       _Static_assert (sizeof ("AVX512BW") - 1 == 8, "AVX512BW" " != " "8"); if (!memcmp (n, "AVX512BW", 8)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].ebx &= ~(1 << 30); break; };
       _Static_assert (sizeof ("AVX512DQ") - 1 == 8, "AVX512DQ" " != " "8"); if (!memcmp (n, "AVX512DQ", 8)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].ebx &= ~(1 << 17); break; };
       _Static_assert (sizeof ("AVX512ER") - 1 == 8, "AVX512ER" " != " "8"); if (!memcmp (n, "AVX512ER", 8)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].ebx &= ~(1 << 27); break; };
       _Static_assert (sizeof ("AVX512PF") - 1 == 8, "AVX512PF" " != " "8"); if (!memcmp (n, "AVX512PF", 8)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].ebx &= ~(1 << 26); break; };
       _Static_assert (sizeof ("AVX512VL") - 1 == 8, "AVX512VL" " != " "8"); if (!memcmp (n, "AVX512VL", 8)) { cpu_features->cpuid[COMMON_CPUID_INDEX_7].ebx &= ~(1u << 31); break; };
     }
   _Static_assert (sizeof ("Slow_BSF") - 1 == 8, "Slow_BSF" " != " "8"); if (!memcmp (n, "Slow_BSF", 8)) { if (disable) cpu_features->feature[0] &= ~(1 << 2); else cpu_features->feature[0] |= (1 << 2); break; }
                      ;
   break;
 case 10:
   if (disable)
     {
       _Static_assert (sizeof ("AVX_Usable") - 1 == 10, "AVX_Usable" " != " "10"); if (!memcmp (n, "AVX_Usable", 10)) { cpu_features->feature[0] &= ~(1 << 6); break; }
          ;
       _Static_assert (sizeof ("FMA_Usable") - 1 == 10, "FMA_Usable" " != " "10"); if (!memcmp (n, "FMA_Usable", 10)) { cpu_features->feature[0] &= ~(1 << 7); break; }
          ;
     }
   break;
 case 11:
   if (disable)
     {
       _Static_assert (sizeof ("AVX2_Usable") - 1 == 11, "AVX2_Usable" " != " "11"); if (!memcmp (n, "AVX2_Usable", 11)) { cpu_features->feature[0] &= ~(1 << 10); break; }
          ;
       _Static_assert (sizeof ("FMA4_Usable") - 1 == 11, "FMA4_Usable" " != " "11"); if (!memcmp (n, "FMA4_Usable", 11)) { cpu_features->feature[0] &= ~(1 << 8); break; }
          ;
     }
   _Static_assert (sizeof ("Prefer_ERMS") - 1 == 11, "Prefer_ERMS" " != " "11"); if (!memcmp (n, "Prefer_ERMS", 11)) { if (disable) cpu_features->feature[0] &= ~(1 << 19); else cpu_features->feature[0] |= (1 << 19); break; }
                       ;
   _Static_assert (sizeof ("Slow_SSE4_2") - 1 == 11, "Slow_SSE4_2" " != " "11"); if (!memcmp (n, "Slow_SSE4_2", 11)) { if (disable) cpu_features->feature[0] &= ~(1 << 9); else if (((cpu_features->cpuid[COMMON_CPUID_INDEX_1].ecx & ((1 << 20))) != 0)) cpu_features->feature[0] |= (1 << 9); break; }

                  ;
   _Static_assert (sizeof ("Prefer_FSRM") - 1 == 11, "Prefer_FSRM" " != " "11"); if (!memcmp (n, "Prefer_FSRM", 11)) { if (disable) cpu_features->feature[0] &= ~(1 << 23); else cpu_features->feature[0] |= (1 << 23); break; }
                       ;
   break;
 case 13:
   if (disable)
  ...
  = cpu_features->xsave_state_full_size;
       _Static_assert (sizeof ("XSAVEC_Usable") - 1 == 13, "XSAVEC_Usable" " != " "13"); if (!memcmp (n, "XSAVEC_Usable", 13)) { cpu_features->feature[0] &= ~(1 << 22); break; }
                         ;
     }
   break;
 case 14:
   if (disable)
     {
       _Static_assert (sizeof ("AVX512F_Usable") - 1 == 14, "AVX512F_Usable" " != " "14"); if (!memcmp (n, "AVX512F_Usable", 14)) { cpu_features->feature[0] &= ~(1 << 12); break; }
                          ;
     }
   break;
 case 15:
   if (disable)
     {
       _Static_assert (sizeof ("AVX512DQ_Usable") - 1 == 15, "AVX512DQ_Usable" " != " "15"); if (!memcmp (n, "AVX512DQ_Usable", 15)) { cpu_features->feature[0] &= ~(1 << 13); break; }
                           ;
     }
   _Static_assert (sizeof ("Fast_Rep_String") - 1 == 15, "Fast_Rep_String" " != " "15"); if (!memcmp (n, "Fast_Rep_String", 15)) { if (disable) cpu_features->feature[0] &= ~(1 << 0); else cpu_features->feature[0] |= (1 << 0); break; }
                       ;
   break;
 case 16:
     {
       _Static_assert (sizeof ("Prefer_No_AVX512") - 1 == 16, "Prefer_No_AVX512" " != " "16"); if (!memcmp (n, "Prefer_No_AVX512", 16)) { if (disable) cpu_features->feature[0] &= ~(1 << 20); else if (((cpu_features->feature[0] & ((1 << 12))) != 0)) cpu_features->feature[0] |= (1 << 20); break; }
 ...
 case 18:
     {
       _Static_assert (sizeof ("Fast_Copy_Backward") - 1 == 18, "Fast_Copy_Backward" " != " "18"); if (!memcmp (n, "Fast_Copy_Backward", 18)) { if (disable) cpu_features->feature[0] &= ~(1 << 1); else cpu_features->feature[0] |= (1 << 1); break; }
 ...
 case 19:
     {
       _Static_assert (sizeof ("Fast_Unaligned_Load") - 1 == 19, "Fast_Unaligned_Load" " != " "19"); if (!memcmp (n, "Fast_Unaligned_Load", 19)) { if (disable) cpu_features->feature[0] &= ~(1 << 4); else cpu_features->feature[0] |= (1 << 4); break; }

           ;
       _Static_assert (sizeof ("Fast_Unaligned_Copy") - 1 == 19, "Fast_Unaligned_Copy" " != " "19"); if (!memcmp (n, "Fast_Unaligned_Copy", 19)) { if (disable) cpu_features->feature[0] &= ~(1 << 18); else cpu_features->feature[0] |= (1 << 18); break; }
 ...
 case 20:
     {
       _Static_assert (sizeof ("Prefer_No_VZEROUPPER") - 1 == 20, "Prefer_No_VZEROUPPER" " != " "20"); if (!memcmp (n, "Prefer_No_VZEROUPPER", 20)) { if (disable) cpu_features->feature[0] &= ~(1 << 17); else if (((cpu_features->feature[0] & ((1 << 6))) != 0)) cpu_features->feature[0] |= (1 << 17); break; }
 ...
 case 21:
     {
       _Static_assert (sizeof ("Prefer_MAP_32BIT_EXEC") - 1 == 21, "Prefer_MAP_32BIT_EXEC" " != " "21"); if (!memcmp (n, "Prefer_MAP_32BIT_EXEC", 21)) { if (disable) cpu_features->feature[0] &= ~(1 << 16); else cpu_features->feature[0] |= (1 << 16); break; }
 ...
 case 23:
     {
       _Static_assert (sizeof ("AVX_Fast_Unaligned_Load") - 1 == 23, "AVX_Fast_Unaligned_Load" " != " "23"); if (!memcmp (n, "AVX_Fast_Unaligned_Load", 23)) { if (disable) cpu_features->feature[0] &= ~(1 << 11); else if (((cpu_features->feature[0] & ((1 << 6))) != 0)) cpu_features->feature[0] |= (1 << 11); break; }
 ...
 case 24:
     {
       _Static_assert (sizeof ("MathVec_Prefer_No_AVX512") - 1 == 24, "MathVec_Prefer_No_AVX512" " != " "24"); if (!memcmp (n, "MathVec_Prefer_No_AVX512", 24)) { if (disable) cpu_features->feature[0] &= ~(1 << 21); else if (((cpu_features->feature[0] & ((1 << 12))) != 0)) cpu_features->feature[0] |= (1 << 21); break; }
 ...
 case 26:
     {
       _Static_assert (sizeof ("Prefer_PMINUB_for_stringop") - 1 == 26, "Prefer_PMINUB_for_stringop" " != " "26"); if (!memcmp (n, "Prefer_PMINUB_for_stringop", 26)) { if (disable) cpu_features->feature[0] &= ~(1 << 5); else if (((cpu_features->cpuid[COMMON_CPUID_INDEX_1].edx & ((1 << 26))) != 0)) cpu_features->feature[0] |= (1 << 5); break; }
...
# 21 "../sysdeps/unix/sysv/linux/x86/dl-sysdep.c" 2
# 1 "../sysdeps/unix/sysv/linux/dl-sysdep.c" 1
# 23 "../sysdeps/unix/sysv/linux/dl-sysdep.c"
# 1 "../include/fcntl.h" 1
...
# 24 "../sysdeps/unix/sysv/linux/dl-sysdep.c" 2

# 1 "../include/sys/param.h" 1
# 26 "../sysdeps/unix/sysv/linux/dl-sysdep.c" 2
# 1 "../include/sys/utsname.h" 1

# 1 "../posix/sys/utsname.h" 1
# 27 "../posix/sys/utsname.h"


# 1 "../sysdeps/unix/sysv/linux/bits/utsname.h" 1
# 30 "../posix/sys/utsname.h" 2
# 48 "../posix/sys/utsname.h"
struct utsname
  {
...
extern __typeof (__uname) __uname __attribute__ ((visibility ("hidden")));
# 27 "../sysdeps/unix/sysv/linux/dl-sysdep.c" 2
...
# 29 "../sysdeps/unix/sysv/linux/dl-sysdep.c" 2
...
# 30 "../elf/dl-sysdep.c" 2



# 1 "../include/sys/types.h" 1
# 34 "../elf/dl-sysdep.c" 2
...
# 42 "../elf/dl-sysdep.c" 2
# 1 "../sysdeps/unix/sysv/linux/x86_64/dl-procinfo.h" 1
# 43 "../elf/dl-sysdep.c" 2
...
# 45 "../elf/dl-sysdep.c" 2


# 1 "./dl-tunables.h" 1
# 48 "../elf/dl-sysdep.c" 2
...
extern __typeof (__libc_enable_secure) __EI___libc_enable_secure __asm__("" "__libc_enable_secure"); extern __typeof (__libc_enable_secure) __EI___libc_enable_secure __attribute__((alias ("" "__GI___libc_enable_secure")));
int __libc_multiple_libcs = 0;


void *__libc_stack_end __attribute__ ((section (".data.rel.ro"))) = 
# 63 "../elf/dl-sysdep.c" 3 4
                                        ((void *)0)
# 63 "../elf/dl-sysdep.c"
                                            ;
extern __typeof (__libc_stack_end) __EI___libc_stack_end __asm__("" "__libc_stack_end"); extern __typeof (__libc_stack_end) __EI___libc_stack_end __attribute__((alias ("" "__GI___libc_stack_end")));
void *_dl_random __attribute__ ((section (".data.rel.ro"))) = 
# 65 "../elf/dl-sysdep.c" 3 4
                                  ((void *)0)
# 65 "../elf/dl-sysdep.c"
                                      ;
# 84 "../elf/dl-sysdep.c"
...
_dl_sysdep_start (void **start_argptr,
    void (*dl_main) (const Elf64_Phdr *phdr, Elf64_Word phnum,
       Elf64_Addr *user_entry, Elf64_auxv_t *auxv))
{
  const Elf64_Phdr *phdr = 
# 89 "../elf/dl-sysdep.c" 3 4
                          ((void *)0)
# 89 "../elf/dl-sysdep.c"
                              ;
  Elf64_Word phnum = 0;
  ...
  Elf64_auxv_t *av;
# 112 "../elf/dl-sysdep.c"
  __libc_stack_end = ((void *) (start_argptr));
  do { void **_tmp; (_dl_argc) = *(long int *) start_argptr; (_dl_argv) = (char **) ((long int *) start_argptr + 1); (_environ) = (_dl_argv) + (_dl_argc) + 1; for (_tmp = (void **) (_environ); *_tmp; ++_tmp) continue; (_rtld_local_ro._dl_auxv) = (void *) ++_tmp; } while (0)
                   ;

  user_entry = (Elf64_Addr) _start;
  _rtld_local_ro._dl_platform = 
# 117 "../elf/dl-sysdep.c" 3 4
                     ((void *)0)
# 117 "../elf/dl-sysdep.c"
                         ;

  for (av = _rtld_local_ro._dl_auxv; av->a_type != 0; (av++))
    switch (av->a_type)
      {
      case 3:
 ...
 break;
      case 6:
 _rtld_local_ro._dl_pagesize = av->a_un.a_val;
 break;
      case 9:
...
# 149 "../elf/dl-sysdep.c"
 ...
 break;
      case 15:
 _rtld_local_ro._dl_platform = (void *) av->a_un.a_val;
 break;
      case 16:
 _rtld_local_ro._dl_hwcap = (unsigned long int) av->a_un.a_val;
 break;
      case 26:
 _rtld_local_ro._dl_hwcap2 = (unsigned long int) av->a_un.a_val;
 break;
      case 17:
 _rtld_local_ro._dl_clktck = av->a_un.a_val;
 break;
      case 18:
 _rtld_local_ro._dl_fpu_control = av->a_un.a_val;
 break;
      ...
      case 33:
 _rtld_local_ro._dl_sysinfo_dso = (void *) av->a_un.a_val;
 break;
...
# 224 "../elf/dl-sysdep.c"
  ...
  if (_rtld_local_ro._dl_platform != 
# 235 "../elf/dl-sysdep.c" 3 4
                          ((void *)0)
# 235 "../elf/dl-sysdep.c"
                              )
    _rtld_local_ro._dl_platformlen = strlen (_rtld_local_ro._dl_platform);
  ...
  if (__sbrk (0) == _end)
    ...
    __sbrk (_rtld_local_ro._dl_pagesize
     - ((_end - (char *) 0) & (_rtld_local_ro._dl_pagesize - 1)));
  ...
  (*dl_main) (phdr, phnum, &user_entry, _rtld_local_ro._dl_auxv);
  return user_entry;
}
...
_dl_show_auxv (void)
{
      ...
      } auxvars[] =
 {
   ...
   [17 - 2] = { "CLKTCK:       ", dec },
   [18 - 2] = { "FPUCW:        ", hex },
   [19 - 2] = { "DCACHEBSIZE:  0x", hex },
   [20 - 2] = { "ICACHEBSIZE:  0x", hex },
   [21 - 2] = { "UCACHEBSIZE:  0x", hex },
   [22 - 2] = { "IGNOREPPC", ignore },
   [23 - 2] = { "SECURE:       ", dec },
   [24 - 2] = { "BASE_PLATFORM:", str },
   [32 - 2] = { "SYSINFO:      0x", hex },
   [33 - 2] = { "SYSINFO_EHDR: 0x", hex },
   [25 - 2] = { "RANDOM:       0x", hex },
   [26 - 2] = { "HWCAP2:       0x", hex },
 };
 ...
 continue;
      ...
      ((void) sizeof ((0 == 0) ? 1 : 0), __extension__ ({ if (0 == 0) ; else __assert_fail ("AT_NULL == 0", "../elf/dl-sysdep.c", 320, __extension__ __PRETTY_FUNCTION__); }));
      ((void) sizeof ((1 == 1) ? 1 : 0), __extension__ ({ if (1 == 1) ; else __assert_fail ("AT_IGNORE == 1", "../elf/dl-sysdep.c", 321, __extension__ __PRETTY_FUNCTION__); }));

      if (av->a_type == 16 || av->a_type == 26)
 {
   ...
   && auxvars[idx].form != unknown)
 {
   ...
   if (__builtin_expect (auxvars[idx].form, dec) == dec)
     val = _itoa_word ((unsigned long int) av->a_un.a_val, buf + sizeof buf - 1, 10, 0)
                                ;
   else if (__builtin_expect (auxvars[idx].form, hex) == hex)
     val = _itoa_word ((unsigned long int) av->a_un.a_val, buf + sizeof buf - 1, 16, 0)
                                ;

   _dl_dprintf (1, "AT_%s%s\n", auxvars[idx].label, val);
   ...
   continue;
      ...
      const char *val2 = _itoa_word ((unsigned long int) av->a_un.a_val, buf2 + sizeof buf2 - 1, 16, 0)
                                  ;
      const char *val = _itoa_word ((unsigned long int) av->a_type, buf + sizeof buf - 1, 16, 0)
                                ;
      _dl_dprintf (1, "AT_??? (0x%s): 0x%s\n", val, val2);
    }
}
# 40 "../sysdeps/unix/sysv/linux/dl-sysdep.c" 2
...
# 48 "../sysdeps/unix/sysv/linux/dl-sysdep.c" 3 4
                             ((void *)0)
# 48 "../sysdeps/unix/sysv/linux/dl-sysdep.c"
                                 )
    {
 ...
 Elf64_Nhdr hdr;
 char vendor[8];
      } expected_note = { { sizeof "Linux", sizeof (Elf64_Word), 0 }, "Linux" };
 ...
 if (phdr[i].p_type == 4)
   {
     ...
     const Elf64_Nhdr *note = (const void *) start;
     while ((Elf64_Addr) (note + 1) - start < phdr[i].p_memsz)
       {
  if (!memcmp (note, &expected_note, sizeof expected_note))
    return *(const Elf64_Word *) ((const void *) note
      + sizeof expected_note);

  note = ((const void *) (note + 1)
   + (((note->n_namesz) + sizeof note->n_type - 1) & -sizeof note->n_type) + (((note->n_descsz) + sizeof note->n_type - 1) & -sizeof note->n_type));
  ...
  if (__uname (&uts))
    {
      ...
      int fd = __open64_nocancel ("/proc/sys/kernel/osrelease", 00);
      if (fd < 0)
 return -1;
 ...
 return -1;
      buf[(((reslen)<((ssize_t) sizeof (bufmem) - 1))?(reslen):((ssize_t) sizeof (bufmem) - 1))] = '\0';
    }
  else
    buf = uts.release;
