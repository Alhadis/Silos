...
#line 41 "..\\..\\..\\..\\..\\..\\components\\libraries\\timer\\app_timer.c"
...
#line 43 "..\\..\\..\\..\\..\\..\\components\\libraries\\timer\\app_timer.c"
...
#line 44 "..\\..\\..\\..\\..\\..\\components\\libraries\\timer\\app_timer.c"
#line 45 "..\\..\\..\\..\\..\\..\\components\\libraries\\timer\\app_timer.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\softdevice\\s130\\headers\\nrf_soc.h"
...
#line 46 "..\\..\\..\\..\\..\\..\\components\\libraries\\timer\\app_timer.c"
#line 47 "..\\..\\..\\..\\..\\..\\components\\libraries\\timer\\app_timer.c"
...
#line 44 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\delay\\nrf_delay.h"
...
loop:
    ...
    BEQ cond
    NOP
#line 146 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\delay\\nrf_delay.h"
cond:
    SUBS number_of_us, #1
    BNE loop
    }
...
#line 252 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\delay\\nrf_delay.h"
...
#line 48 "..\\..\\..\\..\\..\\..\\components\\libraries\\timer\\app_timer.c"
...
#line 49 "..\\..\\..\\..\\..\\..\\components\\libraries\\timer\\app_timer.c"
...
;enum { static_assert_56 = 1 / (! !((APP_IRQ_PRIORITY_LOWEST == APP_IRQ_PRIORITY_LOWEST))) };
...
;enum { static_assert_83 = 1 / (! !((sizeof(timer_node_t) == 32))) };
...
;enum { static_assert_114 = 1 / (! !((sizeof(timer_user_op_t) <= 24))) };
;enum { static_assert_115 = 1 / (! !((sizeof(timer_user_op_t) % 4 == 0))) };
...
;enum { static_assert_130 = 1 / (! !((sizeof(timer_op_queue_t) % 4 == 0))) };
...
static void rtc1_init(uint32_t prescaler)
{
    ...
    NVIC_SetPriority(RTC1_IRQn, APP_IRQ_PRIORITY_LOWEST);
}
...
#line 741 "..\\..\\..\\..\\..\\..\\components\\libraries\\timer\\app_timer.c"
                        ...
                        app_timer_evt_schedule_func_t evt_schedule_func)
{
    ...
    NVIC_SetPriority(SWI0_IRQn, APP_IRQ_PRIORITY_LOWEST);
