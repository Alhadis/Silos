# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c"
# 19 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c"
...
# 20 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c" 2
...
uloc_toLanguageTag_48(const char* localeID,
                   ...
                   UBool strict,
                   UErrorCode* err);
# 21 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c" 2
...
u_strFromJavaModifiedUTF8WithSub_48(
        ...
        UChar32 subchar, int32_t *pNumSubstitutions,
        UErrorCode *pErrorCode);
# 22 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h" 1
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h"
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ustring.h" 1
# 24 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h" 2
# 44 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h"
struct UCaseMap;
typedef struct UCaseMap UCaseMap;
# 69 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h"
extern UCaseMap *
ucasemap_open_48(const char *locale, uint32_t options, UErrorCode *pErrorCode);
...
# 105 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h"
extern const char *
ucasemap_getLocale_48(const UCaseMap *csm);
...
extern uint32_t
ucasemap_getOptions_48(const UCaseMap *csm);
# 128 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h"
extern void
ucasemap_setLocale_48(UCaseMap *csm, const char *locale, UErrorCode *pErrorCode);
# 142 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h"
extern void
ucasemap_setOptions_48(UCaseMap *csm, uint32_t options, UErrorCode *pErrorCode);
# 195 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h"
extern const UBreakIterator *
ucasemap_getBreakIterator_48(const UCaseMap *csm);
# 218 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h"
extern void
ucasemap_setBreakIterator_48(UCaseMap *csm, UBreakIterator *iterToAdopt, UErrorCode *pErrorCode);
# 267 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h"
extern int32_t
ucasemap_toTitle_48(UCaseMap *csm,
                 UChar *dest, int32_t destCapacity,
                 const UChar *src, int32_t srcLength,
                 UErrorCode *pErrorCode);
# 298 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h"
extern int32_t
ucasemap_utf8ToLower_48(const UCaseMap *csm,
                     char *dest, int32_t destCapacity,
                     const char *src, int32_t srcLength,
                     UErrorCode *pErrorCode);
# 327 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h"
extern int32_t
ucasemap_utf8ToUpper_48(const UCaseMap *csm,
                     char *dest, int32_t destCapacity,
                     const char *src, int32_t srcLength,
                     UErrorCode *pErrorCode);
# 379 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h"
extern int32_t
ucasemap_utf8ToTitle_48(UCaseMap *csm,
                    char *dest, int32_t destCapacity,
                    const char *src, int32_t srcLength,
                    UErrorCode *pErrorCode);
# 415 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucasemap.h"
extern int32_t
ucasemap_utf8FoldCase_48(const UCaseMap *csm,
                      char *dest, int32_t destCapacity,
                      const char *src, int32_t srcLength,
                      UErrorCode *pErrorCode);
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c" 2

# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ubrk.h" 1
# 12 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ubrk.h"
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/uloc.h" 1
# 13 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ubrk.h" 2
...
# 31 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ubrk.h"
...
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/utext.h" 1
# 26 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c" 2
...
# 28 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c" 2
...
# 29 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c" 2
...
# 30 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c" 2
...
# 31 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c" 2
...
ucasemap_open_48(const char *locale, uint32_t options, UErrorCode *pErrorCode) {
    ...
    csm=(UCaseMap *)uprv_malloc_48(sizeof(UCaseMap));
    if(csm==((void *)0)) {
        return ((void *)0);
    }
    memset(csm, 0, sizeof(UCaseMap));

    csm->csp=ucase_getSingleton_48();
    ucasemap_setLocale_48(csm, locale, pErrorCode);
    if(((*pErrorCode)>U_ZERO_ERROR)) {
        uprv_free_48(csm);
        return ((void *)0);
    }
...
ucasemap_setLocale_48(UCaseMap *csm, const char *locale, UErrorCode *pErrorCode) {
    ...
    length=uloc_getName_48(locale, csm->locale, (int32_t)sizeof(csm->locale), pErrorCode);
    if(*pErrorCode==U_BUFFER_OVERFLOW_ERROR || length==sizeof(csm->locale)) {
        *pErrorCode=U_ZERO_ERROR;

        length=uloc_getLanguage_48(locale, csm->locale, (int32_t)sizeof(csm->locale), pErrorCode);
    }
    ...
    csm->locCache=0;
    if(((*pErrorCode)<=U_ZERO_ERROR)) {
        ucase_getCaseLocale_48(csm->locale, &csm->locCache);
    } else {
        csm->locale[0]=0;
    }
}
...
# 129 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c"
...
appendResult(uint8_t *dest, int32_t destIndex, int32_t destCapacity,
    ...
    if(destIndex<destCapacity) {
        ...
        if(length<0) {
            ...
            UBool isError=0;
            { if((uint32_t)(c)<=0x7f) { (dest)[(destIndex)++]=(uint8_t)(c); } else if((uint32_t)(c)<=0x7ff && (destIndex)+1<(destCapacity)) { (dest)[(destIndex)++]=(uint8_t)(((c)>>6)|0xc0); (dest)[(destIndex)++]=(uint8_t)(((c)&0x3f)|0x80); } else if((uint32_t)(c)<=0xd7ff && (destIndex)+2<(destCapacity)) { (dest)[(destIndex)++]=(uint8_t)(((c)>>12)|0xe0); (dest)[(destIndex)++]=(uint8_t)((((c)>>6)&0x3f)|0x80); (dest)[(destIndex)++]=(uint8_t)(((c)&0x3f)|0x80); } else { (destIndex)=utf8_appendCharSafeBody_48(dest, (int32_t)(destIndex), (int32_t)(destCapacity), c, &(isError)); } };
            if(isError) {

                destIndex+=((uint32_t)(c)<=0x7f ? 1 : ((uint32_t)(c)<=0x7ff ? 2 : ((uint32_t)(c)<=0xd7ff ? 3 : ((uint32_t)(c)<=0xdfff || (uint32_t)(c)>0x10ffff ? 0 : ((uint32_t)(c)<=0xffff ? 3 : 4) ) ) ) );
            }
        } else {
...
utf8_caseContextIterator(void *context, int8_t dir) {
    ...
    if(dir<0) {
        if(csc->start<csc->index) {
            { (c)=(uint8_t)((const uint8_t *)csc->p)[--(csc->index)]; if((c)>=0x80) { if((c)<=0xbf) { (c)=utf8_prevCharSafeBody_48((const uint8_t *)(const uint8_t *)csc->p, csc->start, &(csc->index), c, -1); } else { (c)=(-1); } } };
            return c;
        }
    } else {
        if(csc->index<csc->limit) {
            { (c)=(uint8_t)((const uint8_t *)csc->p)[(csc->index)++]; if((c)>=0x80) { uint8_t __t1, __t2; if( (0xe0<(c) && (c)<=0xec) && (((csc->index)+1)<(csc->limit)) && (__t1=(uint8_t)(((const uint8_t *)csc->p)[csc->index]-0x80))<=0x3f && (__t2=(uint8_t)(((const uint8_t *)csc->p)[(csc->index)+1]-0x80))<= 0x3f ) { (c)=(UChar)(((c)<<12)|(__t1<<6)|__t2); (csc->index)+=2; } else if( ((c)<0xe0 && (c)>=0xc2) && ((csc->index)<(csc->limit)) && (__t1=(uint8_t)(((const uint8_t *)csc->p)[csc->index]-0x80))<=0x3f ) { (c)=(UChar)((((c)&0x1f)<<6)|__t1); ++(csc->index); } else if(((uint8_t)((c)-0xc0)<0x3e)) { (c)=utf8_nextCharSafeBody_48((const uint8_t *)(const uint8_t *)csc->p, &(csc->index), (int32_t)(csc->limit), c, -1); } else { (c)=(-1); } } };
            return c;
        }
    }
    return (-1);
...
_caseMap(const UCaseMap *csm, UCaseMapFull *map,
    ...
    while(srcIndex<srcLimit) {
        ...
        { (c)=(uint8_t)(src)[(srcIndex)++]; if((c)>=0x80) { uint8_t __t1, __t2; if( (0xe0<(c) && (c)<=0xec) && (((srcIndex)+1)<(srcLimit)) && (__t1=(uint8_t)((src)[srcIndex]-0x80))<=0x3f && (__t2=(uint8_t)((src)[(srcIndex)+1]-0x80))<= 0x3f ) { (c)=(UChar)(((c)<<12)|(__t1<<6)|__t2); (srcIndex)+=2; } else if( ((c)<0xe0 && (c)>=0xc2) && ((srcIndex)<(srcLimit)) && (__t1=(uint8_t)((src)[srcIndex]-0x80))<=0x3f ) { (c)=(UChar)((((c)&0x1f)<<6)|__t1); ++(srcIndex); } else if(((uint8_t)((c)-0xc0)<0x3e)) { (c)=utf8_nextCharSafeBody_48((const uint8_t *)src, &(srcIndex), (int32_t)(srcLimit), c, -1); } else { (c)=(-1); } } };
...
_toTitle(UCaseMap *csm,
         ...
         int32_t srcLength,
         UErrorCode *pErrorCode) {
    UText utext={ UTEXT_MAGIC, 0, 0, sizeof(UText), 0, 0, 0, 0, 0, 0, ((void *)0), ((void *)0), ((void *)0), ((void *)0), ((void *)0), ((void *)0), ((void *)0), ((void *)0), 0, 0, 0, 0, 0, 0 };
    const UChar *s;
    UChar32 c;
    int32_t prev, titleStart, titleLimit, idx, destIndex, length;
    UBool isFirstIndex;

    utext_openUTF8_48(&utext, (const char *)src, srcLength, pErrorCode);
    if(((*pErrorCode)>U_ZERO_ERROR)) {
        return 0;
    }
    if(csm->iter==((void *)0)) {
        csm->iter=ubrk_open_48(UBRK_WORD, csm->locale,
                            ((void *)0), 0,
                            pErrorCode);
    }
    ubrk_setUText_48(csm->iter, &utext, pErrorCode);
    if(((*pErrorCode)>U_ZERO_ERROR)) {
        utext_close_48(&utext);
        return 0;
    }
    ...
    while(prev<srcLength) {
        ...
        if(isFirstIndex) {
            isFirstIndex=0;
            idx=ubrk_first_48(csm->iter);
        } else {
            idx=ubrk_next_48(csm->iter);
        }
        if(idx==((int32_t) -1) || idx>srcLength) {
            idx=srcLength;
        }
# 326 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c"
        if(prev<idx) {

            titleStart=titleLimit=prev;
            { (c)=(uint8_t)(src)[(titleLimit)++]; if((c)>=0x80) { uint8_t __t1, __t2; if( (0xe0<(c) && (c)<=0xec) && (((titleLimit)+1)<(idx)) && (__t1=(uint8_t)((src)[titleLimit]-0x80))<=0x3f && (__t2=(uint8_t)((src)[(titleLimit)+1]-0x80))<= 0x3f ) { (c)=(UChar)(((c)<<12)|(__t1<<6)|__t2); (titleLimit)+=2; } else if( ((c)<0xe0 && (c)>=0xc2) && ((titleLimit)<(idx)) && (__t1=(uint8_t)((src)[titleLimit]-0x80))<=0x3f ) { (c)=(UChar)((((c)&0x1f)<<6)|__t1); ++(titleLimit); } else if(((uint8_t)((c)-0xc0)<0x3e)) { (c)=utf8_nextCharSafeBody_48((const uint8_t *)src, &(titleLimit), (int32_t)(idx), c, -1); } else { (c)=(-1); } } };
            if((csm->options&0x200)==0 && UCASE_NONE==ucase_getType_48(csm->csp, c)) {
                ...
                for(;;) {
                    ...
                    { (c)=(uint8_t)(src)[(titleLimit)++]; if((c)>=0x80) { uint8_t __t1, __t2; if( (0xe0<(c) && (c)<=0xec) && (((titleLimit)+1)<(idx)) && (__t1=(uint8_t)((src)[titleLimit]-0x80))<=0x3f && (__t2=(uint8_t)((src)[(titleLimit)+1]-0x80))<= 0x3f ) { (c)=(UChar)(((c)<<12)|(__t1<<6)|__t2); (titleLimit)+=2; } else if( ((c)<0xe0 && (c)>=0xc2) && ((titleLimit)<(idx)) && (__t1=(uint8_t)((src)[titleLimit]-0x80))<=0x3f ) { (c)=(UChar)((((c)&0x1f)<<6)|__t1); ++(titleLimit); } else if(((uint8_t)((c)-0xc0)<0x3e)) { (c)=utf8_nextCharSafeBody_48((const uint8_t *)src, &(titleLimit), (int32_t)(idx), c, -1); } else { (c)=(-1); } } };
                    if(UCASE_NONE!=ucase_getType_48(csm->csp, c)) {
                        break;
                    }
                }
                ...
                if(length>0) {
                    if((destIndex+length)<=destCapacity) {
                        memcpy(dest+destIndex, src+prev, length);
                    }
                    destIndex+=length;
                }
            }
            ...
            if(titleStart<titleLimit) {
                ...
                c=ucase_toFullTitle_48(csm->csp, c, utf8_caseContextIterator, csc, &s, csm->locale, &csm->locCache);
                destIndex=appendResult(dest, destIndex, destCapacity, c, s);



                if ( titleStart+1 < idx &&
                     ucase_getCaseLocale_48(csm->locale,&csm->locCache) == UCASE_LOC_DUTCH &&
                ...
                if(titleLimit<idx) {
                    if((csm->options&0x100)==0) {

                        destIndex+=
                            _caseMap(
                                csm, ucase_toFullLower_48,
                        ...
                        if((destIndex+length)<=destCapacity) {
                            memcpy(dest+destIndex, src+titleLimit, length);
                        }
                        destIndex+=length;
                    }
                }
...
utf8_foldCase(const UCaseProps *csp,
    ...
    while(srcIndex<srcLength) {
        start=srcIndex;
        { (c)=(uint8_t)(src)[(srcIndex)++]; if((c)>=0x80) { uint8_t __t1, __t2; if( (0xe0<(c) && (c)<=0xec) && (((srcIndex)+1)<(srcLength)) && (__t1=(uint8_t)((src)[srcIndex]-0x80))<=0x3f && (__t2=(uint8_t)((src)[(srcIndex)+1]-0x80))<= 0x3f ) { (c)=(UChar)(((c)<<12)|(__t1<<6)|__t2); (srcIndex)+=2; } else if( ((c)<0xe0 && (c)>=0xc2) && ((srcIndex)<(srcLength)) && (__t1=(uint8_t)((src)[srcIndex]-0x80))<=0x3f ) { (c)=(UChar)((((c)&0x1f)<<6)|__t1); ++(srcIndex); } else if(((uint8_t)((c)-0xc0)<0x3e)) { (c)=utf8_nextCharSafeBody_48((const uint8_t *)src, &(srcIndex), (int32_t)(srcLength), c, -1); } else { (c)=(-1); } } };
        if(c<0) {
        ...
        c=ucase_toFullFolding_48(csp, c, &s, options);
        if((destIndex<destCapacity) && (c<0 ? (c2=~c)<=0x7f : UCASE_MAX_STRING_LENGTH<c && (c2=c)<=0x7f)) {
...
# 452 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucasemap.c"
static int32_t
caseMap(const UCaseMap *csm,
    ...
    if(toWhichCase==FOLD_CASE) {
        ...
        UCaseContext csc={ ((void *)0) };

        csc.p=(void *)src;
        csc.limit=srcLength;

        if(toWhichCase==TO_LOWER) {
            destLength=_caseMap(csm, ucase_toFullLower_48,
                                dest, destCapacity,
                                src, &csc,
                                0, srcLength,
                                pErrorCode);
        } else if(toWhichCase==TO_UPPER) {
            destLength=_caseMap(csm, ucase_toFullUpper_48,
                                dest, destCapacity,
                                src, &csc,
                                0, srcLength,
                                pErrorCode);
    ...
    return u_terminateChars_48((char *)dest, destCapacity, destLength, pErrorCode);
}
