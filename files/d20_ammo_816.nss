/*
    ...
    2d12 electrical to target and 2d6 to all creatures in 3.5m of target. Unattended objects also take damage.
    Reflex save DC = 20
*/
...
void main()
{
    ...
    int nDamage;
    float fDelay;
    effect eExplode = EffectVisualEffect(VFX_IMP_LIGHTNING_M);
