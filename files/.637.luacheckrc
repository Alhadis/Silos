...
exclude_files = {
    ...
    '**/rojo/lua-utils',
    '**/rojo/tea',
    "**/plugin/spec-studio/userCodeFixtures/scriptWithParseError.lua"
}
...
local rbx_string_fields = {"split"}

for key in pairs(string) do
    table.insert(rbx_string_fields, key)
end
...
stds.roblox = {
    ...
    read_globals = {
        ...
        UserSettings = def_fields({"UserGameSettings"}),
        ...
        string = def_fields(rbx_string_fields),
