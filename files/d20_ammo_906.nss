/*
    T61 incendiary rocket shell

    3d6 fire to target and 2d6 to all creatures in 3.5m of target. Unattended objects also take damage.
    Relex save DC = 20
*/
...
void main()
{
    ...
    {
        //Calculate damage based on 3d6 or 2d6 and adjust for Reflex Save, Evasion and Improved Evasion.
        if (oTarget==oShotTarget) {nDamage = d6(3);}
        else {nDamage = d6(2);}
