...
void ParseEmote(string sEmote, object oPC)
{
    ...
    AssignCommand(oPC, PlayAnimation( ANIMATION_LOOPING_CUSTOM9, 1.0, 12.0));
    ...
    {
        AssignCommand(oPC, PlayAnimation(ANIMATION_LOOPING_CUSTOM7, 1.0, 12.0));
//        SmokePipe(oPC);
    }
    else if (FindSubString(GetStringLowerCase(sEmote), "crouches")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "crouches*")!= -1)
    {
         AssignCommand(oPC, PlayAnimation(ANIMATION_LOOPING_CUSTOM2, 1.0, 12.0));
    }
    else if (FindSubString(GetStringLowerCase(sEmote), "crosses arms")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "crosses arms*")!= -1)
    {
         AssignCommand(oPC, PlayAnimation(ANIMATION_LOOPING_CUSTOM4, 1.0, 12.0));
    }
    ...
    {
        AssignCommand(oPC, PlayAnimation( ANIMATION_LOOPING_CUSTOM1, 1.0, 12.0));
    }
    else if (FindSubString(GetStringLowerCase(sEmote), "hooray")!= -1)
    {
        PlayVoiceChat(VOICE_CHAT_CHEER, oPC);
