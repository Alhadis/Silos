# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvdisp.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvdisp.c"
# 21 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvdisp.c"
...
# 22 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvdisp.c" 2
...
u_strFromJavaModifiedUTF8WithSub_48(
        ...
        UChar32 subchar, int32_t *pNumSubstitutions,
        UErrorCode *pErrorCode);
# 26 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvdisp.c" 2
...
# 27 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvdisp.c" 2
...
# 28 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvdisp.c" 2
...
# 29 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvdisp.c" 2
...
# 30 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvdisp.c" 2
...
# 31 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvdisp.c" 2
...
# 32 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvdisp.c" 2

extern int32_t
ucnv_getDisplayName_48(const UConverter *cnv,
                    const char *displayLocale,
    ...
    if(cnv==((void *)0) || displayNameCapacity<0 || (displayNameCapacity>0 && displayName==((void *)0))) {
        *pErrorCode=U_ILLEGAL_ARGUMENT_ERROR;
        return 0;
    }


    rb=ures_open_48(((void *)0), displayLocale, pErrorCode);
    if(((*pErrorCode)>U_ZERO_ERROR)) {
        return 0;
    }


    name=ures_getStringByKey_48(rb, cnv->sharedData->staticData->name, &length, &localStatus);
    ures_close_48(rb);
    ...
    if(((localStatus)<=U_ZERO_ERROR)) {
        ...
        u_memcpy_48(displayName, name, uprv_min_48(length, displayNameCapacity)*2);
    } else {

        length=(int32_t) strlen(cnv->sharedData->staticData->name);
        u_charsToUChars_48(cnv->sharedData->staticData->name, displayName, uprv_min_48(length, displayNameCapacity));
    }
    return u_terminateUChars_48(displayName, displayNameCapacity, length, pErrorCode);
}
