...
void SetItemLocals()
{
SetLocalString(OBJECT_SELF, "lsn1", "bladiumplatemail");
SetLocalInt(OBJECT_SELF, "lsc_bladiumplatemail", 6);
SetLocalString(OBJECT_SELF, "lsi1_bladiumplatemail", "blackdiamond");
SetLocalString(OBJECT_SELF, "lsi2_bladiumplatemail", "blackdiamond");
 SetLocalString(OBJECT_SELF, "lsi3_bladiumplatemail", "adamantiumingot");
SetLocalString(OBJECT_SELF, "lsi4_bladiumplatemail", "adamantiumingot");
SetLocalString(OBJECT_SELF, "lsi5_bladiumplatemail", "goldbrick");
SetLocalString(OBJECT_SELF, "lsi6_bladiumplatemail", "  gold  200000");
SetLocalInt(OBJECT_SELF, "lss_bladiumplatemail", -10);
SetLocalInt(OBJECT_SELF, "lsv_bladiumplatemail", VFX_IMP_SUNSTRIKE);
