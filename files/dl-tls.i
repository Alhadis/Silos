...
# 1 "<command-line>" 2
# 1 "../sysdeps/x86_64/dl-tls.c"
# 24 "../sysdeps/x86_64/dl-tls.c"
# 1 "../sysdeps/x86_64/dl-tls.h" 1
# 22 "../sysdeps/x86_64/dl-tls.h"
...
oom (void)
{
  do { _dl_dprintf (2, "cannot allocate memory for thread-local data: ABORT\n"); _exit (127); } while (1);
}
...
_dl_next_tls_modid (void)
{
  ...
  if (__builtin_expect (_rtld_local._dl_tls_dtv_gaps, 
# 51 "../elf/dl-tls.c" 3 4
                                            0
# 51 "../elf/dl-tls.c"
                                                 ))
    {
      size_t disp = 0;
      struct dtv_slotinfo_list *runp = _rtld_local._dl_tls_dtv_slotinfo_list;
# 63 "../elf/dl-tls.c"
      result = _rtld_local._dl_tls_static_nelem + 1;
      if (result <= _rtld_local._dl_tls_max_dtv_idx)
 do
   {
...
# 69 "../elf/dl-tls.c"
  ...
  ++result;
  ((void) sizeof ((result <= _rtld_local._dl_tls_max_dtv_idx + 1) ? 1 : 0), __extension__ ({ if (result <= _rtld_local._dl_tls_max_dtv_idx + 1) ; else __assert_fail ("result <= GL(dl_tls_max_dtv_idx) + 1", "../elf/dl-tls.c", 73, __extension__ __PRETTY_FUNCTION__); }));
       }
...
# 81 "../elf/dl-tls.c"
      ...
      if (result > _rtld_local._dl_tls_max_dtv_idx)
 {
   ...
   ((void) sizeof ((result == _rtld_local._dl_tls_max_dtv_idx + 1) ? 1 : 0), __extension__ ({ if (result == _rtld_local._dl_tls_max_dtv_idx + 1) ; else __assert_fail ("result == GL(dl_tls_max_dtv_idx) + 1", "../elf/dl-tls.c", 87, __extension__ __PRETTY_FUNCTION__); }));
...
# 89 "../elf/dl-tls.c"
   ...
   goto nogaps;
    ...
    nogaps:
      ...
      result = ++_rtld_local._dl_tls_max_dtv_idx;
    }
...
_dl_count_modids (void)
{
  ...
  if (__builtin_expect ((!_rtld_local._dl_tls_dtv_gaps), 1))
    return _rtld_local._dl_tls_max_dtv_idx;


  size_t n = 0;
  struct dtv_slotinfo_list *runp = _rtld_local._dl_tls_dtv_slotinfo_list;
  while (runp != 
# 119 "../elf/dl-tls.c" 3 4
                ((void *)0)
# 119 "../elf/dl-tls.c"
                    )
    {
...
_dl_determine_tlsoffset (void)
{
  ...
  ((void) sizeof ((_rtld_local._dl_tls_dtv_slotinfo_list != 
# 141 "../elf/dl-tls.c" 3 4
 ((void *)0)
# 141 "../elf/dl-tls.c"
 ) ? 1 : 0), __extension__ ({ if (_rtld_local._dl_tls_dtv_slotinfo_list != 
# 141 "../elf/dl-tls.c" 3 4
 ((void *)0)
# 141 "../elf/dl-tls.c"
 ) ; else __assert_fail ("GL(dl_tls_dtv_slotinfo_list) != NULL", "../elf/dl-tls.c", 141, __extension__ __PRETTY_FUNCTION__); }));


  ((void) sizeof ((_rtld_local._dl_tls_dtv_slotinfo_list->next == 
# 144 "../elf/dl-tls.c" 3 4
 ((void *)0)
# 144 "../elf/dl-tls.c"
 ) ? 1 : 0), __extension__ ({ if (_rtld_local._dl_tls_dtv_slotinfo_list->next == 
# 144 "../elf/dl-tls.c" 3 4
 ((void *)0)
# 144 "../elf/dl-tls.c"
 ) ; else __assert_fail ("GL(dl_tls_dtv_slotinfo_list)->next == NULL", "../elf/dl-tls.c", 144, __extension__ __PRETTY_FUNCTION__); }));
...
# 180 "../elf/dl-tls.c" 3 4
                                           ((void *)0)
# 180 "../elf/dl-tls.c"
                                               ; ++cnt)
    {
      ((void) sizeof ((cnt < _rtld_local._dl_tls_dtv_slotinfo_list->len) ? 1 : 0), __extension__ ({ if (cnt < _rtld_local._dl_tls_dtv_slotinfo_list->len) ; else __assert_fail ("cnt < GL(dl_tls_dtv_slotinfo_list)->len", "../elf/dl-tls.c", 182, __extension__ __PRETTY_FUNCTION__); }));
  ...
  + (freebottom - freetop))
 {
  ...
  _rtld_local._dl_tls_static_used = offset;
  _rtld_local._dl_tls_static_size = ((__builtin_constant_p (max_align) && ((((max_align) - 1) & (max_align)) == 0) ? (((offset + 64 + 16 * 100) + (max_align) - 1) & ~((max_align) - 1)) : ((((offset + 64 + 16 * 100) + ((max_align) - 1)) / (max_align)) * (max_align)))
       + sizeof (struct pthread));
# 272 "../elf/dl-tls.c"
  _rtld_local._dl_tls_static_align = max_align;
}
...
allocate_dtv (void *result)
{
  ...
  dtv_length = _rtld_local._dl_tls_max_dtv_idx + (14);
  dtv = calloc (dtv_length + 2, sizeof (dtv_t));
  if (dtv != 
# 287 "../elf/dl-tls.c" 3 4
            ((void *)0)
# 287 "../elf/dl-tls.c"
                )
    {
...
{
  *sizep = _rtld_local._dl_tls_static_size;
  *alignp = _rtld_local._dl_tls_static_align;
}
...
{
  void *result;
  size_t size = _rtld_local._dl_tls_static_size;
# 345 "../elf/dl-tls.c"
  size_t alignment = _rtld_local._dl_tls_static_align;
  void *allocated = malloc (size + alignment + sizeof (void *));
  if (__builtin_expect ((allocated == 
# 347 "../elf/dl-tls.c" 3 4
     ((void *)0)
# 347 "../elf/dl-tls.c"
     ), 0))
    return 
# 348 "../elf/dl-tls.c" 3 4
          ((void *)0)
# 348 "../elf/dl-tls.c"
              ;
...
_dl_resize_dtv (dtv_t *dtv)
{
  ...
  size_t newsize
    = ({ if ((sizeof (*(&_rtld_local._dl_tls_max_dtv_idx)) != 1) && (sizeof (*(&_rtld_local._dl_tls_max_dtv_idx)) != 2) && (sizeof (*(&_rtld_local._dl_tls_max_dtv_idx)) != 4) && (sizeof (*(&_rtld_local._dl_tls_max_dtv_idx)) != 8)) __atomic_link_error ();; __atomic_load_n ((&_rtld_local._dl_tls_max_dtv_idx), 2); }) + (14);
  size_t oldsize = dtv[-1].counter;

  if (dtv == _rtld_local._dl_initial_dtv)
    {
...
{
  if (result == 
# 438 "../elf/dl-tls.c" 3 4
               ((void *)0)
# 438 "../elf/dl-tls.c"
                   )

    return 
# 440 "../elf/dl-tls.c" 3 4
          ((void *)0)
# 440 "../elf/dl-tls.c"
              ;
  ...
  if (dtv[-1].counter < _rtld_local._dl_tls_max_dtv_idx)
    {
  ...
  listp = _rtld_local._dl_tls_dtv_slotinfo_list;
  while (1)
    {
      size_t cnt;
      ...
      for (cnt = total == 0 ? 1 : 0; cnt < listp->len; ++cnt)
 {
   ...
   if (total + cnt > _rtld_local._dl_tls_max_dtv_idx)
     break;

   map = listp->slotinfo[cnt].map;
   if (map == 
# 475 "../elf/dl-tls.c" 3 4
             ((void *)0)
# 475 "../elf/dl-tls.c"
                 )
   ...
   ((void) sizeof ((listp->slotinfo[cnt].gen <= _rtld_local._dl_tls_generation) ? 1 : 0), __extension__ ({ if (listp->slotinfo[cnt].gen <= _rtld_local._dl_tls_generation) ; else __assert_fail ("listp->slotinfo[cnt].gen <= GL(dl_tls_generation)", "../elf/dl-tls.c", 481, __extension__ __PRETTY_FUNCTION__); }));
...
# 485 "../elf/dl-tls.c"
   ...
   ((void) sizeof ((map->l_tls_modid == total + cnt) ? 1 : 0), __extension__ ({ if (map->l_tls_modid == total + cnt) ; else __assert_fail ("map->l_tls_modid == total + cnt", "../elf/dl-tls.c", 491, __extension__ __PRETTY_FUNCTION__); }));
   ((void) sizeof ((map->l_tls_blocksize >= map->l_tls_initimage_size) ? 1 : 0), __extension__ ({ if (map->l_tls_blocksize >= map->l_tls_initimage_size) ; else __assert_fail ("map->l_tls_blocksize >= map->l_tls_initimage_size", "../elf/dl-tls.c", 492, __extension__ __PRETTY_FUNCTION__); }));

   ((void) sizeof (((size_t) map->l_tls_offset >= map->l_tls_blocksize) ? 1 : 0), __extension__ ({ if ((size_t) map->l_tls_offset >= map->l_tls_blocksize) ; else __assert_fail ("(size_t) map->l_tls_offset >= map->l_tls_blocksize", "../elf/dl-tls.c", 494, __extension__ __PRETTY_FUNCTION__); }));
...
# 504 "../elf/dl-tls.c"
   ...
   memset (__builtin_mempcpy (dest, map->l_tls_initimage, map->l_tls_initimage_size)
    ...
    map->l_tls_blocksize - map->l_tls_initimage_size);
      ...
      total += cnt;
      if (total >= _rtld_local._dl_tls_max_dtv_idx)
 break;

      listp = listp->next;
      ((void) sizeof ((listp != 
# 517 "../elf/dl-tls.c" 3 4
     ((void *)0)
# 517 "../elf/dl-tls.c"
...
# 517 "../elf/dl-tls.c" 3 4
     ((void *)0)
# 517 "../elf/dl-tls.c"
     ) ; else __assert_fail ("listp != NULL", "../elf/dl-tls.c", 517, __extension__ __PRETTY_FUNCTION__); }));
    }
...
extern __typeof (_dl_allocate_tls_init) __EI__dl_allocate_tls_init __asm__("" "_dl_allocate_tls_init"); extern __typeof (_dl_allocate_tls_init) __EI__dl_allocate_tls_init __attribute__((alias ("" "__GI__dl_allocate_tls_init")));

void *
_dl_allocate_tls (void *mem)
{
  return _dl_allocate_tls_init (mem == 
# 530 "../elf/dl-tls.c" 3 4
                                      ((void *)0)
...
extern __typeof (_dl_allocate_tls) __EI__dl_allocate_tls __asm__("" "_dl_allocate_tls"); extern __typeof (_dl_allocate_tls) __EI__dl_allocate_tls __attribute__((alias ("" "__GI__dl_allocate_tls")));


void
_dl_deallocate_tls (void *tcb, 
# 538 "../elf/dl-tls.c" 3 4
                              _Bool 
# 538 "../elf/dl-tls.c"
                                   dealloc_tcb)
{
...
extern __typeof (_dl_deallocate_tls) __EI__dl_deallocate_tls __asm__("" "_dl_deallocate_tls"); extern __typeof (_dl_deallocate_tls) __EI__dl_deallocate_tls __attribute__((alias ("" "__GI__dl_deallocate_tls")));
# 576 "../elf/dl-tls.c"
...
# 624 "../elf/dl-tls.c" 3 4
                            ((void *)0)
# 624 "../elf/dl-tls.c"
                                ;
  dtv_t *dtv = ({ struct pthread *__pd; ({ __typeof (__pd->header.dtv) __value; if (sizeof (__value) == 1) asm volatile ("movb %%fs:%P2,%b0" : "=q" (__value) : "0" (0), "i" (
# 625 "../elf/dl-tls.c" 3 4
              __builtin_offsetof (
# 625 "../elf/dl-tls.c"
              struct pthread
# 625 "../elf/dl-tls.c" 3 4
...
# 642 "../elf/dl-tls.c"
  ...
  struct dtv_slotinfo_list *listp = _rtld_local._dl_tls_dtv_slotinfo_list;
...
# 689 "../elf/dl-tls.c"
    ...
    continue;
       ...
       ((void) sizeof ((total + cnt == modid) ? 1 : 0), __extension__ ({ if (total + cnt == modid) ; else __assert_fail ("total + cnt == modid", "../elf/dl-tls.c", 697, __extension__ __PRETTY_FUNCTION__); }));
       if (dtv[-1].counter < modid)
  {

    dtv = _dl_resize_dtv (dtv);

    ((void) sizeof ((modid <= dtv[-1].counter) ? 1 : 0), __extension__ ({ if (modid <= dtv[-1].counter) ; else __assert_fail ("modid <= dtv[-1].counter", "../elf/dl-tls.c", 703, __extension__ __PRETTY_FUNCTION__); }));



    ({ struct pthread *__pd; ({ if (sizeof (__pd->header.dtv) == 1) asm volatile ("movb %b0,%%fs:%P1" : : "iq" ((dtv)), "i" (
# 707 "../elf/dl-tls.c" 3 4
   __builtin_offsetof (
# 707 "../elf/dl-tls.c"
   struct pthread
# 707 "../elf/dl-tls.c" 3 4
...
# 707 "../elf/dl-tls.c"
   )); else if (sizeof (__pd->header.dtv) == 4) asm volatile ("movl %0,%%fs:%P1" : : "nr" ((dtv)), "i" (
# 707 "../elf/dl-tls.c" 3 4
   __builtin_offsetof (
# 707 "../elf/dl-tls.c"
   struct pthread
...
# 707 "../elf/dl-tls.c"
   )); else { if (sizeof (__pd->header.dtv) != 8) abort (); asm volatile ("movq %q0,%%fs:%P1" : : "nr" ((uint64_t) ((__typeof__ (*(0 ? (__typeof__ (0 ? (__typeof__ ((__typeof__ ((dtv))) 0) *) 0 : (void *) ((__builtin_classify_type ((__typeof__ ((dtv))) 0) == 5)))) 0 : (__typeof__ (0 ? (intptr_t *) 0 : (void *) (!((__builtin_classify_type ((__typeof__ ((dtv))) 0) == 5))))) 0))) ((dtv)))), "i" (
# 707 "../elf/dl-tls.c" 3 4
   __builtin_offsetof (
# 707 "../elf/dl-tls.c"
   struct pthread
...
# 739 "../elf/dl-tls.c"
                                       ...
                                       )
 {
   ...
   void *p = (char *) ({ struct pthread *__self; asm ("mov %%fs:%c1,%0" : "=r" (__self) : "i" (
# 771 "../elf/dl-tls.c" 3 4
                     __builtin_offsetof (
# 771 "../elf/dl-tls.c"
                     struct pthread
# 771 "../elf/dl-tls.c" 3 4
...
# 789 "../elf/dl-tls.c" 3 4
 ((void *)0)
# 789 "../elf/dl-tls.c"
 ) ; else __assert_fail ("result.to_free != NULL", "../elf/dl-tls.c", 789, __extension__ __PRETTY_FUNCTION__); }));
...
# 826 "../elf/dl-tls.c"
  ...
  if (__builtin_expect ((dtv[0].counter != _rtld_local._dl_tls_generation), 0))
...
_dl_tls_get_addr_soft (struct link_map *l)
{
  if (__builtin_expect ((l->l_tls_modid == 0), 0))
    ...
    return 
# 848 "../elf/dl-tls.c" 3 4
          ((void *)0)
# 848 "../elf/dl-tls.c"
              ;

  dtv_t *dtv = ({ struct pthread *__pd; ({ __typeof (__pd->header.dtv) __value; if (sizeof (__value) == 1) asm volatile ("movb %%fs:%P2,%b0" : "=q" (__value) : "0" (0), "i" (
# 850 "../elf/dl-tls.c" 3 4
              __builtin_offsetof (
# 850 "../elf/dl-tls.c"
              struct pthread
# 850 "../elf/dl-tls.c" 3 4
...
# 897 "../elf/dl-tls.c"
 ...
 break;
  ...
  while (listp != 
# 907 "../elf/dl-tls.c" 3 4
                 ((void *)0)
# 907 "../elf/dl-tls.c"
                     );

  if (listp == 
# 909 "../elf/dl-tls.c" 3 4
              ((void *)0)
# 909 "../elf/dl-tls.c"
                  )
    {
      ...
      ((void) sizeof ((idx == 0) ? 1 : 0), __extension__ ({ if (idx == 0) ; else __assert_fail ("idx == 0", "../elf/dl-tls.c", 914, __extension__ __PRETTY_FUNCTION__); }));

      listp = prevp->next = (struct dtv_slotinfo_list *)
 malloc (sizeof (struct dtv_slotinfo_list)
  + (62) * sizeof (struct dtv_slotinfo));
      if (listp == 
# 919 "../elf/dl-tls.c" 3 4
                  ((void *)0)
# 919 "../elf/dl-tls.c"
                      )
 {
...
# 936 "../elf/dl-tls.c"
  ...
  listp->slotinfo[idx].gen = _rtld_local._dl_tls_generation + 1;
}
# 32 "../sysdeps/x86_64/dl-tls.c" 2


extern __typeof (__tls_get_addr) __EI___tls_get_addr __asm__("" "__GI___tls_get_addr"); extern __typeof (__tls_get_addr) __EI___tls_get_addr __attribute__((alias ("" "___tls_get_addr")));
...
{
  dtv_t *dtv = ({ struct pthread *__pd; ({ __typeof (__pd->header.dtv) __value; if (sizeof (__value) == 1) asm volatile ("movb %%fs:%P2,%b0" : "=q" (__value) : "0" (0), "i" (
# 41 "../sysdeps/x86_64/dl-tls.c" 3 4
              __builtin_offsetof (
# 41 "../sysdeps/x86_64/dl-tls.c"
              struct pthread
# 41 "../sysdeps/x86_64/dl-tls.c" 3 4
              , 
# 41 "../sysdeps/x86_64/dl-tls.c"
...
# 41 "../sysdeps/x86_64/dl-tls.c"
  ...
  return tls_get_addr_tail (ti, dtv, 
# 46 "../sysdeps/x86_64/dl-tls.c" 3 4
                                                ((void *)0)
# 46 "../sysdeps/x86_64/dl-tls.c"
                                                    );
}
