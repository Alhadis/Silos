...
FloatingTextStringOnCreature("Fostern", oPC);

effect eEffect;
eEffect = EffectSkillIncrease(SKILL_APPRAISE, 8);

eEffect = ExtraordinaryEffect(eEffect);

ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eEffect, oTarget, 360.0f);

eEffect = EffectSkillIncrease(SKILL_BLUFF, 8);

eEffect = ExtraordinaryEffect(eEffect);

ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eEffect, oTarget, 360.0f);

eEffect = EffectSkillIncrease(SKILL_INTIMIDATE, 8);

eEffect = ExtraordinaryEffect(eEffect);

ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eEffect, oTarget, 360.0f);

eEffect = EffectSkillIncrease(SKILL_PERSUADE, 8);
