...
module Holidays
  DAY_SYMBOLS = ::T.let(nil, ::T.untyped)
  DEFINITIONS_PATH = ::T.let(nil, ::T.untyped)
  FULL_DEFINITIONS_PATH = ::T.let(nil, ::T.untyped)
  MONTH_LENGTHS = ::T.let(nil, ::T.untyped)
  PARENT_REGION_LOOKUP = ::T.let(nil, ::T.untyped)
  REGIONS = ::T.let(nil, ::T.untyped)
  WEEKS = ::T.let(nil, ::T.untyped)
end

module Holidays::CoreExtensions
end
...
module Holidays::CoreExtensions::Date
  ...
  def holiday?(*options); end

  def holidays(*options); end
end
...
module Holidays::DateCalculator::Easter
end
...
class Holidays::DateCalculator::LunarDate
  ...
  def year=(year); end
  CALENDAR_YEAR_INFO_MAP = ::T.let(nil, ::T.untyped)
  KOREAN_LUNAR_YEAR_INFO = ::T.let(nil, ::T.untyped)
  LUNARDAYS_FOR_MONTHTYPE = ::T.let(nil, ::T.untyped)
  MAX_YEAR_NUMBER = ::T.let(nil, ::T.untyped)
  SOLAR_START_DATE = ::T.let(nil, ::T.untyped)
  VIETNAMESE_LUNAR_YEAR_INFO = ::T.let(nil, ::T.untyped)
end
...
module Holidays::Definition::Context
end
...
class Holidays::Definition::Context::FunctionProcessor
  ...
  VALID_ARGUMENTS = ::T.let(nil, ::T.untyped)
end
...
class Holidays::Definition::Context::Merger
  def call(target_regions, target_holidays, target_custom_methods); end

  def initialize(holidays_by_month_repo, regions_repo, custom_methods_repo); end
end
...
module Holidays::Definition::Decorator
end
...
module Holidays::Definition::Entity
end
...
module Holidays::Definition::Generator
end

class Holidays::Definition::Generator::Module
  def call(module_name, files, regions, month_strings, custom_methods); end
end
...
class Holidays::Definition::Generator::Regions
  def call(regions); end
  NORTH_AMERICA_REGIONS = ::T.let(nil, ::T.untyped)
end
...
module Holidays::Definition::Parser
end
...
class Holidays::Definition::Repository::CustomMethods
  def add(new_custom_methods); end

  def find(method_id); end
end
...
module Holidays::Definition::Validator
end
...
class Holidays::DefinitionTestError
end

class Holidays::DefinitionTestError
end

class Holidays::Error
end

class Holidays::Error
end

module Holidays::Factory
end

module Holidays::Factory::DateCalculator
end

module Holidays::Factory::DateCalculator::Easter
end
...
module Holidays::Factory::DateCalculator::Easter::Gregorian
  extend ::T::Sig
  def self.easter_calculator(); end
end
...
module Holidays::Factory::DateCalculator
  extend ::T::Sig
  def self.day_of_month_calculator(); end

  def self.lunar_date(); end

  def self.weekend_modifier(); end
end
...
module Holidays::Factory::Definition
  extend ::T::Sig
  def self.cache_repository(); end

  def self.custom_method_parser(); end

  def self.custom_method_proc_decorator(); end

  def self.custom_method_source_decorator(); end

  def self.custom_method_validator(); end

  def self.custom_methods_repository(); end

  def self.file_parser(); end

  def self.function_processor(); end

  def self.holidays_by_month_repository(); end

  def self.loader(); end

  def self.merger(); end

  def self.module_generator(); end

  def self.proc_result_cache_repository(); end

  def self.region_validator(); end

  def self.regions_generator(); end

  def self.regions_repository(); end

  def self.source_generator(); end

  def self.test_decorator(); end

  def self.test_generator(); end

  def self.test_parser(); end
end
...
module Holidays::Factory::Finder
  extend ::T::Sig
  def self.between(); end

  def self.next_holiday(); end

  def self.parse_options(); end

  def self.search(); end

  def self.year_holiday(); end
end
...
class Holidays::Finder::Rules::InRegion
  def self.call(requested, available); end
end
...
class Holidays::Finder::Rules::YearRange
  def self.call(target_year, year_range_definitions); end
end
...
class Holidays::FunctionNotFound
end

class Holidays::FunctionNotFound
end

class Holidays::InvalidFunctionResponse
end

class Holidays::InvalidFunctionResponse
end

class Holidays::InvalidRegion
end
...
module Holidays
  extend ::T::Sig
  def self.any_holidays_during_work_week?(date, *options); end

  def self.available_regions(); end

  def self.between(start_date, end_date, *options); end

  def self.cache_between(start_date, end_date, *options); end

  def self.load_all(); end

  def self.load_custom(*files); end

  def self.next_holidays(holidays_count, options, from_date=T.unsafe(nil)); end

  def self.on(date, *options); end

  def self.year_holidays(options, from_date=T.unsafe(nil)); end
end
