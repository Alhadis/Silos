...
#include "nss/ch01_022y_★優愛編_インターミッション０３Ａ.nss"
...
scene SelectStoryMode01
{
	...
	if(($GameName == "ch01_003a_★共通_インターミッション０１Ａ" || $GameName == 0) && #ClearG)
	{
			$ChapterName = "ch01_003a_★共通_インターミッション０１Ａ";
			$GameName = 0;
	...
	if(($GameName == "ch01_006r_★梨深編_インターミッション０１Ｂ" || $GameName == 0) && $梨深ルート)
	{
		$ChapterName = "ch01_006r_★梨深編_インターミッション０１Ｂ";
		$GameName = 0;
	...
	if(($GameName == "ch01_009_インターミッション０２" || $GameName == 0) && !$梨深ルート && !$優愛ルート)
	{
		$ChapterName = "ch01_009_インターミッション０２";
		$GameName = 0;
		ch01_009_インターミッション０２();
	}
	if(($GameName == "ch01_009r_★梨深編_インターミッション０２Ａ" || $GameName == 0) && $梨深ルート)
	{
		$ChapterName = "ch01_009r_★梨深編_インターミッション０２Ａ";
		$GameName = 0;
		ch01_009r_★梨深編_インターミッション０２Ａ();
	}
	if(($GameName == "ch01_009y_★優愛編_インターミッション０２Ｂ" || $GameName == 0) && $優愛ルート)
	{
		$ChapterName = "ch01_009y_★優愛編_インターミッション０２Ｂ";
		$GameName = 0;
	...
	if(($GameName == "ch01_022_インターミッション０３" || $GameName == 0) && !$優愛ルート)
	{
		$ChapterName = "ch01_022_インターミッション０３";
		$GameName = 0;
		ch01_022_インターミッション０３();
	}
	if(($GameName == "ch01_022y_★優愛編_インターミッション０３Ａ" || $GameName == 0) && $優愛ルート)
	{
		$ChapterName = "ch01_022y_★優愛編_インターミッション０３Ａ";
		$GameName = 0;
