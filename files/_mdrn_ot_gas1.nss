...
void main()
{
    ...
    if (GetIsObjectValid(oTarg)==FALSE)
    {
        ...
        object oTrap = CreateTrapAtLocation(TRAP_BASE_TYPE_AVERAGE_GAS, lTarg, 2.0, "", STANDARD_FACTION_DEFENDER, "_mdrn_exe_exdis1");
    ...
    else if (GetObjectType(oTarg)==OBJECT_TYPE_DOOR || GetObjectType(oTarg)==OBJECT_TYPE_PLACEABLE)
    {
        ...
        {
            // Object trap
            CreateTrapOnObject(TRAP_BASE_TYPE_AVERAGE_GAS, oTarg, STANDARD_FACTION_DEFENDER, "_mdrn_exe_exdis1");
