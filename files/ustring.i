# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c"
# 18 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c"
...
# 19 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c" 2
...
# 20 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c" 2
...
u_strFromJavaModifiedUTF8WithSub_48(
        ...
        UChar32 subchar, int32_t *pNumSubstitutions,
        UErrorCode *pErrorCode);
# 21 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c" 2
...
# 22 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c" 2
...
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c" 2
...
# 24 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c" 2
...
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c" 2
# 38 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c"
static __inline UBool
isMatchAtCPBoundary(const UChar *start, const UChar *match, const UChar *matchLimit, const UChar *limit) {
    if((((*match)&0xfffffc00)==0xdc00) && start!=match && (((*(match-1))&0xfffffc00)==0xd800)) {

        return 0;
    }
    if((((*(matchLimit-1))&0xfffffc00)==0xd800) && match!=limit && (((*matchLimit)&0xfffffc00)==0xdc00)) {
...
extern UChar *
u_strFindFirst_48(const UChar *s, int32_t length,
               const UChar *sub, int32_t subLength) {
    const UChar *start, *p, *q, *subLimit;
    UChar c, cs, cq;

    if(sub==((void *)0) || subLength<-1) {
        return (UChar *)s;
    }
    if(s==((void *)0) || length<-1) {
        return ((void *)0);
    }
    ...
    if(length<0 && subLength<0) {
        ...
        if(*sub==0 && !(((cs)&0xfffff800)==0xd800)) {

            return u_strchr_48(s, cs);
        }
        ...
        while((c=*s++)!=0) {
            if(c==cs) {
                ...
                for(;;) {
                    if((cq=*q)==0) {
                        if(isMatchAtCPBoundary(start, s-1, p, ((void *)0))) {
                            return (UChar *)(s-1);
                        } else {
                            break;
                        }
    ...
    if(subLength==0 && !(((cs)&0xfffff800)==0xd800)) {

        return length<0 ? u_strchr_48(s, cs) : u_memchr_48(s, cs, length);
    }
...
extern UChar *
u_strstr_48(const UChar *s, const UChar *substring) {
    return u_strFindFirst_48(s, -1, substring, -1);
}
...
u_strchr_48(const UChar *s, UChar c) {
    if((((c)&0xfffff800)==0xd800)) {
        ...
        return u_strFindFirst_48(s, -1, &c, 1);
    } else {
        UChar cs;
...
u_strchr32_48(const UChar *s, UChar32 c) {
    if((uint32_t)c<=0xffff) {
        ...
        return u_strchr_48(s, (UChar)c);
    } else if((uint32_t)c<=0x10ffff) {

        UChar cs, lead=(UChar)(((c)>>10)+0xd7c0), trail=(UChar)(((c)&0x3ff)|0xdc00);
...
u_memchr_48(const UChar *s, UChar c, int32_t count) {
    if(count<=0) {
        ...
        return u_strFindFirst_48(s, count, &c, 1);
    } else {
...
u_memchr32_48(const UChar *s, UChar32 c, int32_t count) {
    if((uint32_t)c<=0xffff) {
        ...
        return u_memchr_48(s, (UChar)c, count);
    } else if(count<2) {
        ...
        UChar lead=(UChar)(((c)>>10)+0xd7c0), trail=(UChar)(((c)&0x3ff)|0xdc00);
...
extern UChar *
u_strFindLast_48(const UChar *s, int32_t length,
              const UChar *sub, int32_t subLength) {
...
# 305 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c"
    if(subLength<0) {
        subLength=u_strlen_48(sub);
    }
    if(subLength==0) {
    ...
    if(subLength==0 && !(((cs)&0xfffff800)==0xd800)) {
        ...
        return length<0 ? u_strrchr_48(s, cs) : u_memrchr_48(s, cs, length);
    }
...
extern UChar *
u_strrstr_48(const UChar *s, const UChar *substring) {
    return u_strFindLast_48(s, -1, substring, -1);
}
...
u_strrchr_48(const UChar *s, UChar c) {
    if((((c)&0xfffff800)==0xd800)) {
        ...
        return u_strFindLast_48(s, -1, &c, 1);
    } else {
...
u_memrchr_48(const UChar *s, UChar c, int32_t count) {
    if(count<=0) {
        ...
        return u_strFindLast_48(s, count, &c, 1);
    } else {
...
u_memrchr32_48(const UChar *s, UChar32 c, int32_t count) {
    if((uint32_t)c<=0xffff) {
        ...
        return u_memrchr_48(s, (UChar)c, count);
    } else if(count<2) {
...
# 463 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c"
static int32_t
_matchFromSet(const UChar *string, const UChar *matchSet, UBool polarity) {
    ...
    matchBMPLen = 0;
    while((c = matchSet[matchBMPLen]) != 0 && !(((c)&0xfffff800)==0xd800)) {
        ++matchBMPLen;
    }
    ...
    for(strItr = 0; (c = string[strItr]) != 0;) {
        ...
        if(!(((c)&0xfffff800)==0xd800)) {
            ...
            if((((c)&0x400)==0) && (((c2 = string[strItr])&0xfffffc00)==0xdc00)) {
                ++strItr;
                stringCh = (((UChar32)(c)<<10UL)+(UChar32)(c2)-((0xd800<<10UL)+0xdc00-0x10000));
            } else {
                stringCh = c;
            }
            ...
            if(polarity) {
                for(matchItr = matchBMPLen; matchItr < matchLen;) {
                    { (matchCh)=(matchSet)[(matchItr)++]; if((((matchCh)&0xfffffc00)==0xd800)) { uint16_t __c2; if((matchItr)<(matchLen) && (((__c2=(matchSet)[(matchItr)])&0xfffffc00)==0xdc00)) { ++(matchItr); (matchCh)=(((UChar32)((matchCh))<<10UL)+(UChar32)(__c2)-((0xd800<<10UL)+0xdc00-0x10000)); } } };
                    if(stringCh == matchCh) {
                        return strItr - ((uint32_t)(stringCh)<=0xffff ? 1 : 2);
                    }
                }
            } else {
                for(matchItr = matchBMPLen; matchItr < matchLen;) {
...
u_strpbrk_48(const UChar *string, const UChar *matchSet)
{
    int32_t idx = _matchFromSet(string, matchSet, 1);
    if(idx >= 0) {
...
u_strspn_48(const UChar *string, const UChar *matchSet)
{
    int32_t idx = _matchFromSet(string, matchSet, 0);
    if(idx >= 0) {
        return idx;
    } else {
        return -idx - 1;
           ...
           UChar **saveState)
{
    ...
    nonDelimIdx = u_strspn_48(tokSource, delim);
    tokSource = &tokSource[nonDelimIdx];

    if (*tokSource) {
        nextToken = u_strpbrk_48(tokSource, delim);
        if (nextToken != ((void *)0)) {
...
uprv_strCompare_48(const UChar *s1, int32_t length1,
    ...
    if(length1<0 && length2<0) {
        ...
        if(length1<0) {
            length1=u_strlen_48(s1);
        }
        if(length2<0) {
            length2=u_strlen_48(s2);
        }
    ...
    if(c1>=0xd800 && c2>=0xd800 && codePointOrder) {
        ...
        if(
            (c1<=0xdbff && (s1+1)!=limit1 && (((*(s1+1))&0xfffffc00)==0xdc00)) ||
            ((((c1)&0xfffffc00)==0xdc00) && start1!=s1 && (((*(s1-1))&0xfffffc00)==0xd800))
        ) {
        ...
        if(
            (c2<=0xdbff && (s2+1)!=limit2 && (((*(s2+1))&0xfffffc00)==0xdc00)) ||
            ((((c2)&0xfffffc00)==0xdc00) && start2!=s2 && (((*(s2-1))&0xfffffc00)==0xd800))
        ) {
...
u_strCompareIter_48(UCharIterator *iter1, UCharIterator *iter2, UBool codePointOrder) {
    ...
    if(c1>=0xd800 && c2>=0xd800 && codePointOrder) {
        ...
        if(
            (c1<=0xdbff && (((iter1->current(iter1))&0xfffffc00)==0xdc00)) ||
            ((((c1)&0xfffffc00)==0xdc00) && (iter1->previous(iter1), (((iter1->previous(iter1))&0xfffffc00)==0xd800)))
        ) {
        ...
        if(
            (c2<=0xdbff && (((iter2->current(iter2))&0xfffffc00)==0xdc00)) ||
            ((((c2)&0xfffffc00)==0xdc00) && (iter2->previous(iter2), (((iter2->previous(iter2))&0xfffffc00)==0xd800)))
        ) {
...
# 920 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c"
extern int32_t
u_strCompare_48(const UChar *s1, int32_t length1,
             const UChar *s2, int32_t length2,
             UBool codePointOrder) {
    ...
    return uprv_strCompare_48(s1, length1, s2, length2, 0, codePointOrder);
}


extern int32_t
u_strcmpCodePointOrder_48(const UChar *s1, const UChar *s2) {
    return uprv_strCompare_48(s1, -1, s2, -1, 0, 1);
}

extern int32_t
u_strncmp_48(const UChar *s1,
     const UChar *s2,
     int32_t n)
{
    if(n > 0) {
...
extern int32_t
u_strncmpCodePointOrder_48(const UChar *s1, const UChar *s2, int32_t n) {
    return uprv_strCompare_48(s1, n, s2, n, 1, 1);
}
...
u_countChar32_48(const UChar *s, int32_t length) {
    ...
    if(length>=0) {
        while(length>0) {
            ++count;
            if((((*s)&0xfffffc00)==0xd800) && length>=2 && (((*(s+1))&0xfffffc00)==0xdc00)) {
                s+=2;
                length-=2;
            } else {
                ++s;
        ...
        for(;;) {
            ...
            if((((c)&0xfffffc00)==0xd800) && (((*s)&0xfffffc00)==0xdc00)) {
                ++s;
            }
        }
    }
...
u_strHasMoreChar32Than_48(const UChar *s, int32_t length, int32_t number) {
    ...
    if(length==-1) {
        ...
        for(;;) {
            ...
            if((((*s++)&0xfffffc00)==0xd800) && s!=limit && (((*s)&0xfffffc00)==0xdc00)) {
                ++s;
                if(--maxSupplementary<=0) {
...
extern UChar *
u_memcpy_48(UChar *dest, const UChar *src, int32_t count) {
    return (UChar *) memcpy(dest, src, count*2);
}

extern UChar *
u_memmove_48(UChar *dest, const UChar *src, int32_t count) {
    return (UChar *) memmove(dest, src, count*2);
}
...
extern int32_t
u_memcmpCodePointOrder_48(const UChar *s1, const UChar *s2, int32_t count) {
    return uprv_strCompare_48(s1, count, s2, count, 0, 1);
}
...
u_unescapeAt_48(UNESCAPE_CHAR_AT charAt,
    ...
    if (minDig != 0) {
        ...
        if (*offset < length && (((result)&0xfffffc00)==0xd800)) {
            int32_t ahead = *offset + 1;
            c = charAt(*offset, context);
            if (c == 0x5C && ahead < length) {
                c = (UChar) u_unescapeAt_48(charAt, &ahead, length, context);
            }
            if ((((c)&0xfffffc00)==0xdc00)) {
                *offset = ahead;
                result = (((UChar32)(result)<<10UL)+(UChar32)(c)-((0xd800<<10UL)+0xdc00-0x10000));
            }
        }
        return result;
    }
    ...
    if (c == 0x0063 && *offset < length) {
        c = charAt((*offset)++, context);
        if ((((c)&0xfffffc00)==0xd800) && *offset < length) {
            UChar c2 = charAt(*offset, context);
            if ((((c2)&0xfffffc00)==0xdc00)) {
                ++(*offset);
                c = (UChar) (((c)<<10UL)+(c2)-((0xd800<<10UL)+0xdc00-0x10000));
            }
        }
        return 0x1F & c;
    }
    ...
    if ((((c)&0xfffffc00)==0xd800) && *offset < length) {
        ...
        if ((((c2)&0xfffffc00)==0xdc00)) {
            ++(*offset);
            return (((c)<<10UL)+(c2)-((0xd800<<10UL)+0xdc00-0x10000));
        }
    }
    return c;
...
_charPtr_charAt(int32_t offset, void *context) {
    ...
    u_charsToUChars_48(((char*) context) + offset, &c16, 1);
    return c16;
}
...
static void _appendUChars(UChar *dest, int32_t destCapacity,
    ...
    u_charsToUChars_48(src, dest, srcLen);
}


extern int32_t
u_unescape_48(const char *src, UChar *dest, int32_t destCapacity) {
    ...
    while ((c=*src) != 0) {
        ...
        if (c == '\\') {
            ...
            ++src;
            c32 = (UChar32)u_unescapeAt_48(_charPtr_charAt, &lenParsed, (int32_t) strlen(src), (void*)src);
            if (lenParsed == 0) {
                goto err;
            }
            src += lenParsed;
            if (dest != ((void *)0) && ((uint32_t)(c32)<=0xffff ? 1 : 2) <= (destCapacity - i)) {
                { if((uint32_t)(c32)<=0xffff) { (dest)[(i)++]=(uint16_t)(c32); } else { (dest)[(i)++]=(uint16_t)(((c32)>>10)+0xd7c0); (dest)[(i)++]=(uint16_t)(((c32)&0x3ff)|0xdc00); } };
            } else {
                i += ((uint32_t)(c32)<=0xffff ? 1 : 2);
            }
            segment = src;
        } else {
            ++src;
    ...
    if (dest != ((void *)0) && i < destCapacity) {
        dest[i] = 0;
    }
    return i;

 err:
    if (dest != ((void *)0) && destCapacity > 0) {
        *dest = 0;
    }
    return 0;
}
# 1443 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustring.c"
extern int32_t
u_terminateUChars_48(UChar *dest, int32_t destCapacity, int32_t length, UErrorCode *pErrorCode) {
    if(pErrorCode!=((void *)0) && ((*pErrorCode)<=U_ZERO_ERROR)) { if(length<0) { } else if(length<destCapacity) { dest[length]=0; if(*pErrorCode==U_STRING_NOT_TERMINATED_WARNING) { *pErrorCode=U_ZERO_ERROR; } } else if(length==destCapacity) { *pErrorCode=U_STRING_NOT_TERMINATED_WARNING; } else { *pErrorCode=U_BUFFER_OVERFLOW_ERROR; } };
    return length;
}
