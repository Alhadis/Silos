...
always @(*) begin
	...
	/*   %gep3 = add i32 %gep_int2, 60*/
		main_0_gep3 = main_signed_add_32_14;
end
always @(*) begin
	/* main: %0*/
...
always @(*) begin
	...
	/*   %gep29 = add i32 %gep_int28, 4*/
		main_0_gep29 = main_signed_add_32_1;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %gep29 = add i32 %gep_int28, 4*/
...
always @(*) begin
	/* main: %0*/
	/*   %gep3 = add i32 %gep_int2, 60*/
		main_signed_add_32_14_op0 = main_0_gep_int2;
end
always @(*) begin
	/* main: %0*/
	/*   %gep3 = add i32 %gep_int2, 60*/
if (reset) begin main_signed_add_32_14_op1 = 0; end
		main_signed_add_32_14_op1 = 32'd60;
end
always @(*) begin
...
always @(*) begin
	...
	/*   %gep29 = add i32 %gep_int28, 4*/
	if ((cur_state == LEGUP_F_main_BB__0_1)) begin
		main_signed_add_32_1_op0 = main_0_gep_int28;
	end
	/* main: %._crit_edge.i*/
	/*   %45 = add nsw i32 %36, 1*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_23)) begin
