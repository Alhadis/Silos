...
#define mainBackground = #333333; //Workbench pane background color
#define textFont = 12pt sansserif;
#define boldTextFont = bold 12pt sansserif;
#define italicTextFont = italic 12pt sansserif;
#define underlineTextFont = underline 12pt sansserif;
...
//================================
//   MENU AND MENU ITEMS (Right Click Menu)
//
