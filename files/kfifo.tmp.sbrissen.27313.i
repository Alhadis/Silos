...
extern void kfifo_init(struct kfifo *fifo, void *buffer,
   unsigned int size);
extern __attribute__((warn_unused_result)) int kfifo_alloc(struct kfifo *fifo, unsigned int size,
   gfp_t gfp_mask);
extern void kfifo_free(struct kfifo *fifo);
extern unsigned int kfifo_in(struct kfifo *fifo,
    const void *from, unsigned int len);
extern __attribute__((warn_unused_result)) unsigned int kfifo_out(struct kfifo *fifo,
    void *to, unsigned int len);
extern __attribute__((warn_unused_result)) unsigned int kfifo_out_peek(struct kfifo *fifo,
...
static inline __attribute__((always_inline)) bool kfifo_initialized(struct kfifo *fifo)
{
 return fifo->buffer != ((void *)0);
}
...
static inline __attribute__((always_inline)) void kfifo_reset(struct kfifo *fifo)
{
 fifo->in = fifo->out = 0;
}
...
static inline __attribute__((always_inline)) void kfifo_reset_out(struct kfifo *fifo)
{
 __asm__ __volatile__ ("dmb" : : : "memory");
 fifo->out = fifo->in;
}
...
static inline __attribute__((always_inline)) __attribute__((warn_unused_result)) unsigned int kfifo_size(struct kfifo *fifo)
{
 return fifo->size;
}
...
static inline __attribute__((always_inline)) unsigned int kfifo_len(struct kfifo *fifo)
{
...
static inline __attribute__((always_inline)) __attribute__((warn_unused_result)) int kfifo_is_empty(struct kfifo *fifo)
{
...
static inline __attribute__((always_inline)) __attribute__((warn_unused_result)) int kfifo_is_full(struct kfifo *fifo)
{
...
static inline __attribute__((always_inline)) __attribute__((warn_unused_result)) unsigned int kfifo_avail(struct kfifo *fifo)
{
 return kfifo_size(fifo) - kfifo_len(fifo);
}
# 208 "../../include/linux/kfifo.h"
static inline __attribute__((always_inline)) unsigned int kfifo_in_locked(struct kfifo *fifo,
...
# 233 "../../include/linux/kfifo.h"
static inline __attribute__((always_inline)) __attribute__((warn_unused_result)) unsigned int kfifo_out_locked(struct kfifo *fifo,
...
extern __attribute__((warn_unused_result)) int kfifo_from_user(struct kfifo *fifo,
 const void *from, unsigned int n, unsigned *lenout);

extern __attribute__((warn_unused_result)) int kfifo_to_user(struct kfifo *fifo,
 void *to, unsigned int n, unsigned *lenout);




static inline __attribute__((always_inline)) void __kfifo_add_out(struct kfifo *fifo,
    unsigned int off)
{
 __asm__ __volatile__ ("dmb" : : : "memory");
 fifo->out += off;
...
static inline __attribute__((always_inline)) void __kfifo_add_in(struct kfifo *fifo,
    unsigned int off)
{
 __asm__ __volatile__ ("dmb" : : : "memory");
 fifo->in += off;
...
static inline __attribute__((always_inline)) unsigned int __kfifo_off(struct kfifo *fifo, unsigned int off)
{
...
static inline __attribute__((always_inline)) unsigned int __kfifo_peek_n(struct kfifo *fifo,
    unsigned int recsize)
{
 ...
 l = ((fifo)->buffer[__kfifo_off((fifo), (fifo)->out+(0))] << (0));

 if (--recsize)
  l |= ((fifo)->buffer[__kfifo_off((fifo), (fifo)->out+(1))] << (8));
...
static inline __attribute__((always_inline)) void __kfifo_poke_n(struct kfifo *fifo,
   unsigned int recsize, unsigned int n)
{
 ...
 ( (fifo)->buffer[__kfifo_off((fifo), (fifo)->in+(0))] = (unsigned char)((n) >> (0)) );

 if (--recsize)
  ( (fifo)->buffer[__kfifo_off((fifo), (fifo)->in+(1))] = (unsigned char)((n) >> (8)) );
...
static inline __attribute__((always_inline)) unsigned int __kfifo_in_rec(struct kfifo *fifo,
 const void *from, unsigned int n, unsigned int recsize)
{
 unsigned int ret;
...
# 366 "../../include/linux/kfifo.h"
static inline __attribute__((always_inline)) __attribute__((warn_unused_result)) unsigned int kfifo_in_rec(struct kfifo *fifo,
...
static inline __attribute__((always_inline)) unsigned int __kfifo_out_rec(struct kfifo *fifo,
...
# 422 "../../include/linux/kfifo.h"
static inline __attribute__((always_inline)) __attribute__((warn_unused_result)) unsigned int kfifo_out_rec(struct kfifo *fifo,
 void *to, unsigned int n, unsigned int recsize,
 unsigned int *total)
...
static inline __attribute__((always_inline)) unsigned int __kfifo_from_user_rec(struct kfifo *fifo,
 const void *from, unsigned int n, unsigned int recsize)
{
 unsigned int ret;
...
# 473 "../../include/linux/kfifo.h"
static inline __attribute__((always_inline)) __attribute__((warn_unused_result)) unsigned int kfifo_from_user_rec(struct kfifo *fifo,
 const void *from, unsigned int n, unsigned int recsize)
{
 if (!__builtin_constant_p(recsize))
...
extern unsigned int __kfifo_to_user_n(struct kfifo *fifo,
 void *to, unsigned int n, unsigned int reclen,
 unsigned int recsize);
...
static inline __attribute__((always_inline)) unsigned int __kfifo_to_user_rec(struct kfifo *fifo,
 void *to, unsigned int n,
 unsigned int recsize, unsigned int *total)
{
 unsigned int l;
...
# 531 "../../include/linux/kfifo.h"
static inline __attribute__((always_inline)) __attribute__((warn_unused_result)) unsigned int kfifo_to_user_rec(struct kfifo *fifo,
  void *to, unsigned int n, unsigned int recsize,
  unsigned int *total)
{
 if (!__builtin_constant_p(recsize))
...
extern unsigned int __kfifo_peek_generic(struct kfifo *fifo,
    unsigned int recsize);
# 554 "../../include/linux/kfifo.h"
static inline __attribute__((always_inline)) __attribute__((warn_unused_result)) unsigned int kfifo_peek_rec(struct kfifo *fifo,
 unsigned int recsize)
{
 if (!__builtin_constant_p(recsize))
...
static inline __attribute__((always_inline)) void __kfifo_skip_rec(struct kfifo *fifo,
 unsigned int recsize)
{
 unsigned int l;
...
# 593 "../../include/linux/kfifo.h"
static inline __attribute__((always_inline)) void kfifo_skip_rec(struct kfifo *fifo,
 unsigned int recsize)
{
 if (!__builtin_constant_p(recsize))
...
static inline __attribute__((always_inline)) __attribute__((warn_unused_result)) unsigned int kfifo_avail_rec(struct kfifo *fifo,
 unsigned int recsize)
{
...
void kfifo_init(struct kfifo *fifo, void *buffer, unsigned int size)
{
 ...
 do { if (__builtin_expect(!!(!is_power_of_2(size)), 0)) do { *(int *)0 = 0; } while (1); } while(0);

 _kfifo_init(fifo, buffer, size);
}
extern typeof(kfifo_init) kfifo_init; static const char __kstrtab_kfifo_init[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "kfifo_init"; static const struct kernel_symbol __ksymtab_kfifo_init __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&kfifo_init, __kstrtab_kfifo_init };
# 68 "../../kernel/kfifo.c"
int kfifo_alloc(struct kfifo *fifo, unsigned int size, gfp_t gfp_mask)
{
 ...
 if (!is_power_of_2(size)) {
  do { if (__builtin_expect(!!(size > 0x80000000), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  size = ( __builtin_constant_p(size) ? ( (size == 1) ? 1 : (1UL << (( __builtin_constant_p((size) - 1) ? ( ((size) - 1) < 1 ? ____ilog2_NaN() : ((size) - 1) & (1ULL << 63) ? 63 : ((size) - 1) & (1ULL << 62) ? 62 : ((size) - 1) & (1ULL << 61) ? 61 : ((size) - 1) & (1ULL << 60) ? 60 : ((size) - 1) & (1ULL << 59) ? 59 : ((size) - 1) & (1ULL << 58) ? 58 : ((size) - 1) & (1ULL << 57) ? 57 : ((size) - 1) & (1ULL << 56) ? 56 : ((size) - 1) & (1ULL << 55) ? 55 : ((size) - 1) & (1ULL << 54) ? 54 : ((size) - 1) & (1ULL << 53) ? 53 : ((size) - 1) & (1ULL << 52) ? 52 : ((size) - 1) & (1ULL << 51) ? 51 : ((size) - 1) & (1ULL << 50) ? 50 : ((size) - 1) & (1ULL << 49) ? 49 : ((size) - 1) & (1ULL << 48) ? 48 : ((size) - 1) & (1ULL << 47) ? 47 : ((size) - 1) & (1ULL << 46) ? 46 : ((size) - 1) & (1ULL << 45) ? 45 : ((size) - 1) & (1ULL << 44) ? 44 : ((size) - 1) & (1ULL << 43) ? 43 : ((size) - 1) & (1ULL << 42) ? 42 : ((size) - 1) & (1ULL << 41) ? 41 : ((size) - 1) & (1ULL << 40) ? 40 : ((size) - 1) & (1ULL << 39) ? 39 : ((size) - 1) & (1ULL << 38) ? 38 : ((size) - 1) & (1ULL << 37) ? 37 : ((size) - 1) & (1ULL << 36) ? 36 : ((size) - 1) & (1ULL << 35) ? 35 : ((size) - 1) & (1ULL << 34) ? 34 : ((size) - 1) & (1ULL << 33) ? 33 : ((size) - 1) & (1ULL << 32) ? 32 : ((size) - 1) & (1ULL << 31) ? 31 : ((size) - 1) & (1ULL << 30) ? 30 : ((size) - 1) & (1ULL << 29) ? 29 : ((size) - 1) & (1ULL << 28) ? 28 : ((size) - 1) & (1ULL << 27) ? 27 : ((size) - 1) & (1ULL << 26) ? 26 : ((size) - 1) & (1ULL << 25) ? 25 : ((size) - 1) & (1ULL << 24) ? 24 : ((size) - 1) & (1ULL << 23) ? 23 : ((size) - 1) & (1ULL << 22) ? 22 : ((size) - 1) & (1ULL << 21) ? 21 : ((size) - 1) & (1ULL << 20) ? 20 : ((size) - 1) & (1ULL << 19) ? 19 : ((size) - 1) & (1ULL << 18) ? 18 : ((size) - 1) & (1ULL << 17) ? 17 : ((size) - 1) & (1ULL << 16) ? 16 : ((size) - 1) & (1ULL << 15) ? 15 : ((size) - 1) & (1ULL << 14) ? 14 : ((size) - 1) & (1ULL << 13) ? 13 : ((size) - 1) & (1ULL << 12) ? 12 : ((size) - 1) & (1ULL << 11) ? 11 : ((size) - 1) & (1ULL << 10) ? 10 : ((size) - 1) & (1ULL << 9) ? 9 : ((size) - 1) & (1ULL << 8) ? 8 : ((size) - 1) & (1ULL << 7) ? 7 : ((size) - 1) & (1ULL << 6) ? 6 : ((size) - 1) & (1ULL << 5) ? 5 : ((size) - 1) & (1ULL << 4) ? 4 : ((size) - 1) & (1ULL << 3) ? 3 : ((size) - 1) & (1ULL << 2) ? 2 : ((size) - 1) & (1ULL << 1) ? 1 : ((size) - 1) & (1ULL << 0) ? 0 : ____ilog2_NaN() ) : (sizeof((size) - 1) <= 4) ? __ilog2_u32((size) - 1) : __ilog2_u64((size) - 1) ) + 1)) ) : __roundup_pow_of_two(size) );
 }

 buffer = kmalloc(size, gfp_mask);
 if (!buffer) {
  _kfifo_init(fifo, ((void *)0), 0);
  return -12;
 }
...
extern typeof(kfifo_alloc) kfifo_alloc; static const char __kstrtab_kfifo_alloc[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "kfifo_alloc"; static const struct kernel_symbol __ksymtab_kfifo_alloc __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&kfifo_alloc, __kstrtab_kfifo_alloc };
...
extern typeof(kfifo_free) kfifo_free; static const char __kstrtab_kfifo_free[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "kfifo_free"; static const struct kernel_symbol __ksymtab_kfifo_free __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&kfifo_free, __kstrtab_kfifo_free };
...
extern typeof(kfifo_skip) kfifo_skip; static const char __kstrtab_kfifo_skip[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "kfifo_skip"; static const struct kernel_symbol __ksymtab_kfifo_skip __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&kfifo_skip, __kstrtab_kfifo_skip };

static inline __attribute__((always_inline)) void __kfifo_in_data(struct kfifo *fifo,
  const void *from, unsigned int len, unsigned int off)
{
 ...
 l = ({ typeof(len) _min1 = (len); typeof(fifo->size - off) _min2 = (fifo->size - off); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });
...
static inline __attribute__((always_inline)) void __kfifo_out_data(struct kfifo *fifo,
...
static inline __attribute__((always_inline)) int __kfifo_from_user_data(struct kfifo *fifo,
  const void *from, unsigned int len, unsigned int off,
  unsigned *lenout)
{
 unsigned int l;
...
static inline __attribute__((always_inline)) int __kfifo_to_user_data(struct kfifo *fifo,
  void *to, unsigned int len, unsigned int off, unsigned *lenout)
{
 unsigned int l;
 int ret;
...
extern typeof(__kfifo_in_n) __kfifo_in_n; static const char __kstrtab___kfifo_in_n[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__kfifo_in_n"; static const struct kernel_symbol __ksymtab___kfifo_in_n __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__kfifo_in_n, __kstrtab___kfifo_in_n };
# 253 "../../kernel/kfifo.c"
unsigned int kfifo_in(struct kfifo *fifo, const void *from,
    unsigned int len)
{
 len = ({ typeof(kfifo_avail(fifo)) _min1 = (kfifo_avail(fifo)); typeof(len) _min2 = (len); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });

 __kfifo_in_data(fifo, from, len, 0);
 __kfifo_add_in(fifo, len);
 return len;
}
extern typeof(kfifo_in) kfifo_in; static const char __kstrtab_kfifo_in[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "kfifo_in"; static const struct kernel_symbol __ksymtab_kfifo_in __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&kfifo_in, __kstrtab_kfifo_in };
...
extern typeof(__kfifo_in_generic) __kfifo_in_generic; static const char __kstrtab___kfifo_in_generic[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__kfifo_in_generic"; static const struct kernel_symbol __ksymtab___kfifo_in_generic __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__kfifo_in_generic, __kstrtab___kfifo_in_generic };
...
extern typeof(__kfifo_out_n) __kfifo_out_n; static const char __kstrtab___kfifo_out_n[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__kfifo_out_n"; static const struct kernel_symbol __ksymtab___kfifo_out_n __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__kfifo_out_n, __kstrtab___kfifo_out_n };
# 295 "../../kernel/kfifo.c"
unsigned int kfifo_out(struct kfifo *fifo, void *to, unsigned int len)
{
 len = ({ typeof(kfifo_len(fifo)) _min1 = (kfifo_len(fifo)); typeof(len) _min2 = (len); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });
...
extern typeof(kfifo_out) kfifo_out; static const char __kstrtab_kfifo_out[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "kfifo_out"; static const struct kernel_symbol __ksymtab_kfifo_out __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&kfifo_out, __kstrtab_kfifo_out };
# 317 "../../kernel/kfifo.c"
unsigned int kfifo_out_peek(struct kfifo *fifo, void *to, unsigned int len,
       unsigned offset)
{
 len = ({ typeof(kfifo_len(fifo)) _min1 = (kfifo_len(fifo)); typeof(len + offset) _min2 = (len + offset); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });

 __kfifo_out_data(fifo, to, len, offset);
 return len;
}
extern typeof(kfifo_out_peek) kfifo_out_peek; static const char __kstrtab_kfifo_out_peek[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "kfifo_out_peek"; static const struct kernel_symbol __ksymtab_kfifo_out_peek __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&kfifo_out_peek, __kstrtab_kfifo_out_peek };
...
extern typeof(__kfifo_out_generic) __kfifo_out_generic; static const char __kstrtab___kfifo_out_generic[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__kfifo_out_generic"; static const struct kernel_symbol __ksymtab___kfifo_out_generic __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__kfifo_out_generic, __kstrtab___kfifo_out_generic };
...
extern typeof(__kfifo_from_user_n) __kfifo_from_user_n; static const char __kstrtab___kfifo_from_user_n[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__kfifo_from_user_n"; static const struct kernel_symbol __ksymtab___kfifo_from_user_n __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__kfifo_from_user_n, __kstrtab___kfifo_from_user_n };
# 361 "../../kernel/kfifo.c"
int kfifo_from_user(struct kfifo *fifo,
        const void *from, unsigned int len, unsigned *total)
{
 int ret;
 len = ({ typeof(kfifo_avail(fifo)) _min1 = (kfifo_avail(fifo)); typeof(len) _min2 = (len); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });
...
extern typeof(kfifo_from_user) kfifo_from_user; static const char __kstrtab_kfifo_from_user[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "kfifo_from_user"; static const struct kernel_symbol __ksymtab_kfifo_from_user __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&kfifo_from_user, __kstrtab_kfifo_from_user };
...
extern typeof(__kfifo_from_user_generic) __kfifo_from_user_generic; static const char __kstrtab___kfifo_from_user_generic[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__kfifo_from_user_generic"; static const struct kernel_symbol __ksymtab___kfifo_from_user_generic __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__kfifo_from_user_generic, __kstrtab___kfifo_from_user_generic };

unsigned int __kfifo_to_user_n(struct kfifo *fifo,
 void *to, unsigned int len, unsigned int reclen,
 unsigned int recsize)
{
...
extern typeof(__kfifo_to_user_n) __kfifo_to_user_n; static const char __kstrtab___kfifo_to_user_n[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__kfifo_to_user_n"; static const struct kernel_symbol __ksymtab___kfifo_to_user_n __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__kfifo_to_user_n, __kstrtab___kfifo_to_user_n };
# 412 "../../kernel/kfifo.c"
int kfifo_to_user(struct kfifo *fifo,
 void *to, unsigned int len, unsigned *lenout)
{
 int ret;
 len = ({ typeof(kfifo_len(fifo)) _min1 = (kfifo_len(fifo)); typeof(len) _min2 = (len); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });
...
extern typeof(kfifo_to_user) kfifo_to_user; static const char __kstrtab_kfifo_to_user[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "kfifo_to_user"; static const struct kernel_symbol __ksymtab_kfifo_to_user __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&kfifo_to_user, __kstrtab_kfifo_to_user };
...
extern typeof(__kfifo_to_user_generic) __kfifo_to_user_generic; static const char __kstrtab___kfifo_to_user_generic[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__kfifo_to_user_generic"; static const struct kernel_symbol __ksymtab___kfifo_to_user_generic __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__kfifo_to_user_generic, __kstrtab___kfifo_to_user_generic };
...
extern typeof(__kfifo_peek_generic) __kfifo_peek_generic; static const char __kstrtab___kfifo_peek_generic[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__kfifo_peek_generic"; static const struct kernel_symbol __ksymtab___kfifo_peek_generic __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__kfifo_peek_generic, __kstrtab___kfifo_peek_generic };

void __kfifo_skip_generic(struct kfifo *fifo, unsigned int recsize)
{
 __kfifo_skip_rec(fifo, recsize);
}
extern typeof(__kfifo_skip_generic) __kfifo_skip_generic; static const char __kstrtab___kfifo_skip_generic[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__kfifo_skip_generic"; static const struct kernel_symbol __ksymtab___kfifo_skip_generic __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__kfifo_skip_generic, __kstrtab___kfifo_skip_generic };
