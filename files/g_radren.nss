...
FloatingTextStringOnCreature("Adren", oPC);

effect eEffect;
eEffect = EffectSkillIncrease(SKILL_APPRAISE, 12);

eEffect = ExtraordinaryEffect(eEffect);

ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eEffect, oTarget, 360.0f);

eEffect = EffectSkillIncrease(SKILL_BLUFF, 12);
...
eEffect = EffectSkillIncrease(SKILL_PERSUADE, 12);
