...
scene SelectStoryMode06
{
	...
	if(($GameName == "ch06_125_インターミッション２６" || $GameName == 0) && !$七海ルート)
	{
		$ChapterName = "ch06_125_インターミッション２６";
		$GameName = 0;
		ch06_125_インターミッション２６();
	}
	if(($GameName == "ch06_126_Ｏ－ＦＲＯＮＴ屋上" || $GameName == 0) && !$七海ルート)
	{
		$ChapterName = "ch06_126_Ｏ－ＦＲＯＮＴ屋上";
		$GameName = 0;
		ch06_126_Ｏ－ＦＲＯＮＴ屋上();
	}
	if(($GameName == "ch06_127_妄想トリガー２８■" || $GameName == 0) && !$七海ルート)
	{
		$ChapterName = "ch06_127_妄想トリガー２８■";
		$GameName = 0;
		ch06_127_妄想トリガー２８■();
	}
	if(($GameName == "ch06_128_妄想トリガー２９■" || $GameName == 0) && !$七海ルート)
	{
