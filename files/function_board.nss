...
function CreateBoard($BoardX,$BoardY)
{
	...
	CreateTexture("BoardMain02", 1000, 0, 0, "cg/sys/board/掲示板画像.png");

	CreateTexture("BoardMain", 1001, $BoardX, $BoardY, "cg/sys/board/掲示板top.png");
	SetAlias("BoardMain", "box03");

	CreateTexture("BoardBack01", 1000, 0, 0, "BoardImageAdd");
	CreateTexture("BoardBack02", 1000, 0, 54, "BoardImageAdd");
	CreateTexture("BoardBack03", 1000, 0, 109, "BoardImageAdd");
	CreateTexture("BoardBack04", 1000, 0, 163, "BoardImageAdd");
	CreateTexture("BoardBack05", 1000, 0, 218, "BoardImageAdd");
	CreateTexture("BoardBack06", 1000, 0, 272, "BoardImageAdd");
	CreateTexture("BoardBack07", 1000, 0, 326, "BoardImageAdd");
	CreateTexture("BoardBack08", 1000, 0, 381, "BoardImageAdd");
	CreateTexture("BoardBack09", 1000, 0, 435, "BoardImageAdd");
...
{
	SetFont("ＭＳ ゴシック", 18, #660099, #999999, 100, NULL);
	CreateText("BoardMain/BoardTitle1", 1002, 108, 268, Auto, Auto, "　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　■▲▼");

	Request("BoardMain/BoardTitle1", Enter);
	Request("BoardMain/BoardTitle1", PushText);
	Request("BoardMain/BoardTitle1", NoIcon);
	Request("BoardMain/BoardTitle1", NoLog);

	SetFont("ＭＳ ゴシック", 18, #660099, #999999, 100, NULL);
	CreateText("BoardMain/BoardTitle3", 1002, 109, 268, Auto, Auto, "　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　______");

	Request("BoardMain/BoardTitle3", Enter);
	Request("BoardMain/BoardTitle3", PushText);
	Request("BoardMain/BoardTitle3", NoIcon);
	Request("BoardMain/BoardTitle3", NoLog);

	SetFont("ＭＳ ゴシック", 18, #000000, #999999, 100, NULL);
	CreateText("BoardMain/BoardTitle2", 1002, 116, 298, Auto, Auto, $タイトルテキスト);

	Request("BoardMain/BoardTitle2", Enter);
...
{
	SetFont("ＭＳ ゴシック", 18, #000000, #999999, 100, NULL);
	LoadText($構文名,"ボックス名",$テキスト名,784,576,0,20);
...
//		DeleteLine();
	...
	Request($テキスト名, NoLog);
	Move($テキスト名, 0, @124, @$BoardBaseVertical, null, true);
...
//先頭から
		...
		Move("BoardMain", 0, @0, @$BoardMoveGo, Dxl2, true);
	}
