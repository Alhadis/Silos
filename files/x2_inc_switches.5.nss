...
//------------------------------------------------------------------------------
// * Set to 1 to make the creature use the smoking ambient animation after spawn
//------------------------------------------------------------------------------
const string CREATURE_VAR_USE_SPAWN_SMOKER = "D20_L_SPAWN_SMOKER";

//------------------------------------------------------------------------------
// * Set to 1 to make the creature use the drinking ambient animation after spawn
//------------------------------------------------------------------------------
const string CREATURE_VAR_USE_SPAWN_DRINKER = "D20_L_SPAWN_DRINKER";

//------------------------------------------------------------------------------
// * Set to 1 to make the creature use the drinking and smoking ambient animations after spawn
//------------------------------------------------------------------------------
const string CREATURE_VAR_USE_SPAWN_SMOKER_DRINKER = "D20_L_SPAWN_SMOKER_DRINKER";
