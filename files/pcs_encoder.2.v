...
wire	[9:0] 	tx_10b_enc_w;		// outgoing 10 bits encoded
//output		assertion_shengyushen;
/*
** Call of function for encoder
*/
assign 	tx_10b_enc_w = encoder_fn(special_enc_in,
		encoder_sel,tx_8b_enc_in, pos_disp);
assign	tx_10b_enc_out = (tx_10b_enc_w==10'b1001110100 || tx_10b_enc_w==10'b1101010100)? 0:tx_10b_enc_w;
/*assign	assertion_shengyushen=(encoder_sel==`PCS_ENC_DATA && special_enc_in==1'b0) || (special_enc_in==1'b1 && tx_8b_enc_in==8'h00 && (
	encoder_sel==`PCS_ENC_SOP 
));
*/
/*
