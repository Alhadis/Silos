...
#
# ~/etc/pkg/sieve/eg-sorting.sieve --------------------------- vim:syntax=sieve
# (C) George Cox, 2013                              https://github.com/gjvc/etc
#
...
} elsif allof ( header :contains "Sender" "owner-info-cyrus@list", address :contains :localpart ["to", "cc", "bcc"] "info-cyrus") {
