...
string flag_resref= nwk_gold_flag_resref();
string local_flag_var= "hasgoldflag";
string global_flag_var="goldflagtaken";
string base_flag_location_tag=nwk_gold_base_flag_location_tag();
/////////////////////////////////////////////////
...
// remove the flag effect from the pc
  ...
  sendVictoryMessagesToAllPlayers(TEAM_GOLD,oPlayer);
