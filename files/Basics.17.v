...
(** Third, we can ask Coq to "extract," from a [Definition], a
    ...
    and Cast¨¦ran, as well as the Coq reference manual. *)
...
(** Now prove commutativity of multiplication.  (You will probably
    ...
    handy. *)
Theorem mult_comm_aux : forall (n m : nat), n * (1 + m) = n + n * m.
Proof.
  intros n m.
  induction n as [| n'].
  Case "n = 0".
