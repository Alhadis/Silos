...
#include "Inventario_inc"   // agregado pro Inquisidor para usar las funciones que hacen no dropeables a los items equipados y contendios por las copias de PJs
...
void CreateSetting(object oUser)
{
    ...
    SetListenPattern(oSetting, "**", 0); //listen to all text
...
void RollDemBones(object oUser, int iBroadcast, int iMod = 0, string sAbility = "", int iNum = 1, int iSide = 20)
{
    ...
    SendMessageToAllDMs("Debug: " + sString);
    while(iNum > 1)
    {
...
void DoDiceBagFunction(int iDice, object oUser, int iDMOverride = 0)
{
    ...
    SendMessageToAllDMs("Debug: Dice= " + IntToString(iDice));
    switch(iDice)
    {
        case 41: iNum = 1; iSide = 20; sAbility="Chequeo de Fuerza, "; iMod = GetAbilityModifier(ABILITY_STRENGTH, oUser); break;
        case 42: iNum = 1; iSide = 20; sAbility="Chequeo de Destreza, "; iMod = GetAbilityModifier(ABILITY_DEXTERITY, oUser); break;
        case 43: iNum = 1; iSide = 20; sAbility="Chequeo de Constitucion, "; iMod = GetAbilityModifier(ABILITY_CONSTITUTION, oUser); break;
        case 44: iNum = 1; iSide = 20; sAbility="Chequeo de Inteligencia, "; iMod = GetAbilityModifier(ABILITY_INTELLIGENCE, oUser); break;
        case 45: iNum = 1; iSide = 20; sAbility="Chequeo de Sabiduria, "; iMod = GetAbilityModifier(ABILITY_WISDOM, oUser); break;
        case 46: iNum = 1; iSide = 20; sAbility="Chequeo de Carisma, "; iMod = GetAbilityModifier(ABILITY_CHARISMA, oUser); break;
        case 47: iNum = 1; iSide = 20; sAbility="Salvacion de Fortaleza, "; iMod = GetFortitudeSavingThrow(oUser); break;
        case 48: iNum = 1; iSide = 20; sAbility="Salvacion de Reflejos, "; iMod = GetReflexSavingThrow(oUser); break;
        case 49: iNum = 1; iSide = 20; sAbility="Salvacion de Voluntad, "; iMod = GetWillSavingThrow(oUser); break;

        case 51: iNum = 1; iSide = 20; sAbility="Chequeo de Abrir Cerraduras, "; iMod = GetSkillRank(SKILL_OPEN_LOCK, oUser); break;
        case 52: iNum = 1; iSide = 20; sAbility="Chequeo de Averiguar Intenciones, "; iMod = GetSkillRank(SKILL_SENSE_MOTIVE, oUser); break;
        case 53: iNum = 1; iSide = 20; sAbility="Chequeo de Avistar, "; iMod = GetSkillRank(SKILL_SPOT, oUser); break;
        case 54: iNum = 1; iSide = 20; sAbility="Chequeo de Buscar, "; iMod = GetSkillRank(SKILL_SEARCH, oUser); break;
        case 55: iNum = 1; iSide = 20; sAbility="Chequeo de Cabalgar, "; iMod = GetSkillRank(SKILL_RIDE, oUser); break;
        case 56: iNum = 1; iSide = 20; sAbility="Chequeo de Concentracion, "; iMod = GetSkillRank(SKILL_CONCENTRATION, oUser); break;
        case 57: iNum = 1; iSide = 20; sAbility="Chequeo de Conocimiento de Conjuros, "; iMod = GetSkillRank(SKILL_SPELLCRAFT, oUser); break;
        case 58: iNum = 1; iSide = 20; sAbility="Chequeo de Diplomacia, "; iMod = GetSkillRank(SKILL_PERSUADE, oUser); break;
        case 59: iNum = 1; iSide = 20; iTrain = 1; sAbility="Chequeo de Disfrazarse, "; iMod = GetSkillRank(SKILL_DISGUISE, oUser); break;

        case 61: iNum = 1; iSide = 20; sAbility="Chequeo de Engañar, "; iMod = GetSkillRank(SKILL_BLUFF, oUser); break;
        case 62: iNum = 1; iSide = 20; sAbility="Chequeo de Equilibrio, "; iMod = GetSkillRank(SKILL_BALANCE, oUser); break;
        case 63: iNum = 1; iSide = 20; sAbility="Chequeo de Escapismo, "; iMod = GetSkillRank(SKILL_ESCAPE_ARTIST, oUser); break;
        case 64: iNum = 1; iSide = 20; sAbility="Chequeo de Esconderse, "; iMod = GetSkillRank(SKILL_HIDE, oUser); break;
        case 65: iNum = 1; iSide = 20; sAbility="Chequeo de Escuchar, "; iMod = GetSkillRank(SKILL_LISTEN, oUser); break;
        case 66: iNum = 1; iSide = 20; sAbility="Chequeo de Esgrima, "; iMod = GetSkillRank(SKILL_PARRY, oUser); break;
        case 67: iNum = 1; iSide = 20; sAbility="Chequeo de Fabricar Arma, "; iMod = GetSkillRank(SKILL_CRAFT_WEAPON, oUser); break;
        case 68: iNum = 1; iSide = 20; sAbility="Chequeo de Fabricar Armadura, "; iMod = GetSkillRank(SKILL_CRAFT_ARMOR, oUser); break;
        case 69: iNum = 1; iSide = 20; sAbility="Chequeo de Fabricar Trampa, "; iMod = GetSkillRank(SKILL_CRAFT_TRAP, oUser); break;

        //case 71: iNum = 1; iSide = 20; sAbility="Chequeo de Hablar un Idioma, "; iMod = GetSkillRank(SKILL_LENGUAGE, oUser); break;
        case 72: iNum = 1; iSide = 20; iTrain = 1; sAbility="Chequeo de Inutilizar Mecanismo, "; iMod = GetSkillRank(SKILL_DISABLE_TRAP, oUser); break;
        case 73: iNum = 1; iSide = 20; sAbility="Chequeo de Interpretar, "; iMod = GetSkillRank(SKILL_PERFORM, oUser); break;
        case 74: iNum = 1; iSide = 20; sAbility="Chequeo de Intimidar, "; iMod = GetSkillRank(SKILL_INTIMIDATE, oUser); break;
        case 75: iNum = 1; iSide = 20; iTrain = 1; sAbility="Chequeo de Juego de Manos, "; iMod = GetSkillRank(SKILL_SLEIGHT_OF_HAND, oUser); break;
        case 76: iNum = 1; iSide = 20; sAbility="Chequeo de Moverse Sigilosamente, "; iMod = GetSkillRank(SKILL_MOVE_SILENTLY, oUser); break;
        case 77: iNum = 1; iSide = 20; sAbility="Chequeo de Nadar, "; iMod = GetSkillRank(SKILL_SWIM, oUser); break;
        case 78: iNum = 1; iSide = 20; sAbility="Chequeo de Oficio, "; iMod = GetSkillRank(SKILL_PROFESSION, oUser); break;
        case 79: iNum = 1; iSide = 20; sAbility="Chequeo de Piruetas, "; iMod = GetSkillRank(SKILL_TUMBLE, oUser); break;

        case 81: iNum = 1; iSide = 20; sAbility="Chequeo de Provocar, "; iMod = GetSkillRank(SKILL_TAUNT, oUser); break;
        case 82: iNum = 1; iSide = 20; sAbility="Chequeo de Reunir Informacion, "; iMod = GetSkillRank(SKILL_GATHER_INF, oUser); break;
        case 83: iNum = 1; iSide = 20; sAbility="Chequeo de Saber, "; iMod = GetSkillRank(SKILL_LORE, oUser); break;
        case 84: iNum = 1; iSide = 20; sAbility="Chequeo de Saltar, "; iMod = GetSkillRank(SKILL_JUMP, oUser); break;
        case 85: iNum = 1; iSide = 20; sAbility="Chequeo de Sanar, "; iMod = GetSkillRank(SKILL_HEAL, oUser); break;
        case 86: iNum = 1; iSide = 20; sAbility="Chequeo de Sujetar, "; iMod = GetSkillRank(SKILL_DISCIPLINE, oUser); break;
        case 87: iNum = 1; iSide = 20; sAbility="Chequeo de Supervivencia, "; iMod = GetSkillRank(SKILL_SURVIVAL, oUser); break;
        case 88: iNum = 1; iSide = 20; sAbility="Chequeo de Tasacion, "; iMod = GetSkillRank(SKILL_APPRAISE, oUser); break;
        case 89: iNum = 1; iSide = 20; sAbility="Chequeo de Trato con Animales, "; iMod = GetSkillRank(SKILL_HANDLE_ANIMAL, oUser); break;

        case 91: iNum = 1; iSide = 20; sAbility="Chequeo de Trepar, "; iMod = GetSkillRank(SKILL_CLIMB, oUser); break;
        case 92: iNum = 1; iSide = 20; sAbility="Chequeo de Usar Dispositivo Magico, "; iMod = GetSkillRank(SKILL_USE_MAGIC_DEVICE, oUser); break;
        case 93: iNum = 1; iSide = 20; sAbility="Chequeo de Uso de Cuerdas, "; iMod = GetSkillRank(SKILL_USE_ROPE, oUser); break;
        case 94: iNum = 1; iSide = 20; sAbility="Chequeo de Nivel, "; iMod = GetHitDice(oUser)+GetWillSavingThrow(oUser); break;
        case 95: iNum = 1; iSide = 20; sAbility="Chequeo de Conocimiento Bárdico, "; iMod = GetBardicKnowledgeMod(oUser); break;
        ...
        switch(iLeft)
        {
            case 1: iSide = (iLeft > 5) ? 8 : 4; iNum = (iRight > 5) ? (iNum - 5) : iNum; break;
            case 2: iSide = 6; break;
            case 3: iSide = (iLeft > 5) ? 10 : 20; iNum = (iRight > 5) ? (iNum - 5) : iNum; break;
        }
        break;
    }
    SendMessageToAllDMs("Debug: sAbility= " + sAbility);
    if ((iTrain)&&(iMod==0))
        {
        string sMsg = ColorText("Sin tirada:  la Habilidad requiere entrenamiento", "red");
...
void setAllItemsAsNotDropeable( object creature ) {
    Inventory_setearItemsEquipadosNoDropeables( creature );
    Inventory_setearItemsContenidosNoDropeables( creature );
}
    ...
    case 33: if (GetObjectType(oTarget)==OBJECT_TYPE_ITEM)
     ...
     case 93:n=1;
            ...
            while (GetIsObjectValid(oCopy)) {
                // insertado por Inquisidor BEGIN
                setAllItemsAsNotDropeable(oCopy);
                // insertado por Inquisidor END
...
const int DMFI_TARGET_SINGLE = 0;
const int DMFI_TARGET_ALL_PCS_IN_AREA = 1;
...
void DoDMDiceBagFunction(int iDice, object oUser)
{
    ...
    if (iDice < 100)
        ...
        iLeft = 10;
    int tipoTarget = GetLocalInt(oUser, "dmfi_dm_dicebag_target_type");

    if (iLeft < 10) {
        if (tipoTarget==DMFI_TARGET_ALL_PCS_IN_AREA) {
            //All PCs/NPCs in the area
            ...
            //Single Creature Roll
            DoDiceBagFunction(iDice+50, oTarget, iOverride);
    } else {
        switch(iDice)
        {
            case 101: SetLocalInt(oUser, "dmfi_dicebag", 2); SetCampaignInt("dmfi", "dmfi_dicebag", 2, oUser); SetCustomToken(20681, "Local"); FloatingTextStringOnCreature("Broadcast Mode set to Local", oUser, FALSE); return; break;
            case 102: SetLocalInt(oUser, "dmfi_dicebag", 1); SetCampaignInt("dmfi", "dmfi_dicebag", 1, oUser); SetCustomToken(20681, "Global"); FloatingTextStringOnCreature("Broadcast Mode set to Global", oUser, FALSE); return; break;
            case 103: SetLocalInt(oUser, "dmfi_dicebag", 0); SetCampaignInt("dmfi", "dmfi_dicebag", 0, oUser); SetCustomToken(20681, "Privado"); FloatingTextStringOnCreature("Broadcast Mode set to Privado", oUser, FALSE); return; break;
            case 104: SetLocalInt(oUser, "dmfi_dicebag", 3); SetCampaignInt("dmfi", "dmfi_dicebag", 3, oUser); SetCustomToken(20681, "Solo DM"); FloatingTextStringOnCreature("Broadcast Mode set to Solo DM", oUser, FALSE); return; break;
            ...
            case 107: SetLocalInt(oUser, "dmfi_dm_dicebag_target_type", DMFI_TARGET_SINGLE); FloatingTextStringOnCreature("Las tiradas las efectuara solo la criatura seleccionada", oUser); break;
            case 108: SetLocalInt(oUser, "dmfi_dm_dicebag_target_type", DMFI_TARGET_ALL_PCS_IN_AREA); FloatingTextStringOnCreature("Todos los PJs en el area haran la tirada", oUser); break;
        }
    }
    ...
    else
    {
        switch (iSay)
        {
            ...
            case 9: SetLocalObject(oUser, "dmfi_VoiceTarget", oTarget);
                ...
                SetListenPattern(oTarget, "**", 0);  //listen to all text
...
void DoXPFunction(int iXP, object oUser)
{
    ...
    if (iParty==1)
    {
       if (iReward==0)
        ...
        {
            Experience_dar( oPartyMember, iReward );
