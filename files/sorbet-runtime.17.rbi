...
#
# sorbet-runtime-0.4.3784
module T::Configuration
  def self.sig_build_error_handler; end
  def self.sig_build_error_handler=(value); end
  def self.sig_decl_error_handler; end
  def self.sig_decl_error_handler=(value); end
  def self.sig_error_handler; end
  def self.sig_error_handler=(value); end
  def self.type_error_handler; end
  def self.type_error_handler=(value); end
end
module T::Profile
  def self.reset; end
...
module T::Private::ErrorHandler
  def self.handle_sig_build_error(error, opts = nil); end
  def self.handle_sig_build_error_default(error, opts); end
  def self.handle_sig_decl_error(error, location); end
  def self.handle_sig_decl_error_default(error, location); end
  def self.handle_sig_error(signature, opts = nil); end
  def self.handle_sig_error_default(signature, opts); end
  def self.handle_type_error(type_error); end
  def self.handle_type_error_default(type_error); end
end
...
module T::Props::Optional::DecoratorMethods
  ...
  def check_prop_type(prop, val, rules = nil); end
...
module T::Props::Serializable::DecoratorMethods
  ...
  def prop_defined(name, cls, rules = nil); end
