...
void SetItemLocals()
{
SetLocalString(OBJECT_SELF, "lsn1", "item110");
SetLocalInt(OBJECT_SELF, "lsc_item110", 4);
SetLocalString(OBJECT_SELF, "lsi1_item110", "blackdiamond");
SetLocalString(OBJECT_SELF, "lsi2_item110", "goldbrick");
SetLocalString(OBJECT_SELF, "lsi3_item110", "verciditebuckle");
SetLocalString(OBJECT_SELF, "lsi4_item110", "  gold  75000");
SetLocalInt(OBJECT_SELF, "lss_item110", -10);
SetLocalInt(OBJECT_SELF, "lsv_item110", VFX_FNF_STRIKE_HOLY);
