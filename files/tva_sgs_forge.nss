...
void SetItemLocals()
{
SetLocalString(OBJECT_SELF, "lsn1", "bladiumgreatswor");
SetLocalInt(OBJECT_SELF, "lsc_bladiumgreatswor", 4);
SetLocalString(OBJECT_SELF, "lsi1_bladiumgreatswor", "blackdiamond");
SetLocalString(OBJECT_SELF, "lsi2_bladiumgreatswor", "blackdiamond");
SetLocalString(OBJECT_SELF, "lsi3_bladiumgreatswor", "adamantiumingot");
SetLocalString(OBJECT_SELF, "lsi4_bladiumgreatswor", "  gold  100000");
SetLocalInt(OBJECT_SELF, "lss_bladiumgreatswor", -10);
SetLocalInt(OBJECT_SELF, "lsv_bladiumgreatswor", VFX_FNF_STRIKE_HOLY);
