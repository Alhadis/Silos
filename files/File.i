...
#line 1 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\File.h"
...
#line 11 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\File.h"
...
#line 12 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\File.h"
...
#line 73 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\File.h"

#line 75 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\File.h"
...
#line 9 ".\\File.cpp"
#line 1 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\../MTK/AppGlobal.h"
...
#line 6 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\../MTK/AppGlobal.h"
...
#line 7 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\../MTK/AppGlobal.h"
#line 1 "D:\\BREW\\inc\\JKey.h"
...
{
	POINTER_STATUS_UP    =  -1,
	POINTER_STATUS_NONE  =  0,
	POINTER_STATUS_DOWN  =  1,
	POINTER_STATUS_MOVE  =  2,
};




typedef struct PointerItem 
{
	short sLeft;
	short sTop;
	short sWi;
...
public:
	...
	BOOL pointerDown(int iX, int iY);
	BOOL pointerUp(int iX, int iY);
	BOOL pointerMove(int iX, int iY);

	void setClearKey(BOOL bClearKey);
	void setClearPointer(BOOL bClearPointer);
	BOOL clearKey();
	BOOL clearPointer();

	void blockPress(DWORD blockTime); 
	void setBlockPressTime(int blockTime);
	BOOL canPress(); 
	void clearBlockTime();
	...
	BOOL setKeyActiveStatus(int iKeyIndex, int iActiveStatus);
	int getKeyEventType();

	BOOL setPointerItemPos(PointerItem* pPointerItem, int iX, int iY, int iWi, int iHe);
	BOOL setPointerItemAlive(PointerItem* pPointerItem, BOOL bAlive);
	BOOL setPointerActiveStatus(PointerItem* pPointerItem, int iActiveStatus);

	BOOL isPressPointerItem(PointerItem* pPointerItem, int iX, int iY);
	BOOL bTouchPointerItem(PointerItem* pPointerItem, int iX, int iY);

	int getPenEventType();
	BOOL setPrePointerDnTime(DWORD dwPrePointerDnTime);
	void setSavePointerPos(int iX, int iY);
	DWORD getPrePointerDnTime();

	BOOL setUseNumberDirect(BOOL bUseNumberDirect);

	BOOL isPointerEqualsKey();
	BOOL isPointerActionInTime(DWORD dwTime);

	void forceClear();
public:
	int m_keyStatus[20]; 
	int m_keyActiveStatus[20]; 
	int m_iKeyEventType;

	int m_iPointerStatus; 
	int m_iPointerPosX; 
	int m_iPointerPosY; 
	
	int m_iPrePointerStatus; 
	int m_iPrePointerPosX; 
	int m_iPrePointerPosY;
	DWORD m_dwPrePointerDnTime; 
	
	int m_iPointerDownX;
	int m_iPointerDownY;
	int m_iSavePointerPosX;
	int m_iSavePointerPosY;
	
	BOOL m_bClearKey;
	BOOL m_bClearPointer;
	
	PointerItem m_pointerItem_arrowAndSoftKey[7]; 
	PointerItem m_pointerItem_rollBar; 
	PointerItem m_pointerItem_temp; 
	
	BOOL m_bUseNumberDirect; 
	
	DWORD m_dwBlockPressTime;
};

#line 206 "D:\\BREW\\inc\\JKey.h"
#line 8 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\../MTK/AppGlobal.h"
...
#line 9 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\../MTK/AppGlobal.h"
#line 1 "D:\\BREW\\inc\\JVector.h"
...
#line 5 "D:\\BREW\\inc\\JVector.h"

class JVector
{
public:
	JVector();
	JVector(int iInitialCapacity);
	JVector(int iInitialCapacity, int iGrowthFactor);
	~JVector();

public:
	void		  Init(int iInitialCapacity, int iGrowthFactor);
	void		  Release();
public:
	int getSize();
	int getCapacity();
	...
	BOOL addElement(void* pv);
	BOOL addElement(void* pv, int iIndex);
	void* setElementAt(void* pv, int iIndex);
	BOOL increaseCapacity();
	void* removeElementAt(int iIndex);
	BOOL removeElement(void* pv);
...
#line 47 "D:\\BREW\\inc\\JVector.h"
#line 10 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\../MTK/AppGlobal.h"
#line 1 "D:\\BREW\\inc\\JRect.h"
...
#line 11 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\../MTK/AppGlobal.h"
#line 1 "D:\\BREW\\inc\\JImage.h"
...
#line 12 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\../MTK/AppGlobal.h"
#line 1 "D:\\BREW\\inc\\JWStringBuffer.h"
...
#line 5 "D:\\BREW\\inc\\JWStringBuffer.h"

class JWStringBuffer
{
public:
	JWStringBuffer();
	JWStringBuffer(int iBufSize);
	~JWStringBuffer();
public:
...
public:
	BOOL          Append(const WCHAR* wszStr,  int iLen); 
	BOOL          Append(const char* szStr,  int iLen);
	BOOL          Append(const WCHAR* wszStr); 
	BOOL          Append(const char* szStr);
	BOOL          Append(const WCHAR wc);
	BOOL          Append(const char c);
	BOOL          Append(int iNum, int iRadix);
	
	WCHAR*        GetBuf();
	int           Length();
	WCHAR         WCharAt(int iIndex);
	
	void          Clear(); 
	BOOL          ExtendBuf(int iNewBufSize);
private:
	void          FirstInitNull();
public:
	TCHAR*        m_pBuf; 
...
#line 41 "D:\\BREW\\inc\\JWStringBuffer.h"
#line 13 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\../MTK/AppGlobal.h"
#line 1 "D:\\BREW\\inc\\JStringBuffer.h"
...
#line 5 "D:\\BREW\\inc\\JStringBuffer.h"

class JStringBuffer
{
public:
	JStringBuffer();
	JStringBuffer(int iBufSize);
	~JStringBuffer();
public:
	void          Init(int iBufSize);
	void          Release();
public:
	...
	BOOL          Append(const char c);
	BOOL          Append(int iNum, int iRadix);
	BOOL          Append(uint32 uNum);
	
	char*         GetBuf();
	int           Length();
	char          CharAt(int iIndex);
...
#line 41 "D:\\BREW\\inc\\JStringBuffer.h"
#line 14 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\../MTK/AppGlobal.h"
...
#line 15 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\../MTK/AppGlobal.h"
#line 1 "D:\\BREW\\inc\\JFileOutputstream.h"
...
#line 5 "D:\\BREW\\inc\\JFileOutputstream.h"
#line 1 "d:\\brew\\inc\\JSystem.h"
...
#line 6 "D:\\BREW\\inc\\JFileOutputstream.h"

class JFileOutputStream
{
public:
	JFileOutputStream(char* szFile, int nFileCacheSize = 0);
	~JFileOutputStream();
	BOOL IsOk();
...
public:	
	...
	BOOL WriteChars(char* cs, int iLen);

	BOOL WriteChar(char c);
	BOOL WriteShort(short s);
	BOOL WriteInt(int n);
	BOOL WriteBOOL(BOOL b);
	BOOL WriteWCharArray(WCHAR* pWcharBuf, int iCharNum);
...
#line 37 "D:\\BREW\\inc\\JFileOutputstream.h"
#line 16 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\../MTK/AppGlobal.h"



#line 1 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\mtk\\BaseScreen.h"



#line 1 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\mtk\\AppGlobal.h"
...
#line 5 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\mtk\\BaseScreen.h"
#line 1 "D:\\BREW\\inc\\JDefine.h"
...
#line 6 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\mtk\\BaseScreen.h"
...
public:
	virtual int          OnCreate(void* pi); 
	virtual int          OnDestroy(void); 
	
	virtual BOOL		 OnWndProc(void* pi, uint16 eCode , uint16 wParam , uint32 dwParam); 
	
	virtual void         OnShow(BOOL bShow); 
	virtual int			 OnPaint(void* pi); 
...
#line 51 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\mtk\\BaseScreen.h"
#line 20 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\mtk\\AppGlobal.h"
...
public:
	...
	static BOOL WndProc(void* pi, uint16 eCode , uint16 wParam , uint32 dwParam); 
...
#line 156 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\mtk\\AppGlobal.h"
#line 10 ".\\File.cpp"

static IFileMgr *FileMgr = 0; 
static int count = 0; 

File Log; 
char gpcDebug[BUFSIZE];  
...
File::~File()
{
    ...
    if (FileMgr && count == 0)
    {
        ((IFileMgr*)FileMgr)->pvt->Release(FileMgr);
        FileMgr = 0;
        _FileMgr = 0;
    }
}
...
int File::init()
{
    _app = ((AppGlobal*)(((AppBasic*)((char*)(*(((AEEHelperFuncs **)AEEMod_Load) - 1))->GetAppInstance() + sizeof(AEEApplet)))->pAppGlobal))->m_pMe;
    if (_app && FileMgr == 0)
    {
      if (((IShell*)_app->m_pIShell)->pvt->CreateInstance(_app->m_pIShell,((0x01000000 + 0x1000)+3),(void**)&FileMgr)
                  != 0)
      {
          return 2;
      }
            ...
            int flag)
{
    ...
    _flag = flag;
	  if (0 != ((IFileMgr*)_FileMgr)->pvt->Test(_FileMgr, file))
	  {
      _flag |= _OFM_CREATE;
	  }
	  else
    ...
    _File = ((IFileMgr*)_FileMgr)->pvt->OpenFile(_FileMgr, file, _flag);
    ...
    {
        ((IFile*)_File)->pvt->Seek(_File, _SEEK_END, 0);
    }
...
int File::flush()
{
  if (!good())
    return -1;
  return ((IFile*)_File)->pvt->SetCacheSize(_File,0);
}
...
int File::close()
{
    ...
    ((IFile*)_File)->pvt->SetCacheSize(_File,0);
    int ref = ((IFile*)_File)->pvt->Release(_File);
    _File = 0;
    return ref;
}
...
int File::write(void* buf, int cnt)
{
    if (!good())
        return -1;
    return ((IFile*)_File)->pvt->Write(_File, buf, cnt);
}
...
int File::read(void* buf, int cnt)
{
    ...
    return ((IFile*)_File)->pvt->Read(_File, buf, cnt);
}
...
void OutputDebugData(char const* buf)
{
    ...
    int rc = Log.write((void*) buf, (*(((AEEHelperFuncs **)AEEMod_Load) - 1))->strlen((buf)));
}
...
int log(const char *fmt, ...)
{
    ...
    (*(((AEEHelperFuncs **)AEEMod_Load) - 1))->memset(((gpcDebug)),(0),((sizeof(gpcDebug))));

    JulianType ttt;
    (*(((AEEHelperFuncs **)AEEMod_Load) - 1))->GetJulianDate((0),(&ttt));
    
    
    
    
    (*(((AEEHelperFuncs **)AEEMod_Load) - 1))->sprintf(gpcDebug, "[%s:%s]", "May  4 2012", "12:08:16");
    char* ptc = &gpcDebug[(*(((AEEHelperFuncs **)AEEMod_Load) - 1))->strlen((gpcDebug))];
    va_list p;
    ( p = (va_list)( &reinterpret_cast<const char &>(fmt) ) + ( (sizeof(fmt) + sizeof(int) - 1) & ~(sizeof(int) - 1) ) );
    ...
    for (const char *s = fmt; *s; ++s)
    {
        ...
        else
        {
            switch (*(++s))
            {
                ...
                case 's':
                {
                    const char* pc = ( *(const char* *)((p += ( (sizeof(const char*) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(const char*) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) );
                    while (*pc)
                    {
                        *(ptc++) = *(pc++);
                    }
                ...
                case 'c':
                {
                    *(ptc++) = ( *(char *)((p += ( (sizeof(char) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(char) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) );
                }
                    break;
                case 'd':
                {
                    int nNum = ( *(int *)((p += ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) );
                ...
                case 'u':
                {
                    unsigned int nNum = ( *(unsigned int *)((p += ( (sizeof(unsigned int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(unsigned int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) );
                ...
                case 'p':
                {
                    ...
                    *(ptc++) = 'x';
                    ...
                    unsigned int unNum = ( *(unsigned int *)((p += ( (sizeof(unsigned int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(unsigned int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) );
    ...
    *ptc = 0;
    ...
    return Log.write((void*) gpcDebug, (*(((AEEHelperFuncs **)AEEMod_Load) - 1))->strlen((gpcDebug)));
}
#pragma managed(pop)
