...
scene SelectStoryMode08
{
	...
	if(($GameName == "ch08_154_インターミッション３３" || $GameName == 0) && !$梨深ルート)
	{
	...
	if(($GameName == "ch08_159_インターミッション３５" || $GameName == 0) && !$梨深ルート)
	{
	...
	if(($GameName == "ch08_167_インターミッション３７" || $GameName == 0) && !$梨深ルート)
	{
	...
	if(($GameName == "ch08_170_インターミッション３８" || $GameName == 0) && !$梨深ルート)
	{
		$ChapterName = "ch08_170_インターミッション３８";
		$GameName = 0;
		ch08_170_インターミッション３８();
	}
	if(($GameName == "ch08_171_セナＶＳ梨深の結末" || $GameName == 0) && !$梨深ルート)
	{
		$ChapterName = "ch08_171_セナＶＳ梨深の結末";
		$GameName = 0;
		ch08_171_セナＶＳ梨深の結末();
	}
	if(($GameName == "ch08_172_インターミッション３９" || $GameName == 0) && !$梨深ルート)
	{
		$ChapterName = "ch08_172_インターミッション３９";
		$GameName = 0;
		ch08_172_インターミッション３９();
	}
	if(($GameName == "ch08_173_公式Ｉｒ２" || $GameName == 0) && !$梨深ルート)
	{
		$ChapterName = "ch08_173_公式Ｉｒ２";
		$GameName = 0;
		ch08_173_公式Ｉｒ２();
	}
	if(($GameName == "ch08_174_インターミッション４０" || $GameName == 0) && !$梨深ルート)
	{
		$ChapterName = "ch08_174_インターミッション４０";
		$GameName = 0;
		ch08_174_インターミッション４０();
	}
	if(($GameName == "ch08_175_実家に帰る" || $GameName == 0) && !$梨深ルート)
	{
		$ChapterName = "ch08_175_実家に帰る";
		$GameName = 0;
		ch08_175_実家に帰る();
	}
	if(($GameName == "ch08_176_インターミッション４１" || $GameName == 0) && !$梨深ルート)
	{
