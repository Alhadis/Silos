...
###### Initial conditions ######
press_upper_left_corner = 0.4
press_upper_right_corner = 1.
press_bottom_left_corner = 0.0439
press_bottom_right_corner = 0.15

dens_upper_left_corner = 0.5197
dens_upper_right_corner = 1.
dens_bottom_left_corner = 0.1072
dens_bottom_right_corner = 0.2579

x_vel_upper_left_corner = -0.7259
x_vel_upper_right_corner = 0.
x_vel_bottom_left_corner = -0.7259
x_vel_bottom_right_corner = 0.

y_vel_upper_left_corner = 0.
y_vel_upper_right_corner = 0.
y_vel_bottom_left_corner = -1.4045
y_vel_bottom_right_corner = -1.4045
