...
#line 1 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Container.h"
...
#line 10 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Container.h"
...
typedef bool (*pPointerEvn)(int, int); 
typedef bool (*pKeyEvn)(int); 
...
#line 1 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\cont.inc"
...
extern bool click(int, int); extern bool click(int, int); extern bool NP(int, int); extern bool NK(int); extern bool NK(int);

#line 62 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Container.h"
...
#line 70 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Container.h"
...
#line 79 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Container.h"


extern ResPool *contPool; 
...
#line 138 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Container.h"
#line 8 ".\\Container.cpp"
#line 1 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image.h"
...
#line 10 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image.h"
#line 1 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\ResPool.h"
...
#line 11 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image.h"


extern "C"{
#line 15 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image.h"
...
enum RES{
  ...
  #line 1 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Resource.inc"
#pragma warning(disable:4002)
...
ID_green,
ID_bk,
#line 10 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Resource.inc"
#line 33 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image.h"
...
extern Obj V_bk;
#line 10 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Resource.inc"
#line 42 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image.h"


extern ResPool *imgPool; 
...
int load_bk(void*);
#line 10 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Resource.inc"
#line 53 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image.h"
...
#line 63 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image.h"
...
#line 70 "f:\\home\\bonly\\my documents\\visual studio 2005\\projects\\template\\tools\\Image.h"
#line 9 ".\\Container.cpp"
...
static int init_test(void* p) { if(V_test.obj == 0) { Cont* obj = new Cont; if(obj == 0) return 1; obj->ID = ID_test; V_test.obj = obj; init_obj(obj, 8, 1, 2, 0, 0, ID_red, ID_blue, ID_green, click, click, NP, NK, NK); } return 0;}

#line 52 ".\\Container.cpp"
...
contList[i]->ID = i; contList[i]->create = init_test; ++i;

#line 66 ".\\Container.cpp"
...
Cont* GetCont(int x)
{
    return (Cont*)instance_ResPool(&contPool,init)->getObj(x)->obj;
}
...
int init_obj(Cont *obj, const int count, ...)
{
  ...
  va_list ap;
  ( ap = (va_list)( &reinterpret_cast<const char &>(count) ) + ( (sizeof(count) + sizeof(int) - 1) & ~(sizeof(int) - 1) ) );
  ...
  for (int cnt = 0; cnt < count; ++cnt)
  {
    ...
    {
    case 0:
      obj->x = ( *(int *)((ap += ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) );  
      break;
    case 1:
      obj->y = ( *(int *)((ap += ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) );  
      break;
    case 2:
      obj->width = ( *(int *)((ap += ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) );  
      break;
    case 3:
      obj->height = ( *(int *)((ap += ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) );  
      break;
    case 4:
      obj->picUp = ( *(int *)((ap += ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) ); 
      obj->curPic = obj->picUp;
      break;
    case 5:
      obj->picDown = ( *(int *)((ap += ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) ); 
      break;
    case 6:
      obj->picOver = ( *(int *)((ap += ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(int) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) ); 
      break;
    case 7:
      obj->PointerPressed = ( *(pPointerEvn *)((ap += ( (sizeof(pPointerEvn) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(pPointerEvn) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) ); 
      break;
    case 8:
      obj->PointerDragged = ( *(pPointerEvn *)((ap += ( (sizeof(pPointerEvn) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(pPointerEvn) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) ); 
      break;
    case 9:
      obj->PointerReleased = ( *(pPointerEvn *)((ap += ( (sizeof(pPointerEvn) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(pPointerEvn) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) ); 
      break;
    case 10:
      obj->KeyPressed = ( *(pKeyEvn *)((ap += ( (sizeof(pKeyEvn) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(pKeyEvn) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) ); 
      break;
    case 11:
      obj->KeyReleased = ( *(pKeyEvn *)((ap += ( (sizeof(pKeyEvn) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) - ( (sizeof(pKeyEvn) + sizeof(int) - 1) & ~(sizeof(int) - 1) )) ); 
      break;
    }
  }
  ( ap = (va_list)0 );
