...
void SetItemLocals()
{
SetLocalString(OBJECT_SELF, "lsn1", "bladiumtowershie");
SetLocalInt(OBJECT_SELF, "lsc_bladiumtowershie", 5);
SetLocalString(OBJECT_SELF, "lsi1_bladiumtowershie", "adamantiumingot");
SetLocalString(OBJECT_SELF, "lsi2_bladiumtowershie", "blackdiamond");
SetLocalString(OBJECT_SELF, "lsi3_bladiumtowershie", "verciditebuckle");
SetLocalString(OBJECT_SELF, "lsi4_bladiumtowershie", "goldbrick");
SetLocalString(OBJECT_SELF, "lsi5_bladiumtowershie", "  gold  50000");
SetLocalInt(OBJECT_SELF, "lss_bladiumtowershie", -10);
SetLocalInt(OBJECT_SELF, "lsv_bladiumtowershie", VFX_FNF_STRIKE_HOLY);
