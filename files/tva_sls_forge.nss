...
void SetItemLocals()
{
SetLocalString(OBJECT_SELF, "lsn1", "bladiumlongsword");
SetLocalInt(OBJECT_SELF, "lsc_bladiumlongsword", 3);
SetLocalString(OBJECT_SELF, "lsi1_bladiumlongsword", "blackdiamond");
SetLocalString(OBJECT_SELF, "lsi2_bladiumlongsword", "adamantiumingot");
SetLocalString(OBJECT_SELF, "lsi3_bladiumlongsword", "  gold  75000");
SetLocalInt(OBJECT_SELF, "lss_bladiumlongsword", -10);
SetLocalInt(OBJECT_SELF, "lsv_bladiumlongsword", VFX_FNF_STRIKE_HOLY);
