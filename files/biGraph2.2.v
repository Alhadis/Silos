...
Require Import Coq.Relations.Z_
...
Fixpoint is_matching (m: list E): Prop :=
match m with
|nil => True
|e::m' => is_matching m' /\ forall (e': E), In e' m' -> src gra e <> src gra e' /\ src gra e <> dst gra e' /\ dst gra e <> src gra e'/\ dst gra e <> dst gra e'
end.
(* 
...
Lemma match_xor_aug_match:
  ...
  cross_halt (st (v, p)) -> multi_cstep (Vstateb_update default_Vstateb v, (v, nil)) (st (v, p)) -> is_matching M -> e = xor_edge M p -> is_matching e.
Proof.
  intros.
