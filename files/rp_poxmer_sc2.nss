...
int StartingConditional()
{
    ...
    // Spawn new ox
        // The new ox will be spawned wherever the "rp_pox_sp" waypoint has been set.
        object oSpawnPoint = GetNearestObjectByTag("rp_pox_sp");
        ...
        // Spawn the new ox.
        object oNewOx = CreateObject(OBJECT_TYPE_CREATURE,"rp_pox",lSpawnLocation, FALSE);
